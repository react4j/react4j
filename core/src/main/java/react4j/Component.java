...
public abstract class Component
{
   ...
   * or the componentPreUpdate(JsPropertyMap) method. If the method is not invoked from the
   * {@link #shouldComponentUpdate(JsPropertyMap)} method first due to a {@link Component#scheduleRender()}
   * call then the call from componentPreUpdate(JsPropertyMap) will report any changes to
   ...
   * @param inComponentPreUpdate true if this is being invoked from componentPreUpdate(JsPropertyMap), false if this is being invoked from {@link #shouldComponentUpdate(JsPropertyMap)}
  ...
  protected boolean reportPropChanges( @Nonnull final JsPropertyMap<Object> props,
                                       ...
                                       final boolean inComponentPreUpdate )
  {
    return false;
  }
