...
public abstract class Component
{
   ...
   * or the {@link #componentDidUpdate(JsPropertyMap)} method. If the method is not invoked from the
   * {@link #shouldComponentUpdate(JsPropertyMap)} method first due to a {@link Component#scheduleRender()}
   * call then the call from {@link #componentDidUpdate(JsPropertyMap)} will report any changes to
   ...
   * @param inComponentDidUpdate true if this is being invoked from {@link #componentDidUpdate(JsPropertyMap)}, false if this is being invoked from {@link #shouldComponentUpdate(JsPropertyMap)}
