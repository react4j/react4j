 ...
 *
 * <p>This method will be invoked immediately after the @Render annotated method. If there are multiple
 * methods annotated by this annotation then the methods will be invoked in the order specified by the sortOrder
 * parameter.</p>
 *
...
public @interface PostRender
{
   ...
   * Higher values occur earlier, if multiple methods have the same sortOrder then sorting order is undefined.
   *
   * @return the sortOrder.
   */
  int sortOrder() default SortOrder.APPLICATION;
}
