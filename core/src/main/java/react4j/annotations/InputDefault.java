 ...
 * <li>Must return a value with the same type as the associated {@link Input @Input} annotated method</li>
 ...
 * <ul>
 * <li>Must have the same type as the associated {@link Input @Input} annotated method</li>
