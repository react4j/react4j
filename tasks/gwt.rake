...
def gwt_enhance(project, options = {})
  ...
  if project.enable_annotation_processor?
    # The next two lines are for artifacts generated by annotation processors. Usually only one will be actually in use.
    dependencies += [project.compile.target] + [project.file(project._('generated/processors/main/java'))]
  end
