...
class CharOnPropChangedBuilder {
  private CharOnPropChangedBuilder() {
  }
  ...
  private static class Builder implements Builder1, Builder2 {
    private final ReactElement _element = ReactElement.createComponentElement( React4j_CharOnPropChanged.Factory.TYPE );
    ...
    public final ReactNode myProp(final char myProp) {
      _element.props().set( React4j_CharOnPropChanged.Props.myProp, myProp );
      return build();
    }
