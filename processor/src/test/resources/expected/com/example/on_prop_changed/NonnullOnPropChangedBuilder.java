...
class NonnullOnPropChangedBuilder {
  private NonnullOnPropChangedBuilder() {
  }
  ...
  private static class Builder implements Builder1, Builder2 {
    private final ReactElement _element = ReactElement.createComponentElement( React4j_NonnullOnPropChanged.Factory.TYPE );
    ...
    public final ReactNode myProp(@Nonnull final String myProp) {
      ...
      _element.props().set( React4j_NonnullOnPropChanged.Props.myProp, myProp );
      return build();
    }
