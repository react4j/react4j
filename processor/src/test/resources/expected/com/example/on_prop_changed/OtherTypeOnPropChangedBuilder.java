...
class OtherTypeOnPropChangedBuilder {
  private OtherTypeOnPropChangedBuilder() {
  }
  ...
  private static class Builder implements Builder1, Builder2 {
    private final ReactElement _element = ReactElement.createComponentElement( React4j_OtherTypeOnPropChanged.Factory.TYPE );
    ...
    public final ReactNode myProp(final ArrayList myProp) {
      _element.props().set( React4j_OtherTypeOnPropChanged.Props.myProp, myProp );
      return build();
    }
