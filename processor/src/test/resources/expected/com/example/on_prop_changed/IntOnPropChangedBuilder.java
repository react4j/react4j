...
class IntOnPropChangedBuilder {
  private IntOnPropChangedBuilder() {
  }
  ...
  private static class Builder implements Builder1, Builder2 {
    private final ReactElement _element = ReactElement.createComponentElement( React4j_IntOnPropChanged.Factory.TYPE );
    ...
    public final ReactNode myProp(final int myProp) {
      _element.props().set( React4j_IntOnPropChanged.Props.myProp, myProp );
      return build();
    }
