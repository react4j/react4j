...
class FloatOnPropChangedBuilder {
  private FloatOnPropChangedBuilder() {
  }
  ...
  private static class Builder implements Builder1, Builder2 {
    private final ReactElement _element = ReactElement.createComponentElement( React4j_FloatOnPropChanged.Factory.TYPE );
    ...
    public final ReactNode myProp(final float myProp) {
      _element.props().set( React4j_FloatOnPropChanged.Props.myProp, myProp );
      return build();
    }
