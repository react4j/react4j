...
class NullableOnPropChangedBuilder {
  ...
  private static class Builder implements Builder1, Builder2 {
    private final ReactElement _element = ReactElement.createComponentElement( React4j_NullableOnPropChanged.Factory.TYPE );
    ...
    public final ReactNode myProp(@Nullable final String myProp) {
      _element.props().set( React4j_NullableOnPropChanged.Props.myProp, myProp );
      return build();
    }
