...
class ByteOnPropChangedBuilder {
  private ByteOnPropChangedBuilder() {
  }
  ...
  private static class Builder implements Builder1, Builder2 {
    private final ReactElement _element = ReactElement.createComponentElement( React4j_ByteOnPropChanged.Factory.TYPE );
    ...
    public final ReactNode myProp(final byte myProp) {
      _element.props().set( React4j_ByteOnPropChanged.Props.myProp, myProp );
      return build();
    }
