...
class DoubleOnPropChangedBuilder {
  private DoubleOnPropChangedBuilder() {
  }
  ...
  private static class Builder implements Builder1, Builder2 {
    private final ReactElement _element = ReactElement.createComponentElement( React4j_DoubleOnPropChanged.Factory.TYPE );
    ...
    public final ReactNode myProp(final double myProp) {
      _element.props().set( React4j_DoubleOnPropChanged.Props.myProp, myProp );
      return build();
    }
