...
class React4j_ProtectedAccessOnPropChanged extends ProtectedAccessOnPropChanged {
  ...
  private static ComponentConstructorFunction getConstructorFunction() {
    ...
    if ( ReactConfig.enableComponentNames() ) {
      Js.asPropertyMap( componentConstructor ).set( "displayName", "ProtectedAccessOnPropChanged" );
    }
  ...
  private static final class LiteNativeReactComponent extends NativeAdapterComponent<ProtectedAccessOnPropChanged> implements LiteLifecycle {
    @JsConstructor
    ...
    @Override
    protected ProtectedAccessOnPropChanged createComponent() {
      return new React4j_ProtectedAccessOnPropChanged();
    }
  ...
  private static final class NativeReactComponent extends NativeAdapterComponent<ProtectedAccessOnPropChanged> implements Lifecycle {
    @JsConstructor
