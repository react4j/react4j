...
class LongOnPropChangedBuilder {
  private LongOnPropChangedBuilder() {
  }
  ...
  private static class Builder implements Builder1, Builder2 {
    private final ReactElement _element = ReactElement.createComponentElement( React4j_LongOnPropChanged.Factory.TYPE );
    ...
    public final ReactNode myProp(final long myProp) {
      _element.props().set( React4j_LongOnPropChanged.Props.myProp, myProp );
      return build();
    }
