...
class React4j_ParameterizedOnPropChanged extends ParameterizedOnPropChanged {
  ...
  private static ComponentConstructorFunction getConstructorFunction() {
    ...
    if ( ReactConfig.enableComponentNames() ) {
      Js.asPropertyMap( componentConstructor ).set( "displayName", "ParameterizedOnPropChanged" );
    }
  ...
  private static final class LiteNativeReactComponent extends NativeAdapterComponent<ParameterizedOnPropChanged> implements LiteLifecycle {
    @JsConstructor
    ...
    @Override
    protected ParameterizedOnPropChanged createComponent() {
      return new React4j_ParameterizedOnPropChanged();
    }
  ...
  private static final class NativeReactComponent extends NativeAdapterComponent<ParameterizedOnPropChanged> implements Lifecycle {
    @JsConstructor
