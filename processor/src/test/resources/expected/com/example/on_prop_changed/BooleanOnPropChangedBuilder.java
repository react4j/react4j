...
class BooleanOnPropChangedBuilder {
  private BooleanOnPropChangedBuilder() {
  }
  ...
  private static class Builder implements Builder1, Builder2 {
    private final ReactElement _element = ReactElement.createComponentElement( React4j_BooleanOnPropChanged.Factory.TYPE );
    ...
    public final ReactNode myProp(final boolean myProp) {
      _element.props().set( React4j_BooleanOnPropChanged.Props.myProp, myProp );
      return build();
    }
