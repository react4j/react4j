...
class BooleanOnPropChangedBuilder {
  ...
  private static class Builder implements Builder1, Builder2 {
    ...
    public final ReactNode myProp(final boolean myProp) {
      _props.set( React4j_BooleanOnPropChanged.Props.myProp, myProp );
      return build();
    }

    @Nonnull
    public final ReactNode build() {
      return React.createElement( React4j_BooleanOnPropChanged.Factory.TYPE, Js.uncheckedCast( _props ) );
    }
  }
}
