...
abstract class React4j_KeepAliveMemoizeArezReactComponent extends KeepAliveMemoizeArezReactComponent {
  React4j_KeepAliveMemoizeArezReactComponent(@Nonnull final NativeComponent nativeComponent) {
  ...
  private static final class LiteNativeReactComponent extends NativeAdapterComponent<KeepAliveMemoizeArezReactComponent> implements OnComponentWillUnmount {
    @JsConstructor
    ...
    protected KeepAliveMemoizeArezReactComponent createComponent() {
      return new Arez_React4j_KeepAliveMemoizeArezReactComponent( this );
    }
  ...
  private static final class NativeReactComponent extends NativeAdapterComponent<KeepAliveMemoizeArezReactComponent> implements OnComponentDidMount, OnComponentDidUpdate, OnComponentWillUnmount {
    ...
    public final void componentDidUpdate(@Nonnull final JsPropertyMap<Object> prevProps) {
      ((React4j_KeepAliveMemoizeArezReactComponent) component() ).$$react4j$$_componentDidUpdate();
    }
