...
abstract class React4j_BasicArezReactComponent extends BasicArezReactComponent {
  ...
  React4j_BasicArezReactComponent(@Nonnull final NativeComponent nativeComponent) {
  ...
  private static final class LiteNativeReactComponent extends NativeAdapterComponent<BasicArezReactComponent> implements OnComponentWillUnmount {
    @JsConstructor
    ...
    protected BasicArezReactComponent createComponent() {
      return new Arez_React4j_BasicArezReactComponent( this );
    }

    @Override
    public final void componentWillUnmount() {
      ((React4j_BasicArezReactComponent) component() ).$$react4j$$_componentWillUnmount();
    }

    @Override
    @Nullable
    public final ReactNode render() {
      return ((React4j_BasicArezReactComponent) component() ).render();
    }
  }

  private static final class NativeReactComponent extends NativeAdapterComponent<BasicArezReactComponent> implements OnComponentDidMount, OnComponentDidUpdate, OnComponentWillUnmount {
    @JsConstructor
    ...
    public final void componentDidMount() {
      ((React4j_BasicArezReactComponent) component() ).$$react4j$$_componentDidMount();
    }

    @Override
    public final void componentDidUpdate(@Nonnull final JsPropertyMap<Object> prevProps) {
      ((React4j_BasicArezReactComponent) component() ).$$react4j$$_componentDidUpdate();
    }
