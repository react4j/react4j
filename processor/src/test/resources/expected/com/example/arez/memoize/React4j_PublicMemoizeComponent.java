...
abstract class React4j_PublicMemoizeComponent extends PublicMemoizeComponent {
  React4j_PublicMemoizeComponent(@Nonnull final NativeComponent nativeComponent) {
  ...
  private static final class LiteNativeReactComponent extends NativeAdapterComponent<PublicMemoizeComponent> implements OnComponentWillUnmount {
    @JsConstructor
    ...
    protected PublicMemoizeComponent createComponent() {
      return new Arez_React4j_PublicMemoizeComponent( this );
    }
  ...
  private static final class NativeReactComponent extends NativeAdapterComponent<PublicMemoizeComponent> implements OnComponentDidMount, OnComponentDidUpdate, OnComponentWillUnmount {
    ...
    public final void componentDidMount() {
      ((React4j_PublicMemoizeComponent) component() ).$$react4j$$_componentDidMount();
    }

    @Override
    public final void componentDidUpdate(@Nonnull final JsPropertyMap<Object> prevProps) {
      ((React4j_PublicMemoizeComponent) component() ).$$react4j$$_componentDidUpdate();
    }
