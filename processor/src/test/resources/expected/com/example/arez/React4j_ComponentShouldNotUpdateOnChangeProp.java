...
abstract class React4j_ComponentShouldNotUpdateOnChangeProp extends ComponentShouldNotUpdateOnChangeProp {
  ...
  React4j_ComponentShouldNotUpdateOnChangeProp(@Nonnull final NativeComponent nativeComponent) {
  ...
  private static final class LiteNativeReactComponent extends NativeAdapterComponent<ComponentShouldNotUpdateOnChangeProp> implements OnComponentWillUnmount {
    @JsConstructor
    ...
    protected ComponentShouldNotUpdateOnChangeProp createComponent() {
      return new Arez_React4j_ComponentShouldNotUpdateOnChangeProp( this );
    }
  ...
  private static final class NativeReactComponent extends NativeAdapterComponent<ComponentShouldNotUpdateOnChangeProp> implements OnComponentDidMount, OnComponentDidUpdate, OnComponentWillUnmount {
    ...
    public final void componentDidMount() {
      ((React4j_ComponentShouldNotUpdateOnChangeProp) component() ).$$react4j$$_componentDidMount();
    }

    @Override
    public final void componentDidUpdate(@Nonnull final JsPropertyMap<Object> prevProps) {
      ((React4j_ComponentShouldNotUpdateOnChangeProp) component() ).$$react4j$$_componentDidUpdate();
    }
