...
abstract class React4j_ComponentJsFunctionProp extends ComponentJsFunctionProp {
  ...
  private static final class LiteNativeReactComponent extends NativeAdapterComponent<ComponentJsFunctionProp> implements OnComponentWillUnmount {
    @JsConstructor
  ...
  private static final class NativeReactComponent extends NativeAdapterComponent<ComponentJsFunctionProp> implements OnComponentDidMount, OnComponentDidUpdate, OnComponentWillUnmount {
    ...
    public final void componentDidMount() {
      ((React4j_ComponentJsFunctionProp) component() ).$$react4j$$_componentDidMount();
    }

    @Override
    public final void componentDidUpdate(@Nonnull final JsPropertyMap<Object> prevProps) {
      ((React4j_ComponentJsFunctionProp) component() ).$$react4j$$_componentDidUpdate( prevProps );
    }
