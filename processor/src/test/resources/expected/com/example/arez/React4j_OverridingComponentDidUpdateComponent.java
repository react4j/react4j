...
abstract class React4j_OverridingComponentDidUpdateComponent extends OverridingComponentDidUpdateComponent {
  ...
  private static final class LiteNativeReactComponent extends NativeAdapterComponent<OverridingComponentDidUpdateComponent> implements OnComponentDidUpdate, OnComponentWillUnmount {
    @JsConstructor
    ...
    protected OverridingComponentDidUpdateComponent createComponent() {
      return new Arez_React4j_OverridingComponentDidUpdateComponent( this );
    }

    @Override
    public final void componentDidUpdate(@Nonnull final JsPropertyMap<Object> prevProps) {
      ((React4j_OverridingComponentDidUpdateComponent) component() ).$$react4j$$_componentDidUpdate();
    }
