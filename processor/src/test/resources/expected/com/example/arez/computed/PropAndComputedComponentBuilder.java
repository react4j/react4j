...
class PropAndComputedComponentBuilder {
  private PropAndComputedComponentBuilder() {
  }
  ...
  private static class Builder implements Builder1, Builder2 {
    ...
    public final ReactNode value(final String value) {
      _props.set( React4j_PropAndComputedComponent.PROP_value, value );
      return build();
    }

    @Nonnull
    public final ReactNode build() {
      return React.createElement( React4j_PropAndComputedComponent.TYPE, Js.uncheckedCast( _props ) );
    }
  }
}
