...
class ComponentShouldUpdateOnChangePropBuilder {
  ...
  private static class Builder implements Builder1, Builder2 {
    ...
    public final ReactNode value(final String value) {
      _props.set( React4j_ComponentShouldUpdateOnChangeProp.Props.value, value );
      return build();
    }

    @Nonnull
    public final ReactNode build() {
      return React.createElement( React4j_ComponentShouldUpdateOnChangeProp.Factory.TYPE, Js.uncheckedCast( _props ) );
    }
  }
}
