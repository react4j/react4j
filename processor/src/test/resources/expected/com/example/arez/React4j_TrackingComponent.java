...
abstract class React4j_TrackingComponent extends TrackingComponent {
  ...
  React4j_TrackingComponent(@Nonnull final NativeComponent $$react4j$$_nativeComponent) {
  ...
  private static ComponentConstructorFunction getConstructorFunction() {
    ...
    if ( React.enableComponentNames() ) {
      Js.asPropertyMap( componentConstructor ).set( "displayName", "TrackingComponent" );
    }
  ...
  private static final class LiteNativeReactComponent extends NativeComponent implements OnShouldComponentUpdate, OnComponentWillUnmount {
    @Nonnull
    private final React4j_TrackingComponent $$react4j$$_component;
