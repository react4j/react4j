...
abstract class React4j_ComponentWithDependency extends ComponentWithDependency {
  React4j_ComponentWithDependency(@Nonnull final NativeComponent nativeComponent) {
  ...
  private static final class LiteNativeReactComponent extends NativeAdapterComponent<ComponentWithDependency> implements OnComponentWillUnmount {
    ...
    protected ComponentWithDependency createComponent() {
      return new Arez_React4j_ComponentWithDependency( this );
    }
  ...
  private static final class NativeReactComponent extends NativeAdapterComponent<ComponentWithDependency> implements OnComponentDidMount, OnComponentDidUpdate, OnComponentWillUnmount {
    ...
    public final void componentDidMount() {
      ((React4j_ComponentWithDependency) component() ).$$react4j$$_componentDidMount();
    }

    @Override
    public final void componentDidUpdate(@Nonnull final JsPropertyMap<Object> prevProps) {
      ((React4j_ComponentWithDependency) component() ).$$react4j$$_componentDidUpdate();
    }
