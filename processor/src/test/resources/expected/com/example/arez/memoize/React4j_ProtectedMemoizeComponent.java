...
abstract class React4j_ProtectedMemoizeComponent extends ProtectedMemoizeComponent {
  ...
  React4j_ProtectedMemoizeComponent(@Nonnull final NativeComponent nativeComponent) {
  ...
  private static final class LiteNativeReactComponent extends NativeAdapterComponent<ProtectedMemoizeComponent> implements OnComponentWillUnmount {
    @JsConstructor
    ...
    protected ProtectedMemoizeComponent createComponent() {
      return new Arez_React4j_ProtectedMemoizeComponent( this );
    }

    @Override
    public final void componentWillUnmount() {
      ((React4j_ProtectedMemoizeComponent) component() ).$$react4j$$_componentWillUnmount();
    }

    @Override
    @Nullable
    public final ReactNode render() {
      return ((React4j_ProtectedMemoizeComponent) component() ).render();
    }
  }

  private static final class NativeReactComponent extends NativeAdapterComponent<ProtectedMemoizeComponent> implements OnComponentDidMount, OnComponentDidUpdate, OnComponentWillUnmount {
    @JsConstructor
    ...
    public final void componentDidMount() {
      ((React4j_ProtectedMemoizeComponent) component() ).$$react4j$$_componentDidMount();
    }

    @Override
    public final void componentDidUpdate(@Nonnull final JsPropertyMap<Object> prevProps) {
      ((React4j_ProtectedMemoizeComponent) component() ).$$react4j$$_componentDidUpdate();
    }
