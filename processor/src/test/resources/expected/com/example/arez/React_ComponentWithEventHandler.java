...
final class React_ComponentWithEventHandler extends NativeAdapterComponent<BaseProps, BaseState, ComponentWithEventHandler> implements ComponentWithEventHandlerLifecycle {
  @JsConstructor
  React_ComponentWithEventHandler(@Nonnull final BaseProps props) {
    super( props );
  }
