...
abstract class React4j_AlreadyPrioritizedMemoizeComponent extends AlreadyPrioritizedMemoizeComponent {
  ...
  private static final class LiteNativeReactComponent extends NativeAdapterComponent<AlreadyPrioritizedMemoizeComponent> implements LiteLifecycle {
    ...
    public final void componentWillUnmount() {
      ((Arez_React4j_AlreadyPrioritizedMemoizeComponent) component() ).$$react4j$$_componentWillUnmount();
    }
  }
  ...
  private static final class NativeReactComponent extends NativeAdapterComponent<AlreadyPrioritizedMemoizeComponent> implements Lifecycle {
    ...
    public final void componentDidUpdate(@Nonnull JsPropertyMap<Object> prevProps) {
      ((Arez_React4j_AlreadyPrioritizedMemoizeComponent) component() ).$$react4j$$_componentDidUpdate( prevProps );
    }
