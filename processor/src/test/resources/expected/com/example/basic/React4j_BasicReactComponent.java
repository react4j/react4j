...
abstract class React4j_BasicReactComponent extends BasicReactComponent {
  React4j_BasicReactComponent(@Nonnull final NativeComponent $$react4j$$_nativeComponent) {
  ...
  private void $$react4j$$_componentWillUnmount() {
    ((Arez_React4j_BasicReactComponent) this).dispose();
  }
  ...
  private static final class LiteNativeReactComponent extends NativeComponent implements OnShouldComponentUpdate {
    @Nonnull
    private final React4j_BasicReactComponent $$react4j$$_component;

    @JsConstructor
    LiteNativeReactComponent(@Nullable final JsPropertyMap<Object> props) {
      super( props );
      $$react4j$$_component = new Arez_React4j_BasicReactComponent( this );
    }
