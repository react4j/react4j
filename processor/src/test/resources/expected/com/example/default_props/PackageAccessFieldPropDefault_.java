...
class PackageAccessFieldPropDefault_ extends PackageAccessFieldPropDefault {
  ...
  private static final class NativeReactComponent extends NativeAdapterComponent<BaseState, BaseContext, PackageAccessFieldPropDefault> {
    ...
    protected PackageAccessFieldPropDefault createComponent() {
      return new PackageAccessFieldPropDefault_();
    }
  }
}
