...
class PublicMethodPropDefault_ extends PublicMethodPropDefault {
  ...
  private static final class NativeReactComponent extends NativeAdapterComponent<BaseState, BaseContext, PublicMethodPropDefault> {
    ...
    protected PublicMethodPropDefault createComponent() {
      return new PublicMethodPropDefault_();
    }
  }
}
