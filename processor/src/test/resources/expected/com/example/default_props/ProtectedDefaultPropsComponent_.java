...
class ProtectedDefaultPropsComponent_ extends ProtectedDefaultPropsComponent {
  ...
  private static final class NativeReactComponent extends NativeAdapterComponent<BaseState, BaseContext, ProtectedDefaultPropsComponent> {
    ...
    @Override
    protected ProtectedDefaultPropsComponent createComponent() {
      return new ProtectedDefaultPropsComponent_();
    }
  }
}
