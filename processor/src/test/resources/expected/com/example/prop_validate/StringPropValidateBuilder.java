...
class StringPropValidateBuilder {
  private StringPropValidateBuilder() {
  }
  ...
  private static class Builder implements Builder1, Builder2 {
    ...
    public final ReactNode myProp(final String myProp) {
      _props.set( React4j_StringPropValidate.Props.myProp, myProp );
      return build();
    }

    @Nonnull
    public final ReactNode build() {
      return React.createElement( React4j_StringPropValidate.Factory.TYPE, Js.uncheckedCast( _props ) );
    }
  }
}
