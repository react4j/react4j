...
abstract class React4j_ExplicitNamePropValidate extends ExplicitNamePropValidate {
  React4j_ExplicitNamePropValidate(@Nonnull final NativeComponent $$react4j$$_nativeComponent) {
  ...
  private static final class LiteNativeReactComponent extends NativeComponent implements OnShouldComponentUpdate {
    @Nonnull
    private final React4j_ExplicitNamePropValidate $$react4j$$_component;

    @JsConstructor
    LiteNativeReactComponent(@Nullable final JsPropertyMap<Object> props) {
      super( props );
      $$react4j$$_component = new Arez_React4j_ExplicitNamePropValidate( this );
      if ( React.shouldValidatePropValues() ) {
        assert null != props;
