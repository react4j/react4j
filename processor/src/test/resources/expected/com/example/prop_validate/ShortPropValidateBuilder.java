...
class ShortPropValidateBuilder {
  ...
  private static class Builder implements Builder1, Builder2 {
    private final ReactElement _element = ReactElement.createComponentElement( React4j_ShortPropValidate.Factory.TYPE );
    ...
    public final ReactNode myProp(final short myProp) {
      _element.props().set( React4j_ShortPropValidate.Props.myProp, myProp );
      return build();
    }
