...
abstract class React4j_FloatPropValidate extends FloatPropValidate {
  React4j_FloatPropValidate(@Nonnull final NativeComponent nativeComponent) {
  ...
  private static final class LiteNativeReactComponent extends NativeAdapterComponent<FloatPropValidate> {
    ...
    LiteNativeReactComponent(@Nullable final JsPropertyMap<Object> props) {
      ...
      if ( React.shouldValidatePropValues() ) {
        assert null != props;
        ((React4j_FloatPropValidate) component() ).$$react4j$$_validatePropValues( props );
      }
    }

    @Override
    protected FloatPropValidate createComponent() {
      return new Arez_React4j_FloatPropValidate( this );
    }

    @Override
    @Nullable
    public final ReactNode render() {
      return ((React4j_FloatPropValidate) component() ).render();
    }
  }

  private static final class NativeReactComponent extends NativeAdapterComponent<FloatPropValidate> implements OnShouldComponentUpdate {
    @JsConstructor
