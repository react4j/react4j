...
abstract class React4j_LongPropValidate extends LongPropValidate {
  React4j_LongPropValidate(@Nonnull final NativeComponent nativeComponent) {
  ...
  private static final class LiteNativeReactComponent extends NativeAdapterComponent<LongPropValidate> {
    ...
    LiteNativeReactComponent(@Nullable final JsPropertyMap<Object> props) {
      ...
      if ( React.shouldValidatePropValues() ) {
        assert null != props;
        ((React4j_LongPropValidate) component() ).$$react4j$$_validatePropValues( props );
      }
    }

    @Override
    protected LongPropValidate createComponent() {
      return new Arez_React4j_LongPropValidate( this );
    }

    @Override
    @Nullable
    public final ReactNode render() {
      return ((React4j_LongPropValidate) component() ).render();
    }
  }
