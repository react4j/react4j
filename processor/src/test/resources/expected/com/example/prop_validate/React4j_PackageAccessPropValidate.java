...
abstract class React4j_PackageAccessPropValidate extends PackageAccessPropValidate {
  ...
  private static final class LiteNativeReactComponent extends NativeAdapterComponent<PackageAccessPropValidate> {
    ...
    LiteNativeReactComponent(@Nullable final JsPropertyMap<Object> props) {
      ...
      if ( React.shouldValidatePropValues() ) {
        assert null != props;
        ((React4j_PackageAccessPropValidate) component() ).$$react4j$$_validatePropValues( props );
      }
    }

    @Override
    protected PackageAccessPropValidate createComponent() {
      return new Arez_React4j_PackageAccessPropValidate( this );
    }

    @Override
    @Nullable
    public final ReactNode render() {
      return ((React4j_PackageAccessPropValidate) component() ).render();
    }
  }
