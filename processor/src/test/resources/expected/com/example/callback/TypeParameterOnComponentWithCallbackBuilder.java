...
class TypeParameterOnComponentWithCallbackBuilder {
  private TypeParameterOnComponentWithCallbackBuilder() {
  }
  ...
  private static class Builder<T> implements Builder1<T>, Builder2<T> {
    ...
    public final ReactNode build() {
      return React.createElement( React4j_TypeParameterOnComponentWithCallback.TYPE, Js.uncheckedCast( _props ) );
    }
  }
}
