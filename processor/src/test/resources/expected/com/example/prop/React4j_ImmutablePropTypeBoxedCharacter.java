...
abstract class React4j_ImmutablePropTypeBoxedCharacter extends ImmutablePropTypeBoxedCharacter {
  React4j_ImmutablePropTypeBoxedCharacter(@Nonnull final NativeComponent nativeComponent) {
  ...
  private static ComponentConstructorFunction getConstructorFunction() {
    ...
    if ( React.enableComponentNames() ) {
      Js.asPropertyMap( componentConstructor ).set( "displayName", "ImmutablePropTypeBoxedCharacter" );
    }
  ...
  private static final class LiteNativeReactComponent extends NativeComponent {
    private React4j_ImmutablePropTypeBoxedCharacter $$react4j$$_component;

    @JsConstructor
    LiteNativeReactComponent(@Nullable final JsPropertyMap<Object> props) {
      super( props );
      $$react4j$$_component = new Arez_React4j_ImmutablePropTypeBoxedCharacter( this );
    }
