...
class CollectionPropComponentBuilder {
  ...
  private static class Builder implements Builder1, Builder2 {
    ...
    public final ReactNode myProp(final Collection<String> myProp) {
      _props.set( React4j_CollectionPropComponent.Props.myProp, myProp );
      return build();
    }

    @Nonnull
    public final ReactNode build() {
      return React.createElement( React4j_CollectionPropComponent.Factory.TYPE, Js.uncheckedCast( _props ) );
    }
  }
}
