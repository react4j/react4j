...
class CollectionArrayPropComponentBuilder {
  ...
  private static class Builder implements Builder1, Builder2 {
    ...
    public final ReactNode myProp(final String[] myProp) {
      _props.set( React4j_CollectionArrayPropComponent.Props.myProp, myProp );
      return build();
    }

    @Nonnull
    public final ReactNode build() {
      return React.createElement( React4j_CollectionArrayPropComponent.Factory.TYPE, Js.uncheckedCast( _props ) );
    }
  }
}
