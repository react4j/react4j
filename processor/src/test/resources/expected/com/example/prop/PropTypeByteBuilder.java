...
class PropTypeByteBuilder {
  private PropTypeByteBuilder() {
  }
  ...
  private static class Builder implements Builder1, Builder2 {
    ...
    public final ReactNode myProp(final byte myProp) {
      _props.set( React4j_PropTypeByte.Props.myProp, myProp );
      return build();
    }

    @Nonnull
    public final ReactNode build() {
      return React.createElement( React4j_PropTypeByte.Factory.TYPE, Js.uncheckedCast( _props ) );
    }
  }
}
