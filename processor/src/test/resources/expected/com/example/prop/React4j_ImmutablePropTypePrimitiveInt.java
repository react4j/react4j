...
@ArezComponent(
    name = "ImmutablePropTypePrimitiveInt",
...
abstract class React4j_ImmutablePropTypePrimitiveInt extends ImmutablePropTypePrimitiveInt {
  React4j_ImmutablePropTypePrimitiveInt(@Nonnull final NativeComponent nativeComponent) {
  ...
  private static ComponentConstructorFunction getConstructorFunction() {
    ...
    if ( React.enableComponentNames() ) {
      Js.asPropertyMap( componentConstructor ).set( "displayName", "ImmutablePropTypePrimitiveInt" );
    }
  ...
  private static final class LiteNativeReactComponent extends NativeComponent {
    private React4j_ImmutablePropTypePrimitiveInt $$react4j$$_component;

    @JsConstructor
    LiteNativeReactComponent(@Nullable final JsPropertyMap<Object> props) {
      super( props );
      $$react4j$$_component = new Arez_React4j_ImmutablePropTypePrimitiveInt( this );
    }
