...
class ObservableViaComputedPropBuilder {
  private ObservableViaComputedPropBuilder() {
  }
  ...
  private static class Builder implements Builder1, Builder2 {
    ...
    public final ReactNode value(final Object value) {
      _props.set( React4j_ObservableViaComputedProp.PROP_value, value );
      return build();
    }

    @Nonnull
    public final ReactNode build() {
      return React.createElement( React4j_ObservableViaComputedProp.TYPE, Js.uncheckedCast( _props ) );
    }
  }
}
