...
@ArezComponent(
    name = "ComponentWithActAsComponentArezProp",
    disposeNotifier = Feature.DISABLE,
    inject = InjectMode.NONE
)
@Generated("react4j.processor.ReactProcessor")
abstract class React4j_ComponentWithActAsComponentArezProp extends ComponentWithActAsComponentArezProp {
  private int $$react4j$$_state;

  React4j_ComponentWithActAsComponentArezProp(
  ...
  private static ComponentConstructorFunction getConstructorFunction() {
    ...
    if ( React.enableComponentNames() ) {
      Js.asPropertyMap( componentConstructor ).set( "displayName", "ComponentWithActAsComponentArezProp" );
    }
  ...
  private void $$react4j$$_componentWillUnmount() {
    ...
    ((Arez_React4j_ComponentWithActAsComponentArezProp) this).dispose();
  }
  ...
  protected ReactNode render() {
    ...
    final ComponentWithActAsComponentArezProp.Model $$react4jv$$_getModel = getModel();
  ...
  private static final class LiteNativeReactComponent extends NativeComponent implements OnShouldComponentUpdate, OnComponentWillUnmount {
    @Nonnull
    private final React4j_ComponentWithActAsComponentArezProp $$react4j$$_component;

    @JsConstructor
    LiteNativeReactComponent(@Nullable final JsPropertyMap<Object> props) {
      super( props );
      $$react4j$$_component = new Arez_React4j_ComponentWithActAsComponentArezProp( this );
    }
