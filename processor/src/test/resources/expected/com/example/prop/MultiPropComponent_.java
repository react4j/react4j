...
class MultiPropComponent_ extends MultiPropComponent {
  ...
  private static final class NativeReactComponent extends NativeAdapterComponent<BaseProps, BaseState, BaseContext, MultiPropComponent> {
    ...
    protected MultiPropComponent createComponent() {
      return new MultiPropComponent_();
    }
  }
}
