...
@ArezComponent(
    name = "ImmutablePropTypeArezComponent",
    disposeNotifier = Feature.DISABLE,
    allowEmpty = true,
    inject = InjectMode.NONE
)
@Generated("react4j.processor.ReactProcessor")
abstract class React4j_ImmutablePropTypeArezComponent extends ImmutablePropTypeArezComponent {
  ...
  private static ComponentConstructorFunction getConstructorFunction() {
    ...
    if ( React.enableComponentNames() ) {
      Js.asPropertyMap( componentConstructor ).set( "displayName", "ImmutablePropTypeArezComponent" );
    }
    return componentConstructor;
  }

  @Override
  protected ImmutablePropTypeArezComponent.MyComponent getMyProp() {
  ...
  private static final class LiteNativeReactComponent extends NativeComponent implements OnShouldComponentUpdate {
    @Nonnull
    private final React4j_ImmutablePropTypeArezComponent $$react4j$$_component;

    @JsConstructor
    LiteNativeReactComponent(@Nullable final JsPropertyMap<Object> props) {
      super( props );
      $$react4j$$_component = new Arez_React4j_ImmutablePropTypeArezComponent( this );
    }
