...
class React4j_CollectionHashSetPropComponent extends CollectionHashSetPropComponent {
  ...
  private static final class LiteNativeReactComponent extends NativeAdapterComponent<CollectionHashSetPropComponent> {
    @JsConstructor
  ...
  private static final class NativeReactComponent extends NativeAdapterComponent<CollectionHashSetPropComponent> implements Lifecycle {
    @JsConstructor
    ...
    public void componentDidMount() {
      ((React4j_CollectionHashSetPropComponent) component() ).$$react4j$$_componentDidMount();
    }

    @Override
    public void componentDidUpdate(@Nonnull final JsPropertyMap<Object> prevProps) {
      ((React4j_CollectionHashSetPropComponent) component() ).$$react4j$$_componentDidUpdate( prevProps );
    }
  }
}
