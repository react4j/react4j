...
abstract class React4j_NonDisposableDisposableProp extends NonDisposableDisposableProp {
  ...
  React4j_NonDisposableDisposableProp(@Nonnull final NativeComponent nativeComponent) {
  ...
  private static final class LiteNativeReactComponent extends NativeAdapterComponent<NonDisposableDisposableProp> implements OnComponentWillUnmount {
    @JsConstructor
    ...
    protected NonDisposableDisposableProp createComponent() {
      return new Arez_React4j_NonDisposableDisposableProp( this );
    }

    @Override
    public final void componentWillUnmount() {
      ((React4j_NonDisposableDisposableProp) component() ).$$react4j$$_componentWillUnmount();
    }

    @Override
    @Nullable
    public final ReactNode render() {
      return ((React4j_NonDisposableDisposableProp) component() ).render();
    }
  }

  private static final class NativeReactComponent extends NativeAdapterComponent<NonDisposableDisposableProp> implements OnComponentDidMount, OnComponentDidUpdate, OnComponentWillUnmount {
    @JsConstructor
    ...
    public final void componentDidMount() {
      ((React4j_NonDisposableDisposableProp) component() ).$$react4j$$_componentDidMount();
    }

    @Override
    public final void componentDidUpdate(@Nonnull final JsPropertyMap<Object> prevProps) {
      ((React4j_NonDisposableDisposableProp) component() ).$$react4j$$_componentDidUpdate();
    }
