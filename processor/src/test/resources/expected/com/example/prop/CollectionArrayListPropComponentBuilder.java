...
class CollectionArrayListPropComponentBuilder {
  ...
  private static class Builder implements Builder1, Builder2 {
    ...
    public final ReactNode myProp(final ArrayList<String> myProp) {
      _props.set( React4j_CollectionArrayListPropComponent.Props.myProp, myProp );
      return build();
    }

    @Nonnull
    public final ReactNode build() {
      return React.createElement( React4j_CollectionArrayListPropComponent.Factory.TYPE, Js.uncheckedCast( _props ) );
    }
  }
}
