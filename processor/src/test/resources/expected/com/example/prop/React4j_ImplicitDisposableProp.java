...
abstract class React4j_ImplicitDisposableProp extends ImplicitDisposableProp {
  ...
  private static final class LiteNativeReactComponent extends NativeAdapterComponent<ImplicitDisposableProp> implements OnComponentWillUnmount {
    ...
    protected ImplicitDisposableProp createComponent() {
      return new Arez_React4j_ImplicitDisposableProp( this );
    }
  ...
  private static final class NativeReactComponent extends NativeAdapterComponent<ImplicitDisposableProp> implements OnComponentDidMount, OnComponentDidUpdate, OnComponentWillUnmount {
    ...
    public final void componentDidMount() {
      ((React4j_ImplicitDisposableProp) component() ).$$react4j$$_componentDidMount();
    }

    @Override
    public final void componentDidUpdate(@Nonnull final JsPropertyMap<Object> prevProps) {
      ((React4j_ImplicitDisposableProp) component() ).$$react4j$$_componentDidUpdate();
    }
