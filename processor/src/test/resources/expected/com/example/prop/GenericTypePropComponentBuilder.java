...
class GenericTypePropComponentBuilder {
  ...
  private static class Builder<T> implements Builder1<T>, Builder2<T> {
    ...
    public final ReactNode value(final T value) {
      _props.set( React4j_GenericTypePropComponent.Props.value, value );
      return build();
    }

    @Nonnull
    public final ReactNode build() {
      return React.createElement( React4j_GenericTypePropComponent.Factory.TYPE, Js.uncheckedCast( _props ) );
    }
  }
}
