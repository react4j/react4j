...
class PropTypeIntBuilder {
  ...
  private static class Builder implements Builder1, Builder2 {
    ...
    public final ReactNode myProp(final int myProp) {
      _props.set( React4j_PropTypeInt.Props.myProp, myProp );
      return build();
    }

    @Nonnull
    public final ReactNode build() {
      return React.createElement( React4j_PropTypeInt.Factory.TYPE, Js.uncheckedCast( _props ) );
    }
  }
}
