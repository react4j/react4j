...
class ImplicitDisposablePropBuilder {
  ...
  private static class Builder implements Builder1, Builder2 {
    ...
    public final ReactNode model(final ImplicitDisposableProp.Model model) {
      _props.set( React4j_ImplicitDisposableProp.Props.model, model );
      return build();
    }

    @Nonnull
    public final ReactNode build() {
      return React.createElement( React4j_ImplicitDisposableProp.Factory.TYPE, Js.uncheckedCast( _props ) );
    }
  }
}
