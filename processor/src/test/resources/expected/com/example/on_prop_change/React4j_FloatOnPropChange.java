...
class React4j_FloatOnPropChange extends FloatOnPropChange {
  ...
  private static final class LiteNativeReactComponent extends NativeAdapterComponent<FloatOnPropChange> implements LiteLifecycle {
    @JsConstructor
  ...
  private static final class NativeReactComponent extends NativeAdapterComponent<FloatOnPropChange> implements Lifecycle {
    @JsConstructor
    ...
    public void componentDidMount() {
      ((React4j_FloatOnPropChange) component() ).$$react4j$$_componentDidMount();
    }
    ...
    public void componentDidUpdate(@Nonnull final JsPropertyMap<Object> prevProps) {
      ((React4j_FloatOnPropChange) component() ).$$react4j$$_componentDidUpdate( prevProps );
    }
  }
}
