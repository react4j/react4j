...
abstract class React4j_NullableOnPropChange extends NullableOnPropChange {
  React4j_NullableOnPropChange(@Nonnull final NativeComponent nativeComponent) {
  ...
  private static final class NativeReactComponent extends NativeAdapterComponent<NullableOnPropChange> implements OnGetSnapshotBeforeUpdate {
    @JsConstructor
    ...
    protected NullableOnPropChange createComponent() {
      return new Arez_React4j_NullableOnPropChange( this );
    }
    ...
    public final ReactNode render() {
      return ((React4j_NullableOnPropChange) component() ).render();
    }
  }
}
