...
class React4j_DoubleOnPropChange extends DoubleOnPropChange {
  ...
  private static final class LiteNativeReactComponent extends NativeAdapterComponent<DoubleOnPropChange> implements LiteLifecycle {
    @JsConstructor
    ...
    protected DoubleOnPropChange createComponent() {
      return new React4j_DoubleOnPropChange();
    }
  ...
  private static final class NativeReactComponent extends NativeAdapterComponent<DoubleOnPropChange> implements Lifecycle {
    @JsConstructor
    ...
    public void componentDidMount() {
      ((React4j_DoubleOnPropChange) component() ).$$react4j$$_componentDidMount();
    }
    ...
    public void componentDidUpdate(@Nonnull final JsPropertyMap<Object> prevProps) {
      ((React4j_DoubleOnPropChange) component() ).$$react4j$$_componentDidUpdate( prevProps );
    }
  }
}
