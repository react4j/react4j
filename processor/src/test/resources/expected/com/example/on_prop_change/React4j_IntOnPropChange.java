...
abstract class React4j_IntOnPropChange extends IntOnPropChange {
  React4j_IntOnPropChange(@Nonnull final NativeComponent nativeComponent) {
  ...
  private static final class NativeReactComponent extends NativeAdapterComponent<IntOnPropChange> implements OnGetSnapshotBeforeUpdate {
    @JsConstructor
    ...
    protected IntOnPropChange createComponent() {
      return new Arez_React4j_IntOnPropChange( this );
    }
    ...
    public final ReactNode render() {
      return ((React4j_IntOnPropChange) component() ).render();
    }
  }
}
