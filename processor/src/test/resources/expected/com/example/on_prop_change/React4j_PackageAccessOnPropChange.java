...
class React4j_PackageAccessOnPropChange extends PackageAccessOnPropChange {
  @Nonnull
  ...
  private static final class LiteNativeReactComponent extends NativeAdapterComponent<PackageAccessOnPropChange> implements LiteLifecycle {
    @JsConstructor
    ...
    @Override
    protected PackageAccessOnPropChange createComponent() {
      return new React4j_PackageAccessOnPropChange();
    }
  ...
  private static final class NativeReactComponent extends NativeAdapterComponent<PackageAccessOnPropChange> implements Lifecycle {
    @JsConstructor
    ...
    public void componentDidMount() {
      ((React4j_PackageAccessOnPropChange) component() ).$$react4j$$_componentDidMount();
    }
    ...
    public void componentDidUpdate(@Nonnull final JsPropertyMap<Object> prevProps) {
      ((React4j_PackageAccessOnPropChange) component() ).$$react4j$$_componentDidUpdate( prevProps );
    }
  }
}
