...
class React4j_ProtectedAccessOnPropChange extends ProtectedAccessOnPropChange {
  ...
  private static final class LiteNativeReactComponent extends NativeAdapterComponent<ProtectedAccessOnPropChange> implements LiteLifecycle {
    @JsConstructor
  ...
  private static final class NativeReactComponent extends NativeAdapterComponent<ProtectedAccessOnPropChange> implements Lifecycle {
    ...
    public void componentDidMount() {
      ((React4j_ProtectedAccessOnPropChange) component() ).$$react4j$$_componentDidMount();
    }
