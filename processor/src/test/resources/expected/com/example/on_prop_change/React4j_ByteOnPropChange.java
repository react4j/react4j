...
abstract class React4j_ByteOnPropChange extends ByteOnPropChange {
  React4j_ByteOnPropChange(@Nonnull final NativeComponent nativeComponent) {
  ...
  private static final class NativeReactComponent extends NativeAdapterComponent<ByteOnPropChange> implements OnGetSnapshotBeforeUpdate {
    @JsConstructor
    ...
    protected ByteOnPropChange createComponent() {
      return new Arez_React4j_ByteOnPropChange( this );
    }

    @Override
    public final Object getSnapshotBeforeUpdate(@Nonnull final JsPropertyMap<Object> prevProps,
        @Nonnull final JsPropertyMap<Object> prevState) {
      ((React4j_ByteOnPropChange) component() ).$$react4j$$_componentPreUpdate( prevProps );
      return null;
    }
    ...
    public final ReactNode render() {
      return ((React4j_ByteOnPropChange) component() ).render();
    }
  }
}
