...
class React4j_AssembledComponent extends AssembledComponent {
  ...
  private static final class LiteNativeReactComponent extends NativeAdapterComponent<AssembledComponent> {
    @JsConstructor
  ...
  private static final class NativeReactComponent extends NativeAdapterComponent<AssembledComponent> implements Lifecycle {
    @JsConstructor
