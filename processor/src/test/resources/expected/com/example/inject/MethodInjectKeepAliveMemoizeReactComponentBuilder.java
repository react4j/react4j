...
public class MethodInjectKeepAliveMemoizeReactComponentBuilder {
  private MethodInjectKeepAliveMemoizeReactComponentBuilder() {
  }
  ...
  private static class Builder implements Step1, Step2 {
    private final ReactElement _element = ReactElement.createComponentElement( React4j_MethodInjectKeepAliveMemoizeReactComponent.Factory.TYPE );
