...
abstract class React4j_MethodInjectReactComponent extends MethodInjectReactComponent {
  React4j_MethodInjectReactComponent(@Nonnull @PerInstance final NativeComponent nativeComponent) {
  ...
  private static final class NativeReactComponent extends NativeComponent {
    private React4j_MethodInjectReactComponent $$react4j$$_component;

    @JsConstructor
    NativeReactComponent(@Nullable final JsPropertyMap<Object> props) {
      super( props );
      $$react4j$$_component = MethodInjectReactComponentDaggerComponentExtension.InjectSupport.create( this );
    }
