...
abstract class React4j_MixedInjectComponent extends MixedInjectComponent {
  ...
  private static ComponentConstructorFunction getConstructorFunction() {
    ...
    if ( React.enableComponentNames() ) {
      Js.asPropertyMap( componentConstructor ).set( "displayName", "MixedInjectComponent" );
    }
  ...
  private void $$react4j$$_componentWillUnmount() {
    ((Arez_React4j_MixedInjectComponent) this).dispose();
  }
  ...
  private static final class LiteNativeReactComponent extends NativeComponent implements OnShouldComponentUpdate {
    private React4j_MixedInjectComponent $$react4j$$_component;

    @JsConstructor
    LiteNativeReactComponent(@Nullable final JsPropertyMap<Object> props) {
      super( props );
      $$react4j$$_component = MixedInjectComponentDaggerComponentExtension.InjectSupport.create( this );
    }
