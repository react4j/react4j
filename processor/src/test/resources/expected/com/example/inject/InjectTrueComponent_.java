...
class InjectTrueComponent_ extends InjectTrueComponent {
  ...
  private static ComponentConstructorFunction<BaseProps, BaseContext> getConstructorFunction() {
    ...
    if ( ReactConfig.enableComponentNames() ) {
      JsPropertyMap.of( componentConstructor ).set( "displayName", "InjectTrueComponent" );
    }
    return componentConstructor;
  }

  static final class NativeReactComponent extends NativeAdapterComponent<BaseProps, BaseState, BaseContext, InjectTrueComponent> {
