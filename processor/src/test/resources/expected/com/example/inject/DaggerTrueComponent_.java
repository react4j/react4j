...
class DaggerTrueComponent_ extends DaggerTrueComponent {
  ...
  private static ComponentConstructorFunction<BaseProps, BaseContext> getConstructorFunction() {
    ...
    if ( ReactConfig.enableComponentNames() ) {
      JsPropertyMap.of( componentConstructor ).set( "displayName", "DaggerTrueComponent" );
    }
    return componentConstructor;
  }

  static final class NativeReactComponent extends NativeAdapterComponent<BaseProps, BaseState, BaseContext, DaggerTrueComponent> {
