...
class MethodInjectReactComponentBuilder {
  private MethodInjectReactComponentBuilder() {
  }
  ...
  private static class Builder implements Step1, Step2 {
    private final ReactElement _element = ReactElement.createComponentElement( React4j_MethodInjectReactComponent.Factory.TYPE );
