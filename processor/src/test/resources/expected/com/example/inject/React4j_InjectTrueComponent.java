...
class React4j_InjectTrueComponent extends InjectTrueComponent {
  ...
  private static final class LiteNativeReactComponent extends NativeAdapterComponent<InjectTrueComponent> {
    @JsConstructor
  ...
  private static final class NativeReactComponent extends NativeAdapterComponent<InjectTrueComponent> implements Lifecycle {
    @JsConstructor
    ...
    public void componentDidMount() {
      ((React4j_InjectTrueComponent) component() ).$$react4j$$_componentDidMount();
    }

    @Override
    public void componentDidUpdate(@Nonnull final JsPropertyMap<Object> prevProps) {
      ((React4j_InjectTrueComponent) component() ).$$react4j$$_componentDidUpdate( prevProps );
    }
  }
}
