    ...
    return new Object[][]
      {
        ...
        new Object[]{ "com.example.default_props.DefaultFieldContextPropModel", "@PropDefault target must not be specified for a @Prop method that specifies source=CONTEXT" },
        new Object[]{ "com.example.default_props.DefaultMethodContextPropModel", "@PropDefault target must not be specified for a @Prop method that specifies source=CONTEXT" },
