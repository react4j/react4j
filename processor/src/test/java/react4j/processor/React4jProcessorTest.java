    ...
    return new Object[][]
      {
        ...
        new Object[]{ "com.example.default_props.BadNameFieldPropDefault",
                      "@InputDefault target specified an invalid name '-myProp'. The name must be a valid java identifier." },
        ...
        new Object[]{ "com.example.default_props.DuplicatePropDefault",
                      "@InputDefault target duplicates existing method named getMyPropDefault" },
        new Object[]{ "com.example.default_props.DuplicatePropDefault2",
                      "@InputDefault target duplicates existing method named getMyPropDefault1" },
        new Object[]{ "com.example.default_props.DuplicatePropDefault3",
                      "@InputDefault target duplicates existing field named DEFAULT_MY_PROP" },
        new Object[]{ "com.example.default_props.InstanceFieldPropDefault", "@InputDefault target must be static" },
        new Object[]{ "com.example.default_props.InstanceMethodPropDefault", "@InputDefault target must be static" },
        new Object[]{ "com.example.default_props.MissingPropFieldPropDefault",
                      "@InputDefault target for input named 'myProp' has no corresponding @Input annotated method." },
        new Object[]{ "com.example.default_props.MissingPropMethodPropDefault",
                      "@InputDefault target for input named 'myProp' has no corresponding @Input annotated method." },
        new Object[]{ "com.example.default_props.NonFinalFieldPropDefault", "@InputDefault target must be final" },
        new Object[]{ "com.example.default_props.ParameterizedMethodPropDefault",
                      "@InputDefault target must not have any parameters" },
        new Object[]{ "com.example.default_props.PrivateFieldPropDefault", "@InputDefault target must not be private" },
        new Object[]{ "com.example.default_props.PrivateMethodPropDefault", "@InputDefault target must not be private" },
        ...
        new Object[]{ "com.example.on_prop_change.ReturnOnPropChange", "@OnInputChange target must not return a value" },
