    ...
    return new Object[][]
      {
        ...
        new Object[]{ "com.example.render.MissingRenderComponent",
                      "@View target must contain a method annotated with the @Render annotation or must specify requireRender=false" },
        new Object[]{ "com.example.render.NoRenderNoLifecycleView",
                      "@View target must contain lifecycle methods if the the @View(requireRender=false) parameter is specified" },
        new Object[]{ "com.example.render.UnexpectedRenderComponent",
                      "@View target must not contain a method annotated with the @Render annotation or must not specify requireRender=false" },
