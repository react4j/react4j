    ...
    return new Object[][]
      {
        ...
        new Object[]{ "com.example.on_prop_change.VoidOnPropChange", false, false },
    ...
    return new Object[][]
      {
        ...
        new Object[]{ "com.example.on_prop_change.BadName1OnPropChange",
                      "@OnPropChange target specified an invalid name 'long'. The name must not be a java keyword." },
        new Object[]{ "com.example.on_prop_change.BadName2OnPropChange",
                      "@OnPropChange target specified an invalid name '---------'. The name must be a valid java identifier." },
        new Object[]{ "com.example.on_prop_change.BadName3OnPropChange",
                      "@OnPropChange target for prop named 'noExisto' has no corresponding @Prop annotated method." },
        new Object[]{ "com.example.on_prop_change.BadNullability1OnPropChange",
                      "@OnPropChange target has a parameter that has a nullability annotation incompatible with the associated @Prop method named getMyProp" },
        new Object[]{ "com.example.on_prop_change.BadNullability2OnPropChange",
                      "@OnPropChange target has a parameter that has a nullability annotation incompatible with the associated @Prop method named getMyProp" },
        new Object[]{ "com.example.on_prop_change.BadParamCount1OnPropChange",
                      "@OnPropChange target must have either 1 or 2 parameters" },
        new Object[]{ "com.example.on_prop_change.BadType1OnPropChange",
                      "@OnPropChange target has a parameter type that is not assignable to the return type of the associated @Prop annotated method." },
        new Object[]{ "com.example.on_prop_change.DuplicateOnPropChange",
                      "@OnPropChange target duplicates existing method named onMyPropChange" },
        new Object[]{ "com.example.on_prop_change.MissingPropOnPropChange",
                      "@OnPropChange target for prop named 'myProp' has no corresponding @Prop annotated method." },
