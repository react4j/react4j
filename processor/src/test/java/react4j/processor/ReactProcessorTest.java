    ...
    return new Object[][]
      {
        ...
        new Object[]{ "com.example.on_prop_changed.CharOnPropChanged", false, false },
        new Object[]{ "com.example.on_prop_changed.DoubleOnPropChanged", false, false },
        new Object[]{ "com.example.on_prop_changed.ExplicitNameOnPropChanged", false, false },
        new Object[]{ "com.example.on_prop_changed.FloatOnPropChanged", false, false },
        new Object[]{ "com.example.on_prop_changed.IntOnPropChanged", false, false },
        new Object[]{ "com.example.on_prop_changed.LongOnPropChanged", false, false },
        new Object[]{ "com.example.on_prop_changed.NonnullOnPropChanged", false, false },
        new Object[]{ "com.example.on_prop_changed.NullableOnPropChanged", false, false },
        new Object[]{ "com.example.on_prop_changed.OtherTypeOnPropChanged", false, false },
        new Object[]{ "com.example.on_prop_changed.PackageAccessOnPropChanged", false, false },
        new Object[]{ "com.example.on_prop_changed.ParameterizedOnPropChanged", false, false },
        new Object[]{ "com.example.on_prop_changed.ProtectedAccessOnPropChanged", false, false },
        new Object[]{ "com.example.on_prop_changed.ShortOnPropChanged", false, false },
        new Object[]{ "com.example.on_prop_changed.StringOnPropChanged", false, false },
        new Object[]{ "com.example.on_prop_changed.VoidOnPropChanged", false, false },
        ...
        new Object[]{ "com.example.prop.ObservableViaComputedProp", false, false },
    ...
    return new Object[][]
      {
        ...
        new Object[]{ "com.example.arez.ComputedOnPrivateComponent", "@Computed target must not be private" },
        ...
        new Object[]{ "com.example.on_prop_changed.BadName1OnPropChanged",
                      "@OnPropChanged target specified an invalid name 'long'. The name must not be a java keyword." },
        new Object[]{ "com.example.on_prop_changed.BadName2OnPropChanged",
                      "@OnPropChanged target specified an invalid name '---------'. The name must be a valid java identifier." },
        new Object[]{ "com.example.on_prop_changed.BadName3OnPropChanged",
                      "@OnPropChanged target for prop named 'noExisto' has no corresponding @Prop annotated method." },
        new Object[]{ "com.example.on_prop_changed.BadNullability1OnPropChanged",
                      "@OnPropChanged target has a parameter that has a nullability annotation incompatible with the associated @Prop method named getMyProp" },
        new Object[]{ "com.example.on_prop_changed.BadNullability2OnPropChanged",
                      "@OnPropChanged target has a parameter that has a nullability annotation incompatible with the associated @Prop method named getMyProp" },
        new Object[]{ "com.example.on_prop_changed.BadParamCount1OnPropChanged",
                      "@OnPropChanged target must have either 1 or 2 parameters" },
        new Object[]{ "com.example.on_prop_changed.BadType1OnPropChanged",
                      "@OnPropChanged target has a parameter type that is not assignable to the return type of the associated @Prop annotated method." },
        new Object[]{ "com.example.on_prop_changed.DuplicateOnPropChanged",
                      "@OnPropChanged target duplicates existing method named onMyPropChanged" },
        new Object[]{ "com.example.on_prop_changed.MissingPropOnPropChanged",
                      "@OnPropChanged target for prop named 'myProp' has no corresponding @Prop annotated method." },
        new Object[]{ "com.example.on_prop_changed.PrivateOnPropChanged", "@OnPropChanged target must not be private" },
        new Object[]{ "com.example.on_prop_changed.PublicOnPropChanged", "@OnPropChanged target must not be public" },
        new Object[]{ "com.example.on_prop_changed.ReturnOnPropChanged",
                      "@OnPropChanged target must not return a value" },
        new Object[]{ "com.example.on_prop_changed.StaticOnPropChanged", "@OnPropChanged target must not be static" },
        new Object[]{ "com.example.on_prop_changed.ThrowsOnPropChanged",
                      "@OnPropChanged target must not throw any exceptions" },
