    ...
    return new Object[][]
      {
        ...
        new Object[]{ "com.example.inject.DisableInjectWithConstructorParametersComponent",
                      "@ReactComponent target has specified both inject=DISABLE but has a constructor with parameters that requires injection." },
