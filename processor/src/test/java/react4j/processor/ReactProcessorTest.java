    ...
    return new Object[][]
      {
        ...
        new Object[]{ "com.example.event_handler.BadNameComponent",
                      "@EventHandler target specified an invalid name '-fox'. The name must be a valid java identifier." },
        new Object[]{ "com.example.event_handler.BadNameComponent2",
                      "@EventHandler target specified an invalid name 'long'. The name must not be a java keyword." },
