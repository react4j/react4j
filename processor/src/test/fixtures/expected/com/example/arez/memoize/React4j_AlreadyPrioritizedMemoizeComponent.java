...
abstract class React4j_AlreadyPrioritizedMemoizeComponent extends AlreadyPrioritizedMemoizeComponent {
  ...
  private static ViewConstructorFunction getConstructorFunction() {
    ...
    if ( React.enableViewNames() ) {
      Js.asPropertyMap( viewConstructor ).set( "displayName", "AlreadyPrioritizedMemoizeComponent" );
    }
  ...
  private static final class LiteNativeView extends react4j.internal.NativeView implements OnShouldComponentUpdate, OnComponentWillUnmount {
    @Nonnull
    private final React4j_AlreadyPrioritizedMemoizeComponent $$react4j$$_view;

    @JsConstructor
    LiteNativeView(@Nullable final JsPropertyMap<Object> props) {
      super( props );
      $$react4j$$_view = new Arez_React4j_AlreadyPrioritizedMemoizeComponent( this );
    }
