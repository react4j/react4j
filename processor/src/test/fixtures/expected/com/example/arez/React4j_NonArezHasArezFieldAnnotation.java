...
abstract class React4j_NonArezHasArezFieldAnnotation extends NonArezHasArezFieldAnnotation {
  ...
  React4j_NonArezHasArezFieldAnnotation(
  ...
  private static ViewConstructorFunction getConstructorFunction() {
    ...
    if ( React.enableViewNames() ) {
      Js.asPropertyMap( viewConstructor ).set( "displayName", "NonArezHasArezFieldAnnotation" );
    }
  ...
  private static final class NativeView extends react4j.internal.NativeView implements OnShouldComponentUpdate, OnComponentWillUnmount {
    @Nonnull
    private final React4j_NonArezHasArezFieldAnnotation $$react4j$$_view;

    @JsConstructor
    NativeView(@Nullable final JsPropertyMap<Object> props) {
      super( props );
      $$react4j$$_view = new Arez_React4j_NonArezHasArezFieldAnnotation( this );
    }
