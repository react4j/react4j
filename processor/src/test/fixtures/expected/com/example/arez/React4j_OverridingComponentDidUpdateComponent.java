...
abstract class React4j_OverridingComponentDidUpdateComponent extends OverridingComponentDidUpdateComponent {
  ...
  private void $$react4j$$_componentWillUnmount() {
    ...
    ((Arez_React4j_OverridingComponentDidUpdateComponent) this).dispose();
  }
  ...
  private static final class LiteNativeReactComponent extends NativeComponent implements OnComponentDidUpdate, OnShouldComponentUpdate, OnComponentWillUnmount {
    @Nonnull
    private final React4j_OverridingComponentDidUpdateComponent $$react4j$$_component;

    @JsConstructor
    LiteNativeReactComponent(@Nullable final JsPropertyMap<Object> props) {
      super( props );
      $$react4j$$_component = new Arez_React4j_OverridingComponentDidUpdateComponent( this );
    }
