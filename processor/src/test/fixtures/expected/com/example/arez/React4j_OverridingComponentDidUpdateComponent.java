...
abstract class React4j_OverridingComponentDidUpdateComponent extends OverridingComponentDidUpdateComponent {
  ...
  private static ViewConstructorFunction getConstructorFunction() {
    ...
    if ( React.enableViewNames() ) {
      Js.asPropertyMap( viewConstructor ).set( "displayName", "OverridingComponentDidUpdateComponent" );
    }
  ...
  private static final class LiteNativeView extends react4j.internal.NativeView implements OnComponentDidUpdate, OnShouldComponentUpdate, OnComponentWillUnmount {
    @Nonnull
    private final React4j_OverridingComponentDidUpdateComponent $$react4j$$_view;

    @JsConstructor
    LiteNativeView(@Nullable final JsPropertyMap<Object> props) {
      super( props );
      $$react4j$$_view = new Arez_React4j_OverridingComponentDidUpdateComponent( this );
    }
