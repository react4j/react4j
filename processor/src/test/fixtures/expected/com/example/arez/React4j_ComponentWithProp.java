...
abstract class React4j_ComponentWithProp extends ComponentWithProp {
  ...
  React4j_ComponentWithProp(@Nonnull final react4j.internal.NativeView $$react4j$$_nativeView) {
  ...
  private static ViewConstructorFunction getConstructorFunction() {
    ...
    if ( React.enableViewNames() ) {
      Js.asPropertyMap( viewConstructor ).set( "displayName", "ComponentWithProp" );
    }
  ...
  private void $$react4j$$_componentWillUnmount() {
    ...
    ((Arez_React4j_ComponentWithProp) this).dispose();
  }
  ...
  private static final class LiteNativeView extends react4j.internal.NativeView implements OnShouldComponentUpdate, OnComponentWillUnmount {
    @Nonnull
    private final React4j_ComponentWithProp $$react4j$$_view;

    @JsConstructor
    LiteNativeView(@Nullable final JsPropertyMap<Object> props) {
      super( props );
      $$react4j$$_view = new Arez_React4j_ComponentWithProp( this );
    }
