...
abstract class React4j_ParameterizedReturnMemoizeComponent extends ParameterizedReturnMemoizeComponent {
  ...
  React4j_ParameterizedReturnMemoizeComponent(
  ...
  private static ViewConstructorFunction getConstructorFunction() {
    ...
    if ( React.enableViewNames() ) {
      Js.asPropertyMap( viewConstructor ).set( "displayName", "ParameterizedReturnMemoizeComponent" );
    }
  ...
  private void $$react4j$$_componentWillUnmount() {
    ...
    ((Arez_React4j_ParameterizedReturnMemoizeComponent) this).dispose();
  }
  ...
  private static final class LiteNativeView extends react4j.internal.NativeView implements OnShouldComponentUpdate, OnComponentWillUnmount {
    @Nonnull
    private final React4j_ParameterizedReturnMemoizeComponent $$react4j$$_view;

    @JsConstructor
    LiteNativeView(@Nullable final JsPropertyMap<Object> props) {
      super( props );
      $$react4j$$_view = new Arez_React4j_ParameterizedReturnMemoizeComponent( this );
    }
