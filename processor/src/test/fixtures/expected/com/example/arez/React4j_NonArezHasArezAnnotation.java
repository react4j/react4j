...
abstract class React4j_NonArezHasArezAnnotation extends NonArezHasArezAnnotation {
  ...
  React4j_NonArezHasArezAnnotation(
  ...
  private static ViewConstructorFunction getConstructorFunction() {
    ...
    if ( React.enableViewNames() ) {
      Js.asPropertyMap( viewConstructor ).set( "displayName", "NonArezHasArezAnnotation" );
    }
  ...
  private static final class LiteNativeView extends react4j.internal.NativeView implements OnShouldComponentUpdate {
    @Nonnull
    private final React4j_NonArezHasArezAnnotation $$react4j$$_view;

    @JsConstructor
    LiteNativeView(@Nullable final JsPropertyMap<Object> props) {
      super( props );
      $$react4j$$_view = new Arez_React4j_NonArezHasArezAnnotation( this );
    }
