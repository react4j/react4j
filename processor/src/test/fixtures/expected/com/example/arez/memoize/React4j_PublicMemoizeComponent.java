...
abstract class React4j_PublicMemoizeComponent extends PublicMemoizeComponent {
  ...
  React4j_PublicMemoizeComponent(@Nonnull final NativeComponent $$react4j$$_nativeComponent) {
  ...
  private static final class LiteNativeReactComponent extends NativeComponent implements OnShouldComponentUpdate, OnComponentWillUnmount {
    @Nonnull
    private final React4j_PublicMemoizeComponent $$react4j$$_component;

    @JsConstructor
    LiteNativeReactComponent(@Nullable final JsPropertyMap<Object> props) {
      super( props );
      $$react4j$$_component = new Arez_React4j_PublicMemoizeComponent( this );
    }
