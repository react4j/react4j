...
abstract class React4j_KeepAliveMemoizeArezView extends KeepAliveMemoizeArezView {
  @Nonnull
  ...
  React4j_KeepAliveMemoizeArezView(
  ...
  private static ViewConstructorFunction getConstructorFunction() {
    ...
    if ( React.enableViewNames() ) {
      Js.asPropertyMap( viewConstructor ).set( "displayName", "KeepAliveMemoizeArezView" );
    }
  ...
  private void $$react4j$$_componentWillUnmount() {
    ...
    ((Arez_React4j_KeepAliveMemoizeArezView) this).dispose();
  }
  ...
  private static final class LiteNativeView extends react4j.internal.NativeView implements OnShouldComponentUpdate, OnComponentWillUnmount {
    @Nonnull
    private final React4j_KeepAliveMemoizeArezView $$react4j$$_view;

    @JsConstructor
    LiteNativeView(@Nullable final JsPropertyMap<Object> props) {
      super( props );
      $$react4j$$_view = new Arez_React4j_KeepAliveMemoizeArezView( this );
    }
