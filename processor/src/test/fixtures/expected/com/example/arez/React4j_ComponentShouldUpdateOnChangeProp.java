...
abstract class React4j_ComponentShouldUpdateOnChangeProp extends ComponentShouldUpdateOnChangeProp {
  ...
  React4j_ComponentShouldUpdateOnChangeProp(
  ...
  String getValue() {
    if ( React.shouldCheckInvariants() ) {
      return null != $$react4j$$_nativeComponent.props().getAsAny( Props.value ) ? $$react4j$$_nativeComponent.props().getAsAny( Props.value ).asString() : null;
    } else {
  ...
  String getOther() {
    if ( React.shouldCheckInvariants() ) {
      return null != $$react4j$$_nativeComponent.props().getAsAny( Props.other ) ? $$react4j$$_nativeComponent.props().getAsAny( Props.other ).asString() : null;
    } else {
      return Js.uncheckedCast( $$react4j$$_nativeComponent.props().getAsAny( Props.other ) );
    }
  }
  ...
  static final class Props {
    ...
    static final String other = React.shouldMinimizePropKeys() ? "b" : "other";
  }
  ...
  private static final class LiteNativeReactComponent extends NativeComponent implements OnShouldComponentUpdate, OnComponentWillUnmount {
    @Nonnull
    private final React4j_ComponentShouldUpdateOnChangeProp $$react4j$$_component;

    @JsConstructor
    LiteNativeReactComponent(@Nullable final JsPropertyMap<Object> props) {
      super( props );
      $$react4j$$_component = new Arez_React4j_ComponentShouldUpdateOnChangeProp( this );
    }
