...
abstract class React4j_ComponentShouldUpdateOnChangeProp extends ComponentShouldUpdateOnChangeProp {
  ...
  private static ViewConstructorFunction getConstructorFunction() {
    ...
    if ( React.enableViewNames() ) {
      Js.asPropertyMap( viewConstructor ).set( "displayName", "ComponentShouldUpdateOnChangeProp" );
    }
  ...
  String getOther() {
    if ( React.shouldCheckInvariants() ) {
      return null != $$react4j$$_nativeView.props().getAsAny( Props.other ) ? $$react4j$$_nativeView.props().getAsAny( Props.other ).asString() : null;
    } else {
      return Js.uncheckedCast( $$react4j$$_nativeView.props().getAsAny( Props.other ) );
    }
  }
  ...
  private static final class LiteNativeView extends react4j.internal.NativeView implements OnShouldComponentUpdate, OnComponentWillUnmount {
    @Nonnull
    private final React4j_ComponentShouldUpdateOnChangeProp $$react4j$$_view;

    @JsConstructor
    LiteNativeView(@Nullable final JsPropertyMap<Object> props) {
      super( props );
      $$react4j$$_view = new Arez_React4j_ComponentShouldUpdateOnChangeProp( this );
    }
