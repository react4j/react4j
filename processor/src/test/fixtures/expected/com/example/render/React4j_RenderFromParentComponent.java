...
@ArezComponent(
    name = "com_example_render_RenderFromParentComponent",
...
abstract class React4j_RenderFromParentComponent extends RenderFromParentComponent {
  ...
  private static final class NativeView extends react4j.internal.NativeView implements OnShouldComponentUpdate, OnComponentWillUnmount {
    @Nonnull
    private final React4j_RenderFromParentComponent view;

    @JsConstructor
    NativeView(@Nullable final JsPropertyMap<Object> inputs) {
      super( inputs );
      view = new Arez_React4j_RenderFromParentComponent( this );
    }
