...
@ArezComponent(
    name = "Suppressed1PublicAccessOnPropChangeModel",
    disposeNotifier = Feature.DISABLE,
    allowEmpty = true,
    inject = InjectMode.NONE
)
@Generated("react4j.processor.React4jProcessor")
abstract class React4j_Suppressed1PublicAccessOnPropChangeModel extends Suppressed1PublicAccessOnPropChangeModel {
  React4j_Suppressed1PublicAccessOnPropChangeModel(
  ...
  private static ComponentConstructorFunction getConstructorFunction() {
    ...
    if ( React.enableComponentNames() ) {
      Js.asPropertyMap( componentConstructor ).set( "displayName", "Suppressed1PublicAccessOnPropChangeModel" );
    }
  ...
  private void $$react4j$$_componentWillUnmount() {
    ((Arez_React4j_Suppressed1PublicAccessOnPropChangeModel) this).dispose();
  }
  ...
  private static final class LiteNativeReactComponent extends NativeComponent implements OnShouldComponentUpdate, OnGetSnapshotBeforeUpdate {
    @Nonnull
    private final React4j_Suppressed1PublicAccessOnPropChangeModel $$react4j$$_component;

    @JsConstructor
    LiteNativeReactComponent(@Nullable final JsPropertyMap<Object> props) {
      super( props );
      $$react4j$$_component = new Arez_React4j_Suppressed1PublicAccessOnPropChangeModel( this );
    }
