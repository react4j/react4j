...
@ArezComponent(
    name = "PublicAccessViaInterfaceOnPropChangeModel",
...
abstract class React4j_PublicAccessViaInterfaceOnPropChangeModel extends PublicAccessViaInterfaceOnPropChangeModel {
  ...
  private static ComponentConstructorFunction getConstructorFunction() {
    ...
    if ( React.enableComponentNames() ) {
      Js.asPropertyMap( componentConstructor ).set( "displayName", "PublicAccessViaInterfaceOnPropChangeModel" );
    }
  ...
  private static final class LiteNativeReactComponent extends NativeComponent implements OnShouldComponentUpdate, OnGetSnapshotBeforeUpdate {
    @Nonnull
    private final React4j_PublicAccessViaInterfaceOnPropChangeModel $$react4j$$_component;

    @JsConstructor
    LiteNativeReactComponent(@Nullable final JsPropertyMap<Object> props) {
      super( props );
      $$react4j$$_component = new Arez_React4j_PublicAccessViaInterfaceOnPropChangeModel( this );
    }
