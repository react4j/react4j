...
@ArezComponent(
    name = "Suppressed2ProtectedAccessOnPropChangeModel",
    disposeNotifier = Feature.DISABLE,
    allowEmpty = true,
    inject = InjectMode.NONE
)
@Generated("react4j.processor.React4jProcessor")
abstract class React4j_Suppressed2ProtectedAccessOnPropChangeModel extends Suppressed2ProtectedAccessOnPropChangeModel {
  React4j_Suppressed2ProtectedAccessOnPropChangeModel(
  ...
  private static ComponentConstructorFunction getConstructorFunction() {
    ...
    if ( React.enableComponentNames() ) {
      Js.asPropertyMap( componentConstructor ).set( "displayName", "Suppressed2ProtectedAccessOnPropChangeModel" );
    }
  ...
  private void $$react4j$$_componentWillUnmount() {
    ((Arez_React4j_Suppressed2ProtectedAccessOnPropChangeModel) this).dispose();
  }
  ...
  private static final class LiteNativeReactComponent extends NativeComponent implements OnShouldComponentUpdate, OnGetSnapshotBeforeUpdate {
    @Nonnull
    private final React4j_Suppressed2ProtectedAccessOnPropChangeModel $$react4j$$_component;

    @JsConstructor
    LiteNativeReactComponent(@Nullable final JsPropertyMap<Object> props) {
      super( props );
      $$react4j$$_component = new Arez_React4j_Suppressed2ProtectedAccessOnPropChangeModel( this );
    }
