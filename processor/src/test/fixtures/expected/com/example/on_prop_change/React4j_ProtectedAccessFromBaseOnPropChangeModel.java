...
abstract class React4j_ProtectedAccessFromBaseOnPropChangeModel extends ProtectedAccessFromBaseOnPropChangeModel {
  @Nonnull
  ...
  private static ViewConstructorFunction getConstructorFunction() {
    ...
    if ( React.enableViewNames() ) {
      Js.asPropertyMap( viewConstructor ).set( "displayName", "ProtectedAccessFromBaseOnPropChangeModel" );
    }
  ...
  private static final class NativeView extends react4j.internal.NativeView implements OnShouldComponentUpdate, OnComponentWillUnmount, OnGetSnapshotBeforeUpdate {
    @Nonnull
    private final React4j_ProtectedAccessFromBaseOnPropChangeModel $$react4j$$_view;

    @JsConstructor
    NativeView(@Nullable final JsPropertyMap<Object> inputs) {
      super( inputs );
      $$react4j$$_view = new Arez_React4j_ProtectedAccessFromBaseOnPropChangeModel( this );
    }
