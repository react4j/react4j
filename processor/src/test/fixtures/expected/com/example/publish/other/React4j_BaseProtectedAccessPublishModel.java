...
@ArezComponent(
    name = "BaseProtectedAccessPublishModel",
...
abstract class React4j_BaseProtectedAccessPublishModel extends BaseProtectedAccessPublishModel {
  @Nonnull
  private final react4j.internal.NativeView $$react4j$$_nativeView;

  React4j_BaseProtectedAccessPublishModel(
  ...
  private static ViewConstructorFunction getConstructorFunction() {
    ...
    if ( React.enableViewNames() ) {
      Js.asPropertyMap( viewConstructor ).set( "displayName", "BaseProtectedAccessPublishModel" );
    }
  ...
  private void $$react4j$$_componentWillUnmount() {
    ((Arez_React4j_BaseProtectedAccessPublishModel) this).dispose();
  }
  ...
  private static final class LiteNativeView extends react4j.internal.NativeView implements OnShouldComponentUpdate {
    @Nonnull
    private final React4j_BaseProtectedAccessPublishModel $$react4j$$_view;

    @JsConstructor
    LiteNativeView(@Nullable final JsPropertyMap<Object> inputs) {
      super( inputs );
      $$react4j$$_view = new Arez_React4j_BaseProtectedAccessPublishModel( this );
    }
