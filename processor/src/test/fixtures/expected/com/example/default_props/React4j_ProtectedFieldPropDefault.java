...
abstract class React4j_ProtectedFieldPropDefault extends ProtectedFieldPropDefault {
  ...
  React4j_ProtectedFieldPropDefault(
  ...
  private static ViewConstructorFunction getConstructorFunction() {
    ...
    if ( React.enableViewNames() ) {
      Js.asPropertyMap( viewConstructor ).set( "displayName", "ProtectedFieldPropDefault" );
    }
  ...
  private void $$react4j$$_componentWillUnmount() {
    ((Arez_React4j_ProtectedFieldPropDefault) this).dispose();
  }
  ...
  private static final class LiteNativeView extends react4j.internal.NativeView implements OnShouldComponentUpdate {
    @Nonnull
    private final React4j_ProtectedFieldPropDefault $$react4j$$_view;

    @JsConstructor
    LiteNativeView(@Nullable final JsPropertyMap<Object> props) {
      super( props );
      $$react4j$$_view = new Arez_React4j_ProtectedFieldPropDefault( this );
    }
