...
@ArezComponent(
    name = "PublicMethodPropDefault",
    disposeNotifier = Feature.DISABLE,
    allowEmpty = true,
    inject = InjectMode.NONE
)
@Generated("react4j.processor.ReactProcessor")
abstract class React4j_PublicMethodPropDefault extends PublicMethodPropDefault {
  React4j_PublicMethodPropDefault(@Nonnull final NativeComponent $$react4j$$_nativeComponent) {
  ...
  private void $$react4j$$_componentWillUnmount() {
    ((Arez_React4j_PublicMethodPropDefault) this).dispose();
  }
  ...
  private static final class LiteNativeReactComponent extends NativeComponent implements OnShouldComponentUpdate {
    @Nonnull
    private final React4j_PublicMethodPropDefault $$react4j$$_component;
