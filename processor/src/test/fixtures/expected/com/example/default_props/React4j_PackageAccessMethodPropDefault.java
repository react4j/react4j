...
abstract class React4j_PackageAccessMethodPropDefault extends PackageAccessMethodPropDefault {
  ...
  React4j_PackageAccessMethodPropDefault(
  ...
  private static ViewConstructorFunction getConstructorFunction() {
    ...
    if ( React.enableViewNames() ) {
      Js.asPropertyMap( viewConstructor ).set( "displayName", "PackageAccessMethodPropDefault" );
    }
  ...
  private void $$react4j$$_componentWillUnmount() {
    ((Arez_React4j_PackageAccessMethodPropDefault) this).dispose();
  }
  ...
  private static final class LiteNativeView extends react4j.internal.NativeView implements OnShouldComponentUpdate {
    @Nonnull
    private final React4j_PackageAccessMethodPropDefault $$react4j$$_view;

    @JsConstructor
    LiteNativeView(@Nullable final JsPropertyMap<Object> inputs) {
      super( inputs );
      $$react4j$$_view = new Arez_React4j_PackageAccessMethodPropDefault( this );
    }
