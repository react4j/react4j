...
@ArezComponent(
    name = "DeprecatedMethodPropDefaultModel",
...
abstract class React4j_DeprecatedMethodPropDefaultModel extends DeprecatedMethodPropDefaultModel {
  ...
  private static ComponentConstructorFunction getConstructorFunction() {
    ...
    if ( React.enableComponentNames() ) {
      Js.asPropertyMap( componentConstructor ).set( "displayName", "DeprecatedMethodPropDefaultModel" );
    }
  ...
  private void $$react4j$$_componentWillUnmount() {
    ((Arez_React4j_DeprecatedMethodPropDefaultModel) this).dispose();
  }
  ...
  private static final class LiteNativeReactComponent extends NativeComponent implements OnShouldComponentUpdate {
    @Nonnull
    private final React4j_DeprecatedMethodPropDefaultModel $$react4j$$_component;

    @JsConstructor
    LiteNativeReactComponent(@Nullable final JsPropertyMap<Object> props) {
      super( props );
      $$react4j$$_component = new Arez_React4j_DeprecatedMethodPropDefaultModel( this );
    }
