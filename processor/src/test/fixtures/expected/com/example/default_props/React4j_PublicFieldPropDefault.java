...
abstract class React4j_PublicFieldPropDefault extends PublicFieldPropDefault {
  ...
  React4j_PublicFieldPropDefault(
  ...
  private static ViewConstructorFunction getConstructorFunction() {
    ...
    if ( React.enableViewNames() ) {
      Js.asPropertyMap( viewConstructor ).set( "displayName", "PublicFieldPropDefault" );
    }
  ...
  private void $$react4j$$_componentWillUnmount() {
    ((Arez_React4j_PublicFieldPropDefault) this).dispose();
  }
  ...
  private static final class LiteNativeView extends react4j.internal.NativeView implements OnShouldComponentUpdate {
    @Nonnull
    private final React4j_PublicFieldPropDefault $$react4j$$_view;

    @JsConstructor
    LiteNativeView(@Nullable final JsPropertyMap<Object> props) {
      super( props );
      $$react4j$$_view = new Arez_React4j_PublicFieldPropDefault( this );
    }
