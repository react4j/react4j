...
abstract class React4j_PropDefaultWithColorfulName extends PropDefaultWithColorfulName {
  ...
  React4j_PropDefaultWithColorfulName(
  ...
  private static ViewConstructorFunction getConstructorFunction() {
    ...
    if ( React.enableViewNames() ) {
      Js.asPropertyMap( viewConstructor ).set( "displayName", "PropDefaultWithColorfulName" );
    }
  ...
  String getMyProp12$23() {
    if ( React.shouldCheckInvariants() ) {
      return null != $$react4j$$_nativeView.props().getAsAny( Props.myProp12$23 ) ? $$react4j$$_nativeView.props().getAsAny( Props.myProp12$23 ).asString() : null;
    } else {
      return Js.uncheckedCast( $$react4j$$_nativeView.props().getAsAny( Props.myProp12$23 ) );
    }
  }
  ...
  private static final class LiteNativeView extends react4j.internal.NativeView implements OnShouldComponentUpdate {
    @Nonnull
    private final React4j_PropDefaultWithColorfulName $$react4j$$_view;

    @JsConstructor
    LiteNativeView(@Nullable final JsPropertyMap<Object> props) {
      super( props );
      $$react4j$$_view = new Arez_React4j_PropDefaultWithColorfulName( this );
    }
