...
abstract class React4j_DoublePropValidate extends DoublePropValidate {
  ...
  React4j_DoublePropValidate(@Nonnull final react4j.internal.NativeView $$react4j$$_nativeView) {
  ...
  private static ViewConstructorFunction getConstructorFunction() {
    ...
    if ( React.enableViewNames() ) {
      Js.asPropertyMap( viewConstructor ).set( "displayName", "DoublePropValidate" );
    }
  ...
  private void $$react4j$$_componentWillUnmount() {
    ((Arez_React4j_DoublePropValidate) this).dispose();
  }
  ...
  private static final class LiteNativeView extends react4j.internal.NativeView implements OnShouldComponentUpdate {
    @Nonnull
    private final React4j_DoublePropValidate $$react4j$$_view;

    @JsConstructor
    LiteNativeView(@Nullable final JsPropertyMap<Object> props) {
      super( props );
      $$react4j$$_view = new Arez_React4j_DoublePropValidate( this );
      if ( React.shouldValidatePropValues() ) {
        assert null != props;
