...
@ArezComponent(
    name = "Suppressed2ProtectedAccessPropValidateModel",
    disposeNotifier = Feature.DISABLE,
    allowEmpty = true,
    inject = InjectMode.NONE
)
@Generated("react4j.processor.React4jProcessor")
abstract class React4j_Suppressed2ProtectedAccessPropValidateModel extends Suppressed2ProtectedAccessPropValidateModel {
  React4j_Suppressed2ProtectedAccessPropValidateModel(
  ...
  private static ComponentConstructorFunction getConstructorFunction() {
    ...
    if ( React.enableComponentNames() ) {
      Js.asPropertyMap( componentConstructor ).set( "displayName", "Suppressed2ProtectedAccessPropValidateModel" );
    }
  ...
  private void $$react4j$$_componentWillUnmount() {
    ((Arez_React4j_Suppressed2ProtectedAccessPropValidateModel) this).dispose();
  }
  ...
  private static final class LiteNativeReactComponent extends NativeComponent implements OnShouldComponentUpdate {
    @Nonnull
    private final React4j_Suppressed2ProtectedAccessPropValidateModel $$react4j$$_component;

    @JsConstructor
    LiteNativeReactComponent(@Nullable final JsPropertyMap<Object> props) {
      super( props );
      $$react4j$$_component = new Arez_React4j_Suppressed2ProtectedAccessPropValidateModel( this );
      if ( React.shouldValidatePropValues() ) {
        assert null != props;
