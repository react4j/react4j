...
@ArezComponent(
    name = "com_example_prop_validate_IntPropValidate",
...
abstract class React4j_IntPropValidate extends IntPropValidate {
  ...
  React4j_IntPropValidate(@Nonnull final react4j.internal.NativeView $$react4j$$_nativeView) {
  ...
  private static ViewConstructorFunction getConstructorFunction() {
    ...
    if ( React.enableViewNames() ) {
      Js.asPropertyMap( viewConstructor ).set( "displayName", "IntPropValidate" );
    }
  ...
  private void $$react4j$$_componentWillUnmount() {
    ((Arez_React4j_IntPropValidate) this).dispose();
  }
  ...
  private static final class NativeView extends react4j.internal.NativeView implements OnShouldComponentUpdate, OnComponentWillUnmount {
    @Nonnull
    private final React4j_IntPropValidate $$react4j$$_view;

    @JsConstructor
    NativeView(@Nullable final JsPropertyMap<Object> inputs) {
      super( inputs );
      $$react4j$$_view = new Arez_React4j_IntPropValidate( this );
      if ( React.shouldValidateInputValues() ) {
        assert null != inputs;
