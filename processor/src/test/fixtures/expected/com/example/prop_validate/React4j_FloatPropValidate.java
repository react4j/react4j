...
@ArezComponent(
    name = "com_example_prop_validate_FloatPropValidate",
...
abstract class React4j_FloatPropValidate extends FloatPropValidate {
  @Nonnull
  private final react4j.internal.NativeView $$react4j$$_nativeView;

  React4j_FloatPropValidate(@Nonnull final react4j.internal.NativeView $$react4j$$_nativeView) {
  ...
  private static ViewConstructorFunction getConstructorFunction() {
    ...
    if ( React.enableViewNames() ) {
      Js.asPropertyMap( viewConstructor ).set( "displayName", "FloatPropValidate" );
    }
  ...
  private void $$react4j$$_componentWillUnmount() {
    ((Arez_React4j_FloatPropValidate) this).dispose();
  }
  ...
  private static final class NativeView extends react4j.internal.NativeView implements OnShouldComponentUpdate, OnComponentWillUnmount {
    @Nonnull
    private final React4j_FloatPropValidate $$react4j$$_view;

    @JsConstructor
    NativeView(@Nullable final JsPropertyMap<Object> inputs) {
      super( inputs );
      $$react4j$$_view = new Arez_React4j_FloatPropValidate( this );
      if ( React.shouldValidateInputValues() ) {
        assert null != inputs;
