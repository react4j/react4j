...
abstract class React4j_ProtectedAccessFromBasePropValidateModel extends ProtectedAccessFromBasePropValidateModel {
  ...
  private static ComponentConstructorFunction getConstructorFunction() {
    ...
    if ( React.enableComponentNames() ) {
      Js.asPropertyMap( componentConstructor ).set( "displayName", "ProtectedAccessFromBasePropValidateModel" );
    }
  ...
  private static final class LiteNativeReactComponent extends NativeComponent implements OnShouldComponentUpdate {
    @Nonnull
    private final React4j_ProtectedAccessFromBasePropValidateModel $$react4j$$_component;

    @JsConstructor
    LiteNativeReactComponent(@Nullable final JsPropertyMap<Object> props) {
      super( props );
      $$react4j$$_component = new Arez_React4j_ProtectedAccessFromBasePropValidateModel( this );
      if ( React.shouldValidatePropValues() ) {
        assert null != props;
