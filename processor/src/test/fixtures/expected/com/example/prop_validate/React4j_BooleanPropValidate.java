...
@ArezComponent(
    name = "com_example_prop_validate_BooleanPropValidate",
...
abstract class React4j_BooleanPropValidate extends BooleanPropValidate {
  @Nonnull
  private final react4j.internal.NativeView $$react4j$$_nativeView;

  React4j_BooleanPropValidate(@Nonnull final react4j.internal.NativeView $$react4j$$_nativeView) {
  ...
  private static ViewConstructorFunction getConstructorFunction() {
    ...
    if ( React.enableViewNames() ) {
      Js.asPropertyMap( viewConstructor ).set( "displayName", "BooleanPropValidate" );
    }
  ...
  private void $$react4j$$_componentWillUnmount() {
    ((Arez_React4j_BooleanPropValidate) this).dispose();
  }
  ...
  private static final class NativeView extends react4j.internal.NativeView implements OnShouldComponentUpdate, OnComponentWillUnmount {
    @Nonnull
    private final React4j_BooleanPropValidate $$react4j$$_view;

    @JsConstructor
    NativeView(@Nullable final JsPropertyMap<Object> inputs) {
      super( inputs );
      $$react4j$$_view = new Arez_React4j_BooleanPropValidate( this );
      if ( React.shouldValidateInputValues() ) {
        assert null != inputs;
