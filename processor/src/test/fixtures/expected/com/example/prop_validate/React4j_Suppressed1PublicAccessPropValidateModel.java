...
@ArezComponent(
    name = "Suppressed1PublicAccessPropValidateModel",
    disposeNotifier = Feature.DISABLE,
    allowEmpty = true,
    inject = InjectMode.NONE
)
@Generated("react4j.processor.React4jProcessor")
abstract class React4j_Suppressed1PublicAccessPropValidateModel extends Suppressed1PublicAccessPropValidateModel {
  React4j_Suppressed1PublicAccessPropValidateModel(
  ...
  private static ComponentConstructorFunction getConstructorFunction() {
    ...
    if ( React.enableComponentNames() ) {
      Js.asPropertyMap( componentConstructor ).set( "displayName", "Suppressed1PublicAccessPropValidateModel" );
    }
  ...
  private void $$react4j$$_componentWillUnmount() {
    ((Arez_React4j_Suppressed1PublicAccessPropValidateModel) this).dispose();
  }
  ...
  private static final class LiteNativeReactComponent extends NativeComponent implements OnShouldComponentUpdate {
    @Nonnull
    private final React4j_Suppressed1PublicAccessPropValidateModel $$react4j$$_component;

    @JsConstructor
    LiteNativeReactComponent(@Nullable final JsPropertyMap<Object> props) {
      super( props );
      $$react4j$$_component = new Arez_React4j_Suppressed1PublicAccessPropValidateModel( this );
      if ( React.shouldValidatePropValues() ) {
        assert null != props;
