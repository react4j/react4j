...
@ArezComponent(
    name = "Suppressed1ProtectedAccessPropValidateModel",
    disposeNotifier = Feature.DISABLE,
    allowEmpty = true,
    inject = InjectMode.NONE
)
@Generated("react4j.processor.React4jProcessor")
abstract class React4j_Suppressed1ProtectedAccessPropValidateModel extends Suppressed1ProtectedAccessPropValidateModel {
  React4j_Suppressed1ProtectedAccessPropValidateModel(
  ...
  private static ComponentConstructorFunction getConstructorFunction() {
    ...
    if ( React.enableComponentNames() ) {
      Js.asPropertyMap( componentConstructor ).set( "displayName", "Suppressed1ProtectedAccessPropValidateModel" );
    }
  ...
  private void $$react4j$$_componentWillUnmount() {
    ((Arez_React4j_Suppressed1ProtectedAccessPropValidateModel) this).dispose();
  }
  ...
  private static final class LiteNativeReactComponent extends NativeComponent implements OnShouldComponentUpdate {
    @Nonnull
    private final React4j_Suppressed1ProtectedAccessPropValidateModel $$react4j$$_component;

    @JsConstructor
    LiteNativeReactComponent(@Nullable final JsPropertyMap<Object> props) {
      super( props );
      $$react4j$$_component = new Arez_React4j_Suppressed1ProtectedAccessPropValidateModel( this );
      if ( React.shouldValidatePropValues() ) {
        assert null != props;
