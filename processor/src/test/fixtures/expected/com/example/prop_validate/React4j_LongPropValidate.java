...
abstract class React4j_LongPropValidate extends LongPropValidate {
  ...
  React4j_LongPropValidate(@Nonnull final NativeComponent $$react4j$$_nativeComponent) {
  ...
  @Override
  long getMyProp() {
    return $$react4j$$_nativeComponent.props().getAsAny( Props.myProp ).asLong();
  }
  ...
  private static final class LiteNativeReactComponent extends NativeComponent implements OnShouldComponentUpdate {
    @Nonnull
    private final React4j_LongPropValidate $$react4j$$_component;

    @JsConstructor
    LiteNativeReactComponent(@Nullable final JsPropertyMap<Object> props) {
      super( props );
      $$react4j$$_component = new Arez_React4j_LongPropValidate( this );
      if ( React.shouldValidatePropValues() ) {
        assert null != props;
