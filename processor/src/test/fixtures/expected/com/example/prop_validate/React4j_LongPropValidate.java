...
abstract class React4j_LongPropValidate extends LongPropValidate {
  ...
  React4j_LongPropValidate(@Nonnull final react4j.internal.NativeView $$react4j$$_nativeView) {
  ...
  private static ViewConstructorFunction getConstructorFunction() {
    ...
    if ( React.enableViewNames() ) {
      Js.asPropertyMap( viewConstructor ).set( "displayName", "LongPropValidate" );
    }
  ...
  @Override
  long getMyProp() {
    return $$react4j$$_nativeView.props().getAsAny( Props.myProp ).asLong();
  }
  ...
  private void $$react4j$$_componentWillUnmount() {
    ((Arez_React4j_LongPropValidate) this).dispose();
  }
  ...
  private static final class LiteNativeView extends react4j.internal.NativeView implements OnShouldComponentUpdate {
    @Nonnull
    private final React4j_LongPropValidate $$react4j$$_view;

    @JsConstructor
    LiteNativeView(@Nullable final JsPropertyMap<Object> props) {
      super( props );
      $$react4j$$_view = new Arez_React4j_LongPropValidate( this );
      if ( React.shouldValidatePropValues() ) {
        assert null != props;
