...
@ArezComponent(
    name = "com_example_prop_validate_CharPropValidate",
...
abstract class React4j_CharPropValidate extends CharPropValidate {
  ...
  React4j_CharPropValidate(@Nonnull final react4j.internal.NativeView $$react4j$$_nativeView) {
  ...
  private static ViewConstructorFunction getConstructorFunction() {
    ...
    if ( React.enableViewNames() ) {
      Js.asPropertyMap( viewConstructor ).set( "displayName", "CharPropValidate" );
    }
  ...
  private static final class NativeView extends react4j.internal.NativeView implements OnShouldComponentUpdate, OnComponentWillUnmount {
    @Nonnull
    private final React4j_CharPropValidate $$react4j$$_view;

    @JsConstructor
    NativeView(@Nullable final JsPropertyMap<Object> inputs) {
      super( inputs );
      $$react4j$$_view = new Arez_React4j_CharPropValidate( this );
      if ( React.shouldValidateInputValues() ) {
        assert null != inputs;
