...
@ArezComponent(
    name = "ProtectedAccessFromBasePreUpdateModel",
...
abstract class React4j_ProtectedAccessFromBasePreUpdateModel extends ProtectedAccessFromBasePreUpdateModel {
  ...
  private static ComponentConstructorFunction getConstructorFunction() {
    ...
    if ( React.enableComponentNames() ) {
      Js.asPropertyMap( componentConstructor ).set( "displayName", "ProtectedAccessFromBasePreUpdateModel" );
    }
  ...
  private static final class LiteNativeReactComponent extends NativeComponent implements OnShouldComponentUpdate, OnGetSnapshotBeforeUpdate {
    @Nonnull
    private final React4j_ProtectedAccessFromBasePreUpdateModel $$react4j$$_component;

    @JsConstructor
    LiteNativeReactComponent(@Nullable final JsPropertyMap<Object> props) {
      super( props );
      $$react4j$$_component = new Arez_React4j_ProtectedAccessFromBasePreUpdateModel( this );
    }
