...
abstract class React4j_MultiPropComponent4 extends MultiPropComponent4 {
  ...
  String getMyProp3() {
    if ( React.shouldCheckInvariants() ) {
      return null != $$react4j$$_nativeComponent.props().getAsAny( Props.myProp3 ) ? $$react4j$$_nativeComponent.props().getAsAny( Props.myProp3 ).asString() : null;
    } else {
      return Js.uncheckedCast( $$react4j$$_nativeComponent.props().getAsAny( Props.myProp3 ) );
    }
  }
  ...
  String getMyProp4() {
    if ( React.shouldCheckInvariants() ) {
      return null != $$react4j$$_nativeComponent.props().getAsAny( Props.myProp4 ) ? $$react4j$$_nativeComponent.props().getAsAny( Props.myProp4 ).asString() : null;
    } else {
      return Js.uncheckedCast( $$react4j$$_nativeComponent.props().getAsAny( Props.myProp4 ) );
    }
  }
