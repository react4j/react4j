...
@ArezComponent(
    name = "com_example_prop_ImmutableDisposableActAsComponentMaybeTrackingProp",
    disposeNotifier = Feature.DISABLE,
    sting = Feature.DISABLE
)
@Generated("react4j.processor.React4jProcessor")
abstract class React4j_ImmutableDisposableActAsComponentMaybeTrackingProp extends ImmutableDisposableActAsComponentMaybeTrackingProp {
  @Nonnull
  private final react4j.internal.NativeView $$react4j$$_nativeView;

  @ComponentDependency
  @Nullable
  final ImmutableDisposableActAsComponentMaybeTrackingProp.ActAsComponentComponent $$react4j_immutable_input$$_model;

  private int $$react4j$$_state;

  private boolean $$react4j$$_scheduledDebugStateUpdate;

  React4j_ImmutableDisposableActAsComponentMaybeTrackingProp(
  ...
  private static ViewConstructorFunction getConstructorFunction() {
    ...
    if ( React.enableViewNames() ) {
      Js.asPropertyMap( viewConstructor ).set( "displayName", "ImmutableDisposableActAsComponentMaybeTrackingProp" );
    }
  ...
  private void $$react4j$$_componentWillUnmount() {
    ((Arez_React4j_ImmutableDisposableActAsComponentMaybeTrackingProp) this).dispose();
  ...
  ReactNode $$react4j$$_render() {
    ...
    final ImmutableDisposableActAsComponentMaybeTrackingProp.ActAsComponentComponent $$react4jv$$_model = $$react4j_immutable_input$$_model;
  ...
  private static final class LiteNativeView extends react4j.internal.NativeView implements OnShouldComponentUpdate, OnComponentWillUnmount {
    ...
    LiteNativeView(@Nullable final JsPropertyMap<Object> inputs) {
      super( inputs );
      ImmutableDisposableActAsComponentMaybeTrackingProp.ActAsComponentComponent model;
      ...
      view = Disposable.isDisposed( Js.uncheckedCast( inputs.getAsAny( Inputs.model ) ) ) ? null : new Arez_React4j_ImmutableDisposableActAsComponentMaybeTrackingProp( this, model );
    }
