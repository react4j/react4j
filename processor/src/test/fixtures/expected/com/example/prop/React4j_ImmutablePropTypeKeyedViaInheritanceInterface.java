...
abstract class React4j_ImmutablePropTypeKeyedViaInheritanceInterface extends ImmutablePropTypeKeyedViaInheritanceInterface {
  ...
  private static final class NativeView extends react4j.internal.NativeView implements OnShouldComponentUpdate, OnComponentWillUnmount {
    @Nonnull
    private final React4j_ImmutablePropTypeKeyedViaInheritanceInterface $$react4j$$_view;

    @JsConstructor
    NativeView(@Nullable final JsPropertyMap<Object> inputs) {
      super( inputs );
      $$react4j$$_view = new Arez_React4j_ImmutablePropTypeKeyedViaInheritanceInterface( this );
    }
