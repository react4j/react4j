...
@ArezComponent(
    name = "com_example_prop_MutableDisposableArezComponentLikeTrackingProp",
    disposeNotifier = Feature.DISABLE,
    sting = Feature.DISABLE
)
@Generated("react4j.processor.React4jProcessor")
abstract class React4j_MutableDisposableArezComponentLikeTrackingProp extends MutableDisposableArezComponentLikeTrackingProp {
  @Nonnull
  ...
  React4j_MutableDisposableArezComponentLikeTrackingProp(
  ...
  private static ViewConstructorFunction getConstructorFunction() {
    ...
    if ( React.enableViewNames() ) {
      Js.asPropertyMap( viewConstructor ).set( "displayName", "MutableDisposableArezComponentLikeTrackingProp" );
    }
  ...
  @Nullable
  @Override
  MutableDisposableArezComponentLikeTrackingProp.ArezComponentLikeComponent model() {
  ...
  private void $$react4j$$_componentWillUnmount() {
    ((Arez_React4j_MutableDisposableArezComponentLikeTrackingProp) this).dispose();
  ...
  ReactNode $$react4j$$_render() {
    ...
    final MutableDisposableArezComponentLikeTrackingProp.ArezComponentLikeComponent $$react4jv$$_model = model();
  ...
  private static final class LiteNativeView extends react4j.internal.NativeView implements OnShouldComponentUpdate, OnComponentWillUnmount {
    private final React4j_MutableDisposableArezComponentLikeTrackingProp view;

    @JsConstructor
    LiteNativeView(@Nullable final JsPropertyMap<Object> inputs) {
      super( inputs );
      view = new Arez_React4j_MutableDisposableArezComponentLikeTrackingProp( this );
    }
