...
abstract class React4j_ImmutablePropTypeActAsComponentAndKeyed extends ImmutablePropTypeActAsComponentAndKeyed {
  ...
  @Nullable
  @Override
  ImmutablePropTypeActAsComponentAndKeyed.MyComponent getMyProp() {
  ...
  private static final class NativeView extends react4j.internal.NativeView implements OnShouldComponentUpdate, OnComponentWillUnmount {
    ...
    NativeView(@Nullable final JsPropertyMap<Object> inputs) {
      super( inputs );
      view = Disposable.isDisposed( Js.uncheckedCast( inputs.getAsAny( Inputs.myProp ) ) ) ? null : new Arez_React4j_ImmutablePropTypeActAsComponentAndKeyed( this );
    }
