...
@ArezComponent(
    name = "CollectionArrayListPropModel",
...
abstract class React4j_CollectionArrayListPropModel extends CollectionArrayListPropModel {
  ...
  React4j_CollectionArrayListPropModel(@Nonnull final NativeComponent $$react4j$$_nativeComponent) {
  ...
  private static ComponentConstructorFunction getConstructorFunction() {
    ...
    if ( React.enableComponentNames() ) {
      Js.asPropertyMap( componentConstructor ).set( "displayName", "CollectionArrayListPropModel" );
    }
  ...
  private static final class LiteNativeReactComponent extends NativeComponent implements OnShouldComponentUpdate {
    @Nonnull
    private final React4j_CollectionArrayListPropModel $$react4j$$_component;

    @JsConstructor
    LiteNativeReactComponent(@Nullable final JsPropertyMap<Object> props) {
      super( props );
      $$react4j$$_component = new Arez_React4j_CollectionArrayListPropModel( this );
    }
