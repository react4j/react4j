...
@ArezComponent(
    name = "com_example_prop_ImmutableDisposableArezComponentTrackingProp",
    disposeNotifier = Feature.DISABLE,
    sting = Feature.DISABLE
)
@Generated("react4j.processor.React4jProcessor")
abstract class React4j_ImmutableDisposableArezComponentTrackingProp extends ImmutableDisposableArezComponentTrackingProp {
  @Nonnull
  private final react4j.internal.NativeView $$react4j$$_nativeView;

  @ComponentDependency
  @Nonnull
  final ImmutableDisposableArezComponentTrackingProp.Model $$react4j_immutable_input$$_model;
  ...
  private void $$react4j$$_validateInputValues(@Nonnull final JsPropertyMap<Object> inputs) {
    ...
    if ( React.shouldCheckInvariants() ) {
      Guards.apiInvariant( () -> null != raw$model, () -> "Required input named 'model' is missing from view named 'ImmutableDisposableArezComponentTrackingProp' so it was either incorrectly omitted or a null value has been incorrectly specified." ) ;
    }
  }
  ...
  private void $$react4j$$_componentWillUnmount() {
    ((Arez_React4j_ImmutableDisposableArezComponentTrackingProp) this).dispose();
  ...
  private static final class LiteNativeView extends react4j.internal.NativeView implements OnShouldComponentUpdate, OnComponentWillUnmount {
    @Nonnull
    private final React4j_ImmutableDisposableArezComponentTrackingProp $$react4j$$_view;

    @JsConstructor
    LiteNativeView(@Nullable final JsPropertyMap<Object> inputs) {
      super( inputs );
      $$react4j$$_view = new Arez_React4j_ImmutableDisposableArezComponentTrackingProp( this );
      if ( React.shouldValidateInputValues() ) {
        assert null != inputs;
