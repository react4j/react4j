...
abstract class React4j_ImmutableDisposableNullableArezComponentTrackingProp extends ImmutableDisposableNullableArezComponentTrackingProp {
  ...
  @Nullable
  @Override
  ImmutableDisposableNullableArezComponentTrackingProp.Model getModel() {
  ...
  ReactNode $$react4j$$_render() {
    ...
    final ImmutableDisposableNullableArezComponentTrackingProp.Model $$react4jv$$_getModel = getModel();
  ...
  private static final class LiteNativeView extends react4j.internal.NativeView implements OnShouldComponentUpdate, OnComponentWillUnmount {
    @Nonnull
    private final React4j_ImmutableDisposableNullableArezComponentTrackingProp $$react4j$$_view;

    @JsConstructor
    LiteNativeView(@Nullable final JsPropertyMap<Object> inputs) {
      super( inputs );
      $$react4j$$_view = new Arez_React4j_ImmutableDisposableNullableArezComponentTrackingProp( this );
    }
