...
@ArezComponent(
    name = "com_example_prop_MutableDisposableNullableArezComponentLikeMaybeTrackingProp",
    disposeNotifier = Feature.DISABLE,
    sting = Feature.DISABLE
)
@Generated("react4j.processor.React4jProcessor")
abstract class React4j_MutableDisposableNullableArezComponentLikeMaybeTrackingProp extends MutableDisposableNullableArezComponentLikeMaybeTrackingProp {
  @Nonnull
  ...
  React4j_MutableDisposableNullableArezComponentLikeMaybeTrackingProp(
  ...
  private static ViewConstructorFunction getConstructorFunction() {
    ...
    if ( React.enableViewNames() ) {
      Js.asPropertyMap( viewConstructor ).set( "displayName", "MutableDisposableNullableArezComponentLikeMaybeTrackingProp" );
    }
  ...
  @Nullable
  @Override
  MutableDisposableNullableArezComponentLikeMaybeTrackingProp.ArezComponentLikeComponent model() {
  ...
  private void $$react4j$$_componentWillUnmount() {
    ((Arez_React4j_MutableDisposableNullableArezComponentLikeMaybeTrackingProp) this).dispose();
  ...
  ReactNode $$react4j$$_render() {
    ...
    final MutableDisposableNullableArezComponentLikeMaybeTrackingProp.ArezComponentLikeComponent $$react4jv$$_model = model();
  ...
  private static final class LiteNativeView extends react4j.internal.NativeView implements OnShouldComponentUpdate, OnComponentWillUnmount {
    private final React4j_MutableDisposableNullableArezComponentLikeMaybeTrackingProp view;

    @JsConstructor
    LiteNativeView(@Nullable final JsPropertyMap<Object> inputs) {
      super( inputs );
      view = new Arez_React4j_MutableDisposableNullableArezComponentLikeMaybeTrackingProp( this );
    }
