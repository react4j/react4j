...
abstract class React4j_ImmutableDisposableNullableActAsComponentMaybeTrackingProp extends ImmutableDisposableNullableActAsComponentMaybeTrackingProp {
  ...
  ReactNode $$react4j$$_render() {
    ...
    final ImmutableDisposableNullableActAsComponentMaybeTrackingProp.ActAsComponentComponent $$react4jv$$_model = model();
  ...
  private static final class LiteNativeView extends react4j.internal.NativeView implements OnShouldComponentUpdate, OnComponentWillUnmount {
    ...
    LiteNativeView(@Nullable final JsPropertyMap<Object> inputs) {
      super( inputs );
      view = Disposable.isDisposed( Js.uncheckedCast( inputs.getAsAny( Inputs.model ) ) ) ? null : new Arez_React4j_ImmutableDisposableNullableActAsComponentMaybeTrackingProp( this );
    }
