...
@ArezComponent(
    name = "com_example_prop_ImmutableDisposableArezComponentMaybeTrackingProp",
    disposeNotifier = Feature.DISABLE,
    sting = Feature.DISABLE
)
@Generated("react4j.processor.React4jProcessor")
abstract class React4j_ImmutableDisposableArezComponentMaybeTrackingProp extends ImmutableDisposableArezComponentMaybeTrackingProp {
  @Nonnull
  private final react4j.internal.NativeView $$react4j$$_nativeView;

  @ComponentDependency
  @Nonnull
  final ImmutableDisposableArezComponentMaybeTrackingProp.Model $$react4j_immutable_input$$_model;

  private int $$react4j$$_state;

  private boolean $$react4j$$_scheduledDebugStateUpdate;

  React4j_ImmutableDisposableArezComponentMaybeTrackingProp(
      @Nonnull final react4j.internal.NativeView $$react4j$$_nativeView,
      @Nonnull final ImmutableDisposableArezComponentMaybeTrackingProp.Model model) {
    super( model );
  ...
  private static ViewConstructorFunction getConstructorFunction() {
    ...
    if ( React.enableViewNames() ) {
      Js.asPropertyMap( viewConstructor ).set( "displayName", "ImmutableDisposableArezComponentMaybeTrackingProp" );
    }
  ...
  private void $$react4j$$_validateInputValues(@Nonnull final JsPropertyMap<Object> inputs) {
    ...
    if ( React.shouldCheckInvariants() ) {
      Guards.apiInvariant( () -> null != raw$model, () -> "Required input named 'model' is missing from view named 'ImmutableDisposableArezComponentMaybeTrackingProp' so it was either incorrectly omitted or a null value has been incorrectly specified." ) ;
    }
  }
  ...
  private void $$react4j$$_componentWillUnmount() {
    ((Arez_React4j_ImmutableDisposableArezComponentMaybeTrackingProp) this).dispose();
  ...
  ReactNode $$react4j$$_render() {
    ...
    final ImmutableDisposableArezComponentMaybeTrackingProp.Model $$react4jv$$_model = $$react4j_immutable_input$$_model;
  ...
  private static final class LiteNativeView extends react4j.internal.NativeView implements OnShouldComponentUpdate, OnComponentWillUnmount {
    @Nonnull
    private final React4j_ImmutableDisposableArezComponentMaybeTrackingProp view;

    @JsConstructor
    LiteNativeView(@Nullable final JsPropertyMap<Object> inputs) {
      super( inputs );
      final ImmutableDisposableArezComponentMaybeTrackingProp.Model model = inputs.getAsAny( Inputs.model ).cast();
      view = Disposable.isDisposed( inputs.getAsAny( Inputs.model ).cast() ) ? null : new Arez_React4j_ImmutableDisposableArezComponentMaybeTrackingProp( this, model );
      if ( React.shouldValidateInputValues() ) {
        assert null != inputs;
