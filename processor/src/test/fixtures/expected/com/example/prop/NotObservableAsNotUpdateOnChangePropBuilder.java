...
final class NotObservableAsNotUpdateOnChangePropBuilder {
  ...
  private static class Builder implements Step1 {
    private final ReactElement _element = ReactElement.createViewElement( React4j_NotObservableAsNotUpdateOnChangeProp.Factory.TYPE );

    @Override
    @Nonnull
    public final ReactNode value(final Object value) {
      _element.input( React4j_NotObservableAsNotUpdateOnChangeProp.Inputs.value, value );
      return build();
    }
