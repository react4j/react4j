...
final class ImmutableConstructorContextPropModelBuilder {
  private ImmutableConstructorContextPropModelBuilder() {
  }
  ...
  private static class Builder implements Step1 {
    @Nonnull
    private final ReactElement _element = ReactElement.createViewElement( React4j_ImmutableConstructorContextPropModel.Factory.TYPE );
    ...
    private ReactNode $context_myProp(final String myProp) {
      _element.input( React4j_ImmutableConstructorContextPropModel.Inputs.myProp, myProp );
