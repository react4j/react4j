...
abstract class React4j_CollectionHashSetPropComponent extends CollectionHashSetPropComponent {
  React4j_CollectionHashSetPropComponent(
  ...
  private void $$react4j$$_componentWillUnmount() {
    ((Arez_React4j_CollectionHashSetPropComponent) this).dispose();
  }
  ...
  private static final class LiteNativeReactComponent extends NativeComponent implements OnShouldComponentUpdate {
    @Nonnull
    private final React4j_CollectionHashSetPropComponent $$react4j$$_component;

    @JsConstructor
    LiteNativeReactComponent(@Nullable final JsPropertyMap<Object> props) {
      super( props );
      $$react4j$$_component = new Arez_React4j_CollectionHashSetPropComponent( this );
    }
