...
abstract class React4j_NonnullChildPropComponent extends NonnullChildPropComponent {
  ...
  React4j_NonnullChildPropComponent(@Nonnull final NativeComponent $$react4j$$_nativeComponent) {
  ...
  @Override
  ReactNode getChild() {
    return $$react4j$$_nativeComponent.props().getAsAny( Props.child ).cast();
  }
  ...
  private static final class LiteNativeReactComponent extends NativeComponent implements OnShouldComponentUpdate {
    @Nonnull
    private final React4j_NonnullChildPropComponent $$react4j$$_component;
