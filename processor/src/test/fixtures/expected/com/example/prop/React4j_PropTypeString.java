...
abstract class React4j_PropTypeString extends PropTypeString {
  React4j_PropTypeString(@Nonnull final NativeComponent $$react4j$$_nativeComponent) {
  ...
  private static final class LiteNativeReactComponent extends NativeComponent implements OnShouldComponentUpdate {
    @Nonnull
    private final React4j_PropTypeString $$react4j$$_component;

    @JsConstructor
    LiteNativeReactComponent(@Nullable final JsPropertyMap<Object> props) {
      super( props );
      $$react4j$$_component = new Arez_React4j_PropTypeString( this );
    }
