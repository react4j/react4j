...
abstract class React4j_MutablePropAndPostConstructWithSuppressComponent extends MutablePropAndPostConstructWithSuppressComponent {
  ...
  private static ComponentConstructorFunction getConstructorFunction() {
    ...
    if ( React.enableComponentNames() ) {
      Js.asPropertyMap( componentConstructor ).set( "displayName", "MutablePropAndPostConstructWithSuppressComponent" );
    }
  ...
  private static final class LiteNativeReactComponent extends NativeComponent implements OnShouldComponentUpdate {
    ...
    LiteNativeReactComponent(@Nullable final JsPropertyMap<Object> props) {
      super( props );
      $$react4j$$_component = new Arez_React4j_MutablePropAndPostConstructWithSuppressComponent( this );
    }
