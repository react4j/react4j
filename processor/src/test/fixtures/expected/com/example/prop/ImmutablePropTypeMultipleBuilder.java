...
final class ImmutablePropTypeMultipleBuilder {
  ...
  public interface Step13 {
    ...
    Step14 actAsComponentProp(
        @Nonnull ImmutablePropTypeMultiple.ActAsComponentComponent actAsComponentProp);
  }
  ...
  public interface Step16 {
    ...
    Step16 nullableActAsComponentProp(
        @Nullable ImmutablePropTypeMultiple.ActAsComponentComponent nullableActAsComponentProp);
