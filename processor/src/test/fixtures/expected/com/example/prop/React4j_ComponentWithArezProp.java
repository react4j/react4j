...
abstract class React4j_ComponentWithArezProp extends ComponentWithArezProp {
  ...
  React4j_ComponentWithArezProp(@Nonnull final NativeComponent $$react4j$$_nativeComponent) {
  ...
  @Override
  ComponentWithArezProp.Model getModel() {
    if ( React.shouldCheckInvariants() ) {
  ...
  private void $$react4j$$_componentWillUnmount() {
    ...
    ((Arez_React4j_ComponentWithArezProp) this).dispose();
  }
  ...
  private static final class LiteNativeReactComponent extends NativeComponent implements OnShouldComponentUpdate, OnComponentWillUnmount {
    @Nonnull
    private final React4j_ComponentWithArezProp $$react4j$$_component;

    @JsConstructor
    LiteNativeReactComponent(@Nullable final JsPropertyMap<Object> props) {
      super( props );
      $$react4j$$_component = new Arez_React4j_ComponentWithArezProp( this );
    }
