...
@ArezComponent(
    name = "com_example_prop_NonDisposableDisposableProp",
...
abstract class React4j_NonDisposableDisposableProp extends NonDisposableDisposableProp {
  ...
  React4j_NonDisposableDisposableProp(
  ...
  private static final class LiteNativeView extends react4j.internal.NativeView implements OnShouldComponentUpdate, OnComponentWillUnmount {
    private final React4j_NonDisposableDisposableProp view;

    @JsConstructor
    LiteNativeView(@Nullable final JsPropertyMap<Object> inputs) {
      super( inputs );
      view = new Arez_React4j_NonDisposableDisposableProp( this );
    }
