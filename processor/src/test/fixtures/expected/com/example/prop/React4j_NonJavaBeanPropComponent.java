...
abstract class React4j_NonJavaBeanPropComponent extends NonJavaBeanPropComponent {
  ...
  String window() {
    if ( React.shouldCheckInvariants() ) {
      return null != $$react4j$$_nativeView.props().getAsAny( Props.window ) ? $$react4j$$_nativeView.props().getAsAny( Props.window ).asString() : null;
    } else {
      return Js.uncheckedCast( $$react4j$$_nativeView.props().getAsAny( Props.window ) );
    }
  }
