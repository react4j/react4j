...
abstract class React4j_GenericTypePropModel<T> extends GenericTypePropModel<T> {
  React4j_GenericTypePropModel(@Nonnull final NativeComponent $$react4j$$_nativeComponent) {
  ...
  private static ComponentConstructorFunction getConstructorFunction() {
    ...
    if ( React.enableComponentNames() ) {
      Js.asPropertyMap( componentConstructor ).set( "displayName", "GenericTypePropModel" );
    }
  ...
  private static final class LiteNativeReactComponent<T> extends NativeComponent implements OnShouldComponentUpdate {
    @Nonnull
    private final React4j_GenericTypePropModel<T> $$react4j$$_component;

    @JsConstructor
    LiteNativeReactComponent(@Nullable final JsPropertyMap<Object> props) {
      super( props );
      $$react4j$$_component = new Arez_React4j_GenericTypePropModel<T>( this );
    }
