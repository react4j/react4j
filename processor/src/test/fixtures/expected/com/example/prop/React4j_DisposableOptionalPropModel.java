...
abstract class React4j_DisposableOptionalPropModel extends DisposableOptionalPropModel {
  ...
  React4j_DisposableOptionalPropModel(
  ...
  private static ViewConstructorFunction getConstructorFunction() {
    ...
    if ( React.enableViewNames() ) {
      Js.asPropertyMap( viewConstructor ).set( "displayName", "DisposableOptionalPropModel" );
    }
  ...
  private static final class LiteNativeView extends react4j.internal.NativeView implements OnShouldComponentUpdate, OnComponentWillUnmount {
    @Nonnull
    private final React4j_DisposableOptionalPropModel $$react4j$$_view;

    @JsConstructor
    LiteNativeView(@Nullable final JsPropertyMap<Object> inputs) {
      super( inputs );
      $$react4j$$_view = new Arez_React4j_DisposableOptionalPropModel( this );
    }
