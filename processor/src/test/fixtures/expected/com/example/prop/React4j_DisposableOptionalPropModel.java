...
abstract class React4j_DisposableOptionalPropModel extends DisposableOptionalPropModel {
  private int $$react4j$$_state;

  React4j_DisposableOptionalPropModel(@Nonnull final NativeComponent $$react4j$$_nativeComponent) {
  ...
  private static ComponentConstructorFunction getConstructorFunction() {
    ...
    if ( React.enableComponentNames() ) {
      Js.asPropertyMap( componentConstructor ).set( "displayName", "DisposableOptionalPropModel" );
    }
  ...
  private void $$react4j$$_componentWillUnmount() {
    ...
    ((Arez_React4j_DisposableOptionalPropModel) this).dispose();
  }
  ...
  private static final class LiteNativeReactComponent extends NativeComponent implements OnShouldComponentUpdate, OnComponentWillUnmount {
    @Nonnull
    private final React4j_DisposableOptionalPropModel $$react4j$$_component;

    @JsConstructor
    LiteNativeReactComponent(@Nullable final JsPropertyMap<Object> props) {
      super( props );
      $$react4j$$_component = new Arez_React4j_DisposableOptionalPropModel( this );
    }
