...
@ArezComponent(
    name = "com_example_prop_MutableDisposableArezComponentTrackingProp",
    disposeNotifier = Feature.DISABLE,
    sting = Feature.DISABLE
)
@Generated("react4j.processor.React4jProcessor")
abstract class React4j_MutableDisposableArezComponentTrackingProp extends MutableDisposableArezComponentTrackingProp {
  @Nonnull
  ...
  React4j_MutableDisposableArezComponentTrackingProp(
  ...
  private static ViewConstructorFunction getConstructorFunction() {
    ...
    if ( React.enableViewNames() ) {
      Js.asPropertyMap( viewConstructor ).set( "displayName", "MutableDisposableArezComponentTrackingProp" );
    }
  ...
  @Nonnull
  @Override
  MutableDisposableArezComponentTrackingProp.Model getModel() {
  ...
  private void $$react4j$$_validateInputValues(@Nonnull final JsPropertyMap<Object> inputs) {
    ...
    if ( React.shouldCheckInvariants() ) {
      Guards.apiInvariant( () -> null != raw$model, () -> "Required input named 'model' is missing from view named 'MutableDisposableArezComponentTrackingProp' so it was either incorrectly omitted or a null value has been incorrectly specified." ) ;
    }
  }
  ...
  private void $$react4j$$_componentWillUnmount() {
    ((Arez_React4j_MutableDisposableArezComponentTrackingProp) this).dispose();
  ...
  ReactNode $$react4j$$_render() {
    ...
    final MutableDisposableArezComponentTrackingProp.Model $$react4jv$$_getModel = getModel();
  ...
  private static final class LiteNativeView extends react4j.internal.NativeView implements OnShouldComponentUpdate, OnComponentWillUnmount {
    @Nonnull
    private final React4j_MutableDisposableArezComponentTrackingProp $$react4j$$_view;

    @JsConstructor
    LiteNativeView(@Nullable final JsPropertyMap<Object> inputs) {
      super( inputs );
      $$react4j$$_view = new Arez_React4j_MutableDisposableArezComponentTrackingProp( this );
      if ( React.shouldValidateInputValues() ) {
        assert null != inputs;
