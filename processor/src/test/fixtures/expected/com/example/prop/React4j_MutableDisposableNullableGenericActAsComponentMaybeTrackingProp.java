...
@ArezComponent(
    name = "com_example_prop_MutableDisposableNullableGenericActAsComponentMaybeTrackingProp",
    disposeNotifier = Feature.DISABLE,
    sting = Feature.DISABLE
)
@Generated("react4j.processor.React4jProcessor")
abstract class React4j_MutableDisposableNullableGenericActAsComponentMaybeTrackingProp extends MutableDisposableNullableGenericActAsComponentMaybeTrackingProp {
  @Nonnull
  ...
  React4j_MutableDisposableNullableGenericActAsComponentMaybeTrackingProp(
  ...
  private static ViewConstructorFunction getConstructorFunction() {
    ...
    if ( React.enableViewNames() ) {
      Js.asPropertyMap( viewConstructor ).set( "displayName", "MutableDisposableNullableGenericActAsComponentMaybeTrackingProp" );
    }
  ...
  @Nullable
  @Override
  MutableDisposableNullableGenericActAsComponentMaybeTrackingProp.ActAsComponentComponent<?> model(
      ) {
  ...
  private void $$react4j$$_componentWillUnmount() {
    ((Arez_React4j_MutableDisposableNullableGenericActAsComponentMaybeTrackingProp) this).dispose();
  ...
  ReactNode $$react4j$$_render() {
    ...
    final MutableDisposableNullableGenericActAsComponentMaybeTrackingProp.ActAsComponentComponent<?> $$react4jv$$_model = model();
  ...
  private static final class LiteNativeView extends react4j.internal.NativeView implements OnShouldComponentUpdate, OnComponentWillUnmount {
    @Nonnull
    private final React4j_MutableDisposableNullableGenericActAsComponentMaybeTrackingProp $$react4j$$_view;

    @JsConstructor
    LiteNativeView(@Nullable final JsPropertyMap<Object> inputs) {
      super( inputs );
      $$react4j$$_view = new Arez_React4j_MutableDisposableNullableGenericActAsComponentMaybeTrackingProp( this );
    }
