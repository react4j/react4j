...
abstract class React4j_MutablePropAndPostConstructWithReact4jSuppressComponent extends MutablePropAndPostConstructWithReact4jSuppressComponent {
  @Nonnull
  ...
  private static ComponentConstructorFunction getConstructorFunction() {
    ...
    if ( React.enableComponentNames() ) {
      Js.asPropertyMap( componentConstructor ).set( "displayName", "MutablePropAndPostConstructWithReact4jSuppressComponent" );
    }
  ...
  private static final class LiteNativeReactComponent extends NativeComponent implements OnShouldComponentUpdate {
    @Nonnull
    private final React4j_MutablePropAndPostConstructWithReact4jSuppressComponent $$react4j$$_component;

    @JsConstructor
    LiteNativeReactComponent(@Nullable final JsPropertyMap<Object> props) {
      super( props );
      $$react4j$$_component = new Arez_React4j_MutablePropAndPostConstructWithReact4jSuppressComponent( this );
    }
