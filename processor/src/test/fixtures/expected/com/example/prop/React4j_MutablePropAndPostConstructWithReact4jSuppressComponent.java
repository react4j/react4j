...
abstract class React4j_MutablePropAndPostConstructWithReact4jSuppressComponent extends MutablePropAndPostConstructWithReact4jSuppressComponent {
  ...
  private static ViewConstructorFunction getConstructorFunction() {
    ...
    if ( React.enableViewNames() ) {
      Js.asPropertyMap( viewConstructor ).set( "displayName", "MutablePropAndPostConstructWithReact4jSuppressComponent" );
    }
  ...
  private static final class NativeView extends react4j.internal.NativeView implements OnShouldComponentUpdate, OnComponentWillUnmount {
    @Nonnull
    private final React4j_MutablePropAndPostConstructWithReact4jSuppressComponent $$react4j$$_view;

    @JsConstructor
    NativeView(@Nullable final JsPropertyMap<Object> inputs) {
      super( inputs );
      $$react4j$$_view = new Arez_React4j_MutablePropAndPostConstructWithReact4jSuppressComponent( this );
    }
