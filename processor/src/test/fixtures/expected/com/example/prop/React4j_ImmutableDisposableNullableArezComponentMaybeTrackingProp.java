...
@ArezComponent(
    name = "com_example_prop_ImmutableDisposableNullableArezComponentMaybeTrackingProp",
    disposeNotifier = Feature.DISABLE,
    sting = Feature.DISABLE
)
@Generated("react4j.processor.React4jProcessor")
abstract class React4j_ImmutableDisposableNullableArezComponentMaybeTrackingProp extends ImmutableDisposableNullableArezComponentMaybeTrackingProp {
  @Nonnull
  private final react4j.internal.NativeView $$react4j$$_nativeView;

  @ComponentDependency
  @Nullable
  final ImmutableDisposableNullableArezComponentMaybeTrackingProp.Model $$react4j_immutable_input$$_model;

  private int $$react4j$$_state;

  private boolean $$react4j$$_scheduledDebugStateUpdate;

  React4j_ImmutableDisposableNullableArezComponentMaybeTrackingProp(
  ...
  private static ViewConstructorFunction getConstructorFunction() {
    ...
    if ( React.enableViewNames() ) {
      Js.asPropertyMap( viewConstructor ).set( "displayName", "ImmutableDisposableNullableArezComponentMaybeTrackingProp" );
    }
  ...
  @Nullable
  @Override
  ImmutableDisposableNullableArezComponentMaybeTrackingProp.Model getModel() {
  ...
  private void $$react4j$$_componentWillUnmount() {
    ((Arez_React4j_ImmutableDisposableNullableArezComponentMaybeTrackingProp) this).dispose();
  ...
  ReactNode $$react4j$$_render() {
    ...
    final ImmutableDisposableNullableArezComponentMaybeTrackingProp.Model $$react4jv$$_getModel = getModel();
  ...
  private static final class LiteNativeView extends react4j.internal.NativeView implements OnShouldComponentUpdate, OnComponentWillUnmount {
    @Nonnull
    private final React4j_ImmutableDisposableNullableArezComponentMaybeTrackingProp view;

    @JsConstructor
    LiteNativeView(@Nullable final JsPropertyMap<Object> inputs) {
      super( inputs );
      view = Disposable.isDisposed( Js.uncheckedCast( inputs.getAsAny( Inputs.model ) ) ) ? null : new Arez_React4j_ImmutableDisposableNullableArezComponentMaybeTrackingProp( this );
    }
