...
abstract class React4j_ImmutableDisposableNullableArezComponentMaybeTrackingProp extends ImmutableDisposableNullableArezComponentMaybeTrackingProp {
  ...
  private static final class LiteNativeView extends react4j.internal.NativeView implements OnShouldComponentUpdate, OnComponentWillUnmount {
    ...
    LiteNativeView(@Nullable final JsPropertyMap<Object> inputs) {
      super( inputs );
      ImmutableDisposableNullableArezComponentMaybeTrackingProp.Model model;
      ...
      view = Disposable.isDisposed( Js.uncheckedCast( inputs.getAsAny( Inputs.model ) ) ) ? null : new Arez_React4j_ImmutableDisposableNullableArezComponentMaybeTrackingProp( this, model );
    }
