...
abstract class React4j_ImmutablePropTypeActAsComponentClass extends ImmutablePropTypeActAsComponentClass {
  ...
  React4j_ImmutablePropTypeActAsComponentClass(
      ...
      @Nullable final ImmutablePropTypeActAsComponentClass.MyComponent myProp) {
    super( myProp );
  ...
  private static final class NativeView extends react4j.internal.NativeView implements OnShouldComponentUpdate, OnComponentWillUnmount {
    @Nonnull
    private final React4j_ImmutablePropTypeActAsComponentClass view;

    @JsConstructor
    NativeView(@Nullable final JsPropertyMap<Object> inputs) {
      super( inputs );
      ImmutablePropTypeActAsComponentClass.MyComponent myProp;
      ...
      view = Disposable.isDisposed( Js.uncheckedCast( inputs.getAsAny( Inputs.myProp ) ) ) ? null : new Arez_React4j_ImmutablePropTypeActAsComponentClass( this, myProp );
    }
