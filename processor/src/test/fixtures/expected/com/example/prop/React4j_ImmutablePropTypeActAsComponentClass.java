...
abstract class React4j_ImmutablePropTypeActAsComponentClass extends ImmutablePropTypeActAsComponentClass {
  ...
  private static ComponentConstructorFunction getConstructorFunction() {
    ...
    if ( React.enableComponentNames() ) {
      Js.asPropertyMap( componentConstructor ).set( "displayName", "ImmutablePropTypeActAsComponentClass" );
    }
  ...
  protected ReactNode render() {
    ...
    final ImmutablePropTypeActAsComponentClass.MyComponent $$react4jv$$_getMyProp = getMyProp();
  ...
  private static final class LiteNativeReactComponent extends NativeComponent implements OnShouldComponentUpdate {
    @Nonnull
    private final React4j_ImmutablePropTypeActAsComponentClass $$react4j$$_component;

    @JsConstructor
    LiteNativeReactComponent(@Nullable final JsPropertyMap<Object> props) {
      super( props );
      $$react4j$$_component = new Arez_React4j_ImmutablePropTypeActAsComponentClass( this );
    }
