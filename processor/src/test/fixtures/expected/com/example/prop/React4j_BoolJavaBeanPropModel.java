...
@ArezComponent(
    name = "com_example_prop_BoolJavaBeanPropModel",
...
abstract class React4j_BoolJavaBeanPropModel extends BoolJavaBeanPropModel {
  ...
  React4j_BoolJavaBeanPropModel(@Nonnull final react4j.internal.NativeView $$react4j$$_nativeView) {
  ...
  private void $$react4j$$_componentWillUnmount() {
    ((Arez_React4j_BoolJavaBeanPropModel) this).dispose();
  }
  ...
  private static final class NativeView extends react4j.internal.NativeView implements OnShouldComponentUpdate, OnComponentWillUnmount {
    @Nonnull
    private final React4j_BoolJavaBeanPropModel view;

    @JsConstructor
    NativeView(@Nullable final JsPropertyMap<Object> inputs) {
      super( inputs );
      view = new Arez_React4j_BoolJavaBeanPropModel( this );
    }
