...
@ArezComponent(
    name = "com_example_prop_ImmutablePropTypeString",
...
abstract class React4j_ImmutablePropTypeString extends ImmutablePropTypeString {
  ...
  private static final class NativeView extends react4j.internal.NativeView implements OnShouldComponentUpdate, OnComponentWillUnmount {
    @Nonnull
    private final React4j_ImmutablePropTypeString $$react4j$$_view;

    @JsConstructor
    NativeView(@Nullable final JsPropertyMap<Object> inputs) {
      super( inputs );
      $$react4j$$_view = new Arez_React4j_ImmutablePropTypeString( this );
    }
