...
@ArezComponent(
    name = "com_example_prop_ImmutableDisposableNullableActAsComponentTrackingProp",
    disposeNotifier = Feature.DISABLE,
    sting = Feature.DISABLE
)
@Generated("react4j.processor.React4jProcessor")
abstract class React4j_ImmutableDisposableNullableActAsComponentTrackingProp extends ImmutableDisposableNullableActAsComponentTrackingProp {
  @Nonnull
  private final react4j.internal.NativeView $$react4j$$_nativeView;

  @ComponentDependency
  @Nullable
  final ImmutableDisposableNullableActAsComponentTrackingProp.ActAsComponentComponent $$react4j_immutable_input$$_model;

  private int $$react4j$$_state;

  private boolean $$react4j$$_scheduledDebugStateUpdate;

  React4j_ImmutableDisposableNullableActAsComponentTrackingProp(
  ...
  private static ViewConstructorFunction getConstructorFunction() {
    ...
    if ( React.enableViewNames() ) {
      Js.asPropertyMap( viewConstructor ).set( "displayName", "ImmutableDisposableNullableActAsComponentTrackingProp" );
    }
  ...
  private void $$react4j$$_componentWillUnmount() {
    ((Arez_React4j_ImmutableDisposableNullableActAsComponentTrackingProp) this).dispose();
  ...
  ReactNode $$react4j$$_render() {
    ...
    final ImmutableDisposableNullableActAsComponentTrackingProp.ActAsComponentComponent $$react4jv$$_model = $$react4j_immutable_input$$_model;
  ...
  private static final class LiteNativeView extends react4j.internal.NativeView implements OnShouldComponentUpdate, OnComponentWillUnmount {
    @Nonnull
    private final React4j_ImmutableDisposableNullableActAsComponentTrackingProp view;

    @JsConstructor
    LiteNativeView(@Nullable final JsPropertyMap<Object> inputs) {
      super( inputs );
      ImmutableDisposableNullableActAsComponentTrackingProp.ActAsComponentComponent model;
      ...
      view = Disposable.isDisposed( Js.uncheckedCast( inputs.getAsAny( Inputs.model ) ) ) ? null : new Arez_React4j_ImmutableDisposableNullableActAsComponentTrackingProp( this, model );
    }
