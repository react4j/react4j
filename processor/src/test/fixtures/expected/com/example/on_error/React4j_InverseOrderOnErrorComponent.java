...
abstract class React4j_InverseOrderOnErrorComponent extends InverseOrderOnErrorComponent {
  React4j_InverseOrderOnErrorComponent(@Nonnull final NativeComponent $$react4j$$_nativeComponent) {
  ...
  private static ComponentConstructorFunction getConstructorFunction() {
    ...
    if ( React.enableComponentNames() ) {
      Js.asPropertyMap( componentConstructor ).set( "displayName", "InverseOrderOnErrorComponent" );
    }
  ...
  private static final class LiteNativeReactComponent extends NativeComponent implements OnShouldComponentUpdate, OnComponentDidCatch {
    @Nonnull
    private final React4j_InverseOrderOnErrorComponent $$react4j$$_component;

    @JsConstructor
    LiteNativeReactComponent(@Nullable final JsPropertyMap<Object> props) {
      super( props );
      $$react4j$$_component = new Arez_React4j_InverseOrderOnErrorComponent( this );
    }
    ...
    public final void componentDidCatch(@Nonnull final JsError error,
      ...
      $$react4j$$_component.onError( info, error );
    }
