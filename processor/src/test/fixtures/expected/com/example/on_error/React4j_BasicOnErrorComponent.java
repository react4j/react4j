...
abstract class React4j_BasicOnErrorComponent extends BasicOnErrorComponent {
  React4j_BasicOnErrorComponent(@Nonnull final NativeComponent $$react4j$$_nativeComponent) {
  ...
  private static ComponentConstructorFunction getConstructorFunction() {
    ...
    if ( React.enableComponentNames() ) {
      Js.asPropertyMap( componentConstructor ).set( "displayName", "BasicOnErrorComponent" );
    }
  ...
  private static final class LiteNativeReactComponent extends NativeComponent implements OnShouldComponentUpdate, OnComponentDidCatch {
    @Nonnull
    private final React4j_BasicOnErrorComponent $$react4j$$_component;
