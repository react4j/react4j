...
@ArezComponent(
    name = "PackageAccessOnErrorModel",
...
abstract class React4j_PackageAccessOnErrorModel extends PackageAccessOnErrorModel {
  @Nonnull
  private final react4j.internal.NativeView $$react4j$$_nativeView;

  React4j_PackageAccessOnErrorModel(
  ...
  private static ViewConstructorFunction getConstructorFunction() {
    ...
    if ( React.enableViewNames() ) {
      Js.asPropertyMap( viewConstructor ).set( "displayName", "PackageAccessOnErrorModel" );
    }
  ...
  private static final class LiteNativeView extends react4j.internal.NativeView implements OnShouldComponentUpdate, OnComponentDidCatch {
    @Nonnull
    private final React4j_PackageAccessOnErrorModel $$react4j$$_view;

    @JsConstructor
    LiteNativeView(@Nullable final JsPropertyMap<Object> props) {
      super( props );
      $$react4j$$_view = new Arez_React4j_PackageAccessOnErrorModel( this );
    }
