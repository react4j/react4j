...
abstract class React4j_PackageAccessOnErrorModel extends PackageAccessOnErrorModel {
  React4j_PackageAccessOnErrorModel(@Nonnull final NativeComponent $$react4j$$_nativeComponent) {
  ...
  private static ComponentConstructorFunction getConstructorFunction() {
    ...
    if ( React.enableComponentNames() ) {
      Js.asPropertyMap( componentConstructor ).set( "displayName", "PackageAccessOnErrorModel" );
    }
  ...
  private static final class LiteNativeReactComponent extends NativeComponent implements OnShouldComponentUpdate, OnComponentDidCatch {
    @Nonnull
    private final React4j_PackageAccessOnErrorModel $$react4j$$_component;

    @JsConstructor
    LiteNativeReactComponent(@Nullable final JsPropertyMap<Object> props) {
      super( props );
      $$react4j$$_component = new Arez_React4j_PackageAccessOnErrorModel( this );
    }
