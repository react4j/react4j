...
abstract class React4j_InfoOnlyOnErrorComponent extends InfoOnlyOnErrorComponent {
  ...
  React4j_InfoOnlyOnErrorComponent(
  ...
  private static ViewConstructorFunction getConstructorFunction() {
    ...
    if ( React.enableViewNames() ) {
      Js.asPropertyMap( viewConstructor ).set( "displayName", "InfoOnlyOnErrorComponent" );
    }
  ...
  private static final class LiteNativeView extends react4j.internal.NativeView implements OnShouldComponentUpdate, OnComponentDidCatch {
    @Nonnull
    private final React4j_InfoOnlyOnErrorComponent $$react4j$$_view;

    @JsConstructor
    LiteNativeView(@Nullable final JsPropertyMap<Object> props) {
      super( props );
      $$react4j$$_view = new Arez_React4j_InfoOnlyOnErrorComponent( this );
    }
