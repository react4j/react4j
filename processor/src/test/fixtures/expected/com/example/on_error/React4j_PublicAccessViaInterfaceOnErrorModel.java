...
abstract class React4j_PublicAccessViaInterfaceOnErrorModel extends PublicAccessViaInterfaceOnErrorModel {
  ...
  private static ComponentConstructorFunction getConstructorFunction() {
    ...
    if ( React.enableComponentNames() ) {
      Js.asPropertyMap( componentConstructor ).set( "displayName", "PublicAccessViaInterfaceOnErrorModel" );
    }
  ...
  private static final class LiteNativeReactComponent extends NativeComponent implements OnShouldComponentUpdate, OnComponentDidCatch {
    @Nonnull
    private final React4j_PublicAccessViaInterfaceOnErrorModel $$react4j$$_component;

    @JsConstructor
    LiteNativeReactComponent(@Nullable final JsPropertyMap<Object> props) {
      super( props );
      $$react4j$$_component = new Arez_React4j_PublicAccessViaInterfaceOnErrorModel( this );
    }
