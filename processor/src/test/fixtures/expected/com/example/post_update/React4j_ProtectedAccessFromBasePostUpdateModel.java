...
@ArezComponent(
    name = "ProtectedAccessFromBasePostUpdateModel",
...
abstract class React4j_ProtectedAccessFromBasePostUpdateModel extends ProtectedAccessFromBasePostUpdateModel {
  ...
  private static ComponentConstructorFunction getConstructorFunction() {
    ...
    if ( React.enableComponentNames() ) {
      Js.asPropertyMap( componentConstructor ).set( "displayName", "ProtectedAccessFromBasePostUpdateModel" );
    }
  ...
  private static final class LiteNativeReactComponent extends NativeComponent implements OnComponentDidUpdate, OnShouldComponentUpdate {
    @Nonnull
    private final React4j_ProtectedAccessFromBasePostUpdateModel $$react4j$$_component;

    @JsConstructor
    LiteNativeReactComponent(@Nullable final JsPropertyMap<Object> props) {
      super( props );
      $$react4j$$_component = new Arez_React4j_ProtectedAccessFromBasePostUpdateModel( this );
    }
