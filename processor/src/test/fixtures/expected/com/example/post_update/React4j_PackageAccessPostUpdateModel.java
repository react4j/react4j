...
abstract class React4j_PackageAccessPostUpdateModel extends PackageAccessPostUpdateModel {
  ...
  private static ComponentConstructorFunction getConstructorFunction() {
    ...
    if ( React.enableComponentNames() ) {
      Js.asPropertyMap( componentConstructor ).set( "displayName", "PackageAccessPostUpdateModel" );
    }
  ...
  private static final class LiteNativeReactComponent extends NativeComponent implements OnComponentDidUpdate, OnShouldComponentUpdate {
    @Nonnull
    private final React4j_PackageAccessPostUpdateModel $$react4j$$_component;

    @JsConstructor
    LiteNativeReactComponent(@Nullable final JsPropertyMap<Object> props) {
      super( props );
      $$react4j$$_component = new Arez_React4j_PackageAccessPostUpdateModel( this );
    }
