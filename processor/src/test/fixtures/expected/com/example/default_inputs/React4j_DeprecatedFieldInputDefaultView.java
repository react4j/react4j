...
@ArezComponent(
    name = "DeprecatedFieldInputDefaultView",
...
abstract class React4j_DeprecatedFieldInputDefaultView extends DeprecatedFieldInputDefaultView {
  ...
  private static ViewConstructorFunction getConstructorFunction() {
    ...
    if ( React.enableViewNames() ) {
      Js.asPropertyMap( viewConstructor ).set( "displayName", "DeprecatedFieldInputDefaultView" );
    }
  ...
  private static final class LiteNativeView extends react4j.internal.NativeView implements OnShouldComponentUpdate {
    @Nonnull
    private final React4j_DeprecatedFieldInputDefaultView $$react4j$$_view;

    @JsConstructor
    LiteNativeView(@Nullable final JsPropertyMap<Object> inputs) {
      super( inputs );
      $$react4j$$_view = new Arez_React4j_DeprecatedFieldInputDefaultView( this );
    }
