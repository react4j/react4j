...
@ArezComponent(
    name = "com_example_input_InputShouldUpdateOnChangeView",
    disposeNotifier = Feature.DISABLE,
    dagger = Feature.DISABLE,
    sting = Feature.DISABLE
)
@Generated("react4j.processor.React4jProcessor")
abstract class React4j_InputShouldUpdateOnChangeView extends InputShouldUpdateOnChangeView {
  @Nonnull
  ...
  React4j_InputShouldUpdateOnChangeView(
  ...
  private static ViewConstructorFunction getConstructorFunction() {
    ...
    if ( React.enableViewNames() ) {
      Js.asPropertyMap( viewConstructor ).set( "displayName", "InputShouldUpdateOnChangeView" );
    }
  ...
  String getOther() {
    if ( React.shouldCheckInvariants() ) {
      return null != $$react4j$$_nativeView.inputs().getAsAny( Inputs.other ) ? $$react4j$$_nativeView.inputs().getAsAny( Inputs.other ).asString() : null;
    } else {
      return Js.uncheckedCast( $$react4j$$_nativeView.inputs().getAsAny( Inputs.other ) );
    }
  }
  ...
  static final class Inputs {
    ...
    static final String other = React.shouldMinimizeInputKeys() ? "b" : "other";
  }
  ...
  private static final class LiteNativeView extends react4j.internal.NativeView implements OnShouldComponentUpdate, OnComponentWillUnmount {
    @Nonnull
    private final React4j_InputShouldUpdateOnChangeView $$react4j$$_view;

    @JsConstructor
    LiteNativeView(@Nullable final JsPropertyMap<Object> inputs) {
      super( inputs );
      $$react4j$$_view = new Arez_React4j_InputShouldUpdateOnChangeView( this );
    }
