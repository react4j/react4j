...
@ArezComponent(
    name = "com_example_input_InputShouldNotUpdateOnChangeView",
    disposeNotifier = Feature.DISABLE,
    dagger = Feature.DISABLE,
    sting = Feature.DISABLE
)
@Generated("react4j.processor.React4jProcessor")
abstract class React4j_InputShouldNotUpdateOnChangeView extends InputShouldNotUpdateOnChangeView {
  @Nonnull
  ...
  React4j_InputShouldNotUpdateOnChangeView(
  ...
  private static ViewConstructorFunction getConstructorFunction() {
    ...
    if ( React.enableViewNames() ) {
      Js.asPropertyMap( viewConstructor ).set( "displayName", "InputShouldNotUpdateOnChangeView" );
    }
  ...
  private static final class LiteNativeView extends react4j.internal.NativeView implements OnShouldComponentUpdate, OnComponentWillUnmount {
    @Nonnull
    private final React4j_InputShouldNotUpdateOnChangeView $$react4j$$_view;

    @JsConstructor
    LiteNativeView(@Nullable final JsPropertyMap<Object> inputs) {
      super( inputs );
      $$react4j$$_view = new Arez_React4j_InputShouldNotUpdateOnChangeView( this );
    }
