...
@ArezComponent(
    name = "com_example_schedule_render_NoSkipScheduleRenderComponent",
...
abstract class React4j_NoSkipScheduleRenderComponent extends NoSkipScheduleRenderComponent {
  ...
  private static final class NativeView extends react4j.internal.NativeView implements OnShouldComponentUpdate, OnComponentWillUnmount {
    @Nonnull
    private final React4j_NoSkipScheduleRenderComponent view;

    @JsConstructor
    NativeView(@Nullable final JsPropertyMap<Object> inputs) {
      super( inputs );
      view = new Arez_React4j_NoSkipScheduleRenderComponent( this );
    }
