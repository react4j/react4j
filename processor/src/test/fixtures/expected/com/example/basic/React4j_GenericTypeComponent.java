...
abstract class React4j_GenericTypeComponent<T> extends GenericTypeComponent<T> {
  ...
  React4j_GenericTypeComponent(@Nonnull final react4j.internal.NativeView $$react4j$$_nativeView) {
  ...
  private static ViewConstructorFunction getConstructorFunction() {
    ...
    if ( React.enableViewNames() ) {
      Js.asPropertyMap( viewConstructor ).set( "displayName", "GenericTypeComponent" );
    }
  ...
  private static final class LiteNativeView<T> extends react4j.internal.NativeView implements OnShouldComponentUpdate {
    @Nonnull
    private final React4j_GenericTypeComponent<T> $$react4j$$_view;

    @JsConstructor
    LiteNativeView(@Nullable final JsPropertyMap<Object> props) {
      super( props );
      $$react4j$$_view = new Arez_React4j_GenericTypeComponent<T>( this );
    }
