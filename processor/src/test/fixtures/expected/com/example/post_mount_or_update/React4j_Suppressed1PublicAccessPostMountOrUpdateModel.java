...
@ArezComponent(
    name = "Suppressed1PublicAccessPostMountOrUpdateModel",
...
abstract class React4j_Suppressed1PublicAccessPostMountOrUpdateModel extends Suppressed1PublicAccessPostMountOrUpdateModel {
  ...
  private static ComponentConstructorFunction getConstructorFunction() {
    ...
    if ( React.enableComponentNames() ) {
      Js.asPropertyMap( componentConstructor ).set( "displayName", "Suppressed1PublicAccessPostMountOrUpdateModel" );
    }
  ...
  private void $$react4j$$_componentWillUnmount() {
    ((Arez_React4j_Suppressed1PublicAccessPostMountOrUpdateModel) this).dispose();
  }
  ...
  private static final class LiteNativeReactComponent extends NativeComponent implements OnComponentDidMount, OnComponentDidUpdate, OnShouldComponentUpdate {
    @Nonnull
    private final React4j_Suppressed1PublicAccessPostMountOrUpdateModel $$react4j$$_component;

    @JsConstructor
    LiteNativeReactComponent(@Nullable final JsPropertyMap<Object> props) {
      super( props );
      $$react4j$$_component = new Arez_React4j_Suppressed1PublicAccessPostMountOrUpdateModel( this );
    }
