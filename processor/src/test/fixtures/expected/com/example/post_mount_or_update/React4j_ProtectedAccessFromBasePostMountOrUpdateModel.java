...
abstract class React4j_ProtectedAccessFromBasePostMountOrUpdateModel extends ProtectedAccessFromBasePostMountOrUpdateModel {
  ...
  private static ComponentConstructorFunction getConstructorFunction() {
    ...
    if ( React.enableComponentNames() ) {
      Js.asPropertyMap( componentConstructor ).set( "displayName", "ProtectedAccessFromBasePostMountOrUpdateModel" );
    }
  ...
  private static final class LiteNativeReactComponent extends NativeComponent implements OnComponentDidMount, OnComponentDidUpdate, OnShouldComponentUpdate {
    @Nonnull
    private final React4j_ProtectedAccessFromBasePostMountOrUpdateModel $$react4j$$_component;

    @JsConstructor
    LiteNativeReactComponent(@Nullable final JsPropertyMap<Object> props) {
      super( props );
      $$react4j$$_component = new Arez_React4j_ProtectedAccessFromBasePostMountOrUpdateModel( this );
    }
