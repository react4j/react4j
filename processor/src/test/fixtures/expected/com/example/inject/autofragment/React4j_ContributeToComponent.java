...
abstract class React4j_ContributeToComponent extends ContributeToComponent {
  ...
  React4j_ContributeToComponent(@Nonnull final NativeComponent $$react4j$$_nativeComponent,
  ...
  private static ComponentConstructorFunction getConstructorFunction() {
    ...
    if ( React.enableComponentNames() ) {
      Js.asPropertyMap( componentConstructor ).set( "displayName", "ContributeToComponent" );
    }
  ...
  private static final class LiteNativeReactComponent extends NativeComponent implements OnShouldComponentUpdate {
    @Nonnull
    private final React4j_ContributeToComponent $$react4j$$_component;

    @JsConstructor
    LiteNativeReactComponent(@Nullable final JsPropertyMap<Object> props) {
      super( props );
      $$react4j$$_component = ContributeToComponentFactory.create( this );
    }
