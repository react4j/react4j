...
abstract class React4j_ConstructorInjectRawTypeComponent extends ConstructorInjectRawTypeComponent {
  ...
  private static ComponentConstructorFunction getConstructorFunction() {
    ...
    if ( React.enableComponentNames() ) {
      Js.asPropertyMap( componentConstructor ).set( "displayName", "ConstructorInjectRawTypeComponent" );
    }
  ...
  private static final class LiteNativeReactComponent extends NativeComponent implements OnShouldComponentUpdate {
    @Nonnull
    private final React4j_ConstructorInjectRawTypeComponent $$react4j$$_component;
