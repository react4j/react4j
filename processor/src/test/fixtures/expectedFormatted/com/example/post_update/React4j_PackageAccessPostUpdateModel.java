...
@ArezComponent(
    name = "com_example_post_update_PackageAccessPostUpdateModel",
...
abstract class React4j_PackageAccessPostUpdateModel extends PackageAccessPostUpdateModel {
  ...
  React4j_PackageAccessPostUpdateModel(
  ...
  private static ViewConstructorFunction getConstructorFunction() {
    ...
    if (React.enableViewNames()) {
      Js.asPropertyMap(viewConstructor).set("displayName", "PackageAccessPostUpdateModel");
    }
  ...
  private void $$react4j$$_componentWillUnmount() {
    ((Arez_React4j_PackageAccessPostUpdateModel) this).dispose();
  }
  ...
  private static final class NativeView extends react4j.internal.NativeView
    ...
    @Nonnull
    private final React4j_PackageAccessPostUpdateModel view;

    @JsConstructor
    NativeView(@Nullable final JsPropertyMap<Object> inputs) {
      super(inputs);
      view = new Arez_React4j_PackageAccessPostUpdateModel(this);
    }
