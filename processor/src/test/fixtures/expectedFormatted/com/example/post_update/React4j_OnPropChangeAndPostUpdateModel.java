...
@ArezComponent(
    name = "com_example_post_update_OnPropChangeAndPostUpdateModel",
...
abstract class React4j_OnPropChangeAndPostUpdateModel extends OnPropChangeAndPostUpdateModel {
  ...
  private void $$react4j$$_componentWillUnmount() {
    ((Arez_React4j_OnPropChangeAndPostUpdateModel) this).dispose();
  }
  ...
  private static final class NativeView extends react4j.internal.NativeView
    ...
    NativeView(@Nullable final JsPropertyMap<Object> inputs) {
      super(inputs);
      view = new Arez_React4j_OnPropChangeAndPostUpdateModel(this);
    }
