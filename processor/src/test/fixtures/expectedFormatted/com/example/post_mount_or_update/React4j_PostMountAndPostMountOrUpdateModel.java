...
@ArezComponent(
    name = "com_example_post_mount_or_update_PostMountAndPostMountOrUpdateModel",
    disposeNotifier = Feature.DISABLE,
    defaultSkipIfDisposed = Feature.ENABLE,
    sting = Feature.DISABLE,
    allowEmpty = true)
@Generated("react4j.processor.React4jProcessor")
abstract class React4j_PostMountAndPostMountOrUpdateModel
    extends PostMountAndPostMountOrUpdateModel {
  @Nonnull
  ...
  private static final class NativeView extends react4j.internal.NativeView
    ...
    NativeView(@Nullable final JsPropertyMap<Object> inputs) {
      super(inputs);
      view = new Arez_React4j_PostMountAndPostMountOrUpdateModel(this);
    }
