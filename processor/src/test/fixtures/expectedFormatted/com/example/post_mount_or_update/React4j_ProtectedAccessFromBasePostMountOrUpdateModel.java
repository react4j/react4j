...
abstract class React4j_ProtectedAccessFromBasePostMountOrUpdateModel
    extends ProtectedAccessFromBasePostMountOrUpdateModel {
  @Nonnull
  ...
  private static ViewConstructorFunction getConstructorFunction() {
    ...
    if (React.enableViewNames()) {
      Js.asPropertyMap(viewConstructor)
          .set("displayName", "ProtectedAccessFromBasePostMountOrUpdateModel");
    }
  ...
  private static final class NativeView extends react4j.internal.NativeView
    ...
    @Nonnull
    private final React4j_ProtectedAccessFromBasePostMountOrUpdateModel view;

    @JsConstructor
    NativeView(@Nullable final JsPropertyMap<Object> inputs) {
      super(inputs);
      view = new Arez_React4j_ProtectedAccessFromBasePostMountOrUpdateModel(this);
    }
