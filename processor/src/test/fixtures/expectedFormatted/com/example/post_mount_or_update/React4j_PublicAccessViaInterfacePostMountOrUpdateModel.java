...
@ArezComponent(
    name = "com_example_post_mount_or_update_PublicAccessViaInterfacePostMountOrUpdateModel",
    disposeNotifier = Feature.DISABLE,
    defaultSkipIfDisposed = Feature.ENABLE,
    sting = Feature.DISABLE,
    allowEmpty = true)
@Generated("react4j.processor.React4jProcessor")
abstract class React4j_PublicAccessViaInterfacePostMountOrUpdateModel
    extends PublicAccessViaInterfacePostMountOrUpdateModel {
  @Nonnull
  ...
  private static ViewConstructorFunction getConstructorFunction() {
    ...
    if (React.enableViewNames()) {
      Js.asPropertyMap(viewConstructor)
          .set("displayName", "PublicAccessViaInterfacePostMountOrUpdateModel");
    }
  ...
  private static final class NativeView extends react4j.internal.NativeView
    ...
    @Nonnull
    private final React4j_PublicAccessViaInterfacePostMountOrUpdateModel view;

    @JsConstructor
    NativeView(@Nullable final JsPropertyMap<Object> inputs) {
      super(inputs);
      view = new Arez_React4j_PublicAccessViaInterfacePostMountOrUpdateModel(this);
    }
