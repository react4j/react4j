...
abstract class React4j_BasicPostMountOrUpdateModel extends BasicPostMountOrUpdateModel {
  ...
  React4j_BasicPostMountOrUpdateModel(
  ...
  private static ViewConstructorFunction getConstructorFunction() {
    ...
    if (React.enableViewNames()) {
      Js.asPropertyMap(viewConstructor).set("displayName", "BasicPostMountOrUpdateModel");
    }
  ...
  private static final class NativeView extends react4j.internal.NativeView
    ...
    @Nonnull
    private final React4j_BasicPostMountOrUpdateModel view;

    @JsConstructor
    NativeView(@Nullable final JsPropertyMap<Object> inputs) {
      super(inputs);
      view = new Arez_React4j_BasicPostMountOrUpdateModel(this);
    }
