...
@ArezComponent(
    name = "com_example_nested_NestedNestedView_DeepNesting_BasicView",
    disposeNotifier = Feature.DISABLE,
    defaultSkipIfDisposed = Feature.ENABLE,
    sting = Feature.DISABLE,
    allowEmpty = true)
@Generated("react4j.processor.React4jProcessor")
abstract class NestedNestedView_DeepNesting_React4j_BasicView
    extends NestedNestedView.DeepNesting.BasicView {
  @Nonnull
  ...
  private static final class NativeView extends react4j.internal.NativeView
    ...
    NativeView(@Nullable final JsPropertyMap<Object> inputs) {
      super(inputs);
      view = new Arez_NestedNestedView_DeepNesting_React4j_BasicView(this);
    }
