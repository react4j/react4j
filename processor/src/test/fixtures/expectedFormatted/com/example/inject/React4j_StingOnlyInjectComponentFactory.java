...
final class React4j_StingOnlyInjectComponentFactory {
  ...
  @Nonnull
  static React4j_StingOnlyInjectComponent create(@Nonnull final NativeView view) {
    ...
    private static void setFactory(@Nonnull final React4j_StingOnlyInjectComponentFactory factory) {
      if (React.shouldCheckInvariants()) {
        Guards.invariant(
            () -> null == c_factory,
            () ->
                "Attempted to instantiate the React4j view factory for the view named 'StingOnlyInjectComponent' a second time");
      }
      c_factory = factory;
    }
    ...
    private static React4j_StingOnlyInjectComponent create(@Nonnull final NativeView view) {
      if (React.shouldCheckInvariants()) {
        Guards.invariant(
            () -> null != c_factory,
            () ->
                "Attempted to create an instance of the React4j view named 'StingOnlyInjectComponent' before the view factory has been initialized. Please see the documentation at https://react4j.github.io/dependency_injection for directions how to configure dependency injection.");
      }
