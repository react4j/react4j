    ...
    private static void setFactory(
      ...
      if (React.shouldCheckInvariants()) {
        Guards.invariant(
            () -> null == c_factory,
            () ->
                "Attempted to instantiate the React4j view factory for the view named 'ConstructorInputAndInjectArezComponentTypeComponent' a second time");
      }
      c_factory = factory;
    }
    ...
    private static React4j_ConstructorInputAndInjectArezComponentTypeComponent create(
      ...
      if (React.shouldCheckInvariants()) {
        Guards.invariant(
            () -> null != c_factory,
            () ->
                "Attempted to create an instance of the React4j view named 'ConstructorInputAndInjectArezComponentTypeComponent' before the view factory has been initialized. Please see the documentation at https://react4j.github.io/dependency_injection for directions how to configure dependency injection.");
      }
      final ConstructorInputAndInjectArezComponentTypeComponent.Model model = view.inputs()
          .getAsAny(React4j_ConstructorInputAndInjectArezComponentTypeComponent.Inputs.model)
          .cast();
      return new Arez_React4j_ConstructorInputAndInjectArezComponentTypeComponent(
          view, c_factory.someParam, model);
    }
  }
}
