...
@ArezComponent(
    name = "com_example_pre_update_OnPropChangeAndPreUpdateModel",
...
abstract class React4j_OnPropChangeAndPreUpdateModel extends OnPropChangeAndPreUpdateModel {
  ...
  private static ViewConstructorFunction getConstructorFunction() {
    ...
    if (React.enableViewNames()) {
      Js.asPropertyMap(viewConstructor).set("displayName", "OnPropChangeAndPreUpdateModel");
    }
  ...
  private static final class NativeView extends react4j.internal.NativeView
    ...
    @Nonnull
    private final React4j_OnPropChangeAndPreUpdateModel view;

    @JsConstructor
    NativeView(@Nullable final JsPropertyMap<Object> inputs) {
      super(inputs);
      view = new Arez_React4j_OnPropChangeAndPreUpdateModel(this);
    }
