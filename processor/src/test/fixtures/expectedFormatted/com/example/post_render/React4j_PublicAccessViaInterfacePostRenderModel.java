...
abstract class React4j_PublicAccessViaInterfacePostRenderModel
    extends PublicAccessViaInterfacePostRenderModel {
  @Nonnull
  ...
  private static ViewConstructorFunction getConstructorFunction() {
    ...
    if (React.enableViewNames()) {
      Js.asPropertyMap(viewConstructor)
          .set("displayName", "PublicAccessViaInterfacePostRenderModel");
    }
