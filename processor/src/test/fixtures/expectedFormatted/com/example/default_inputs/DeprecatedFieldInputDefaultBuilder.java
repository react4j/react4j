...
final class DeprecatedFieldInputDefaultBuilder {
  private DeprecatedFieldInputDefaultBuilder() {}
  ...
  private static class Builder implements Step1 {
    ...
    Builder() {
      _element =
          ReactElement.createViewElement(React4j_DeprecatedFieldInputDefaultView.Factory.TYPE);
      final JsPropertyMap<Object> inputs = _element.inputs();
      inputs.set(
          React4j_DeprecatedFieldInputDefaultView.Inputs.myProp,
          DeprecatedFieldInputDefaultView.DEFAULT_MY_PROP);
    }
