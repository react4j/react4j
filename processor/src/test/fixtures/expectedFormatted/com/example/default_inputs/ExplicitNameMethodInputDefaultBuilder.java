...
final class ExplicitNameMethodInputDefaultBuilder {
  private ExplicitNameMethodInputDefaultBuilder() {}
  ...
  private static class Builder implements Step1 {
    ...
    Builder() {
      _element =
          ReactElement.createViewElement(React4j_ExplicitNameMethodInputDefaultView.Factory.TYPE);
      final JsPropertyMap<Object> inputs = _element.inputs();
      inputs.set(
          React4j_ExplicitNameMethodInputDefaultView.Inputs.myProp,
          ExplicitNameMethodInputDefaultView.zoooooooooooooom());
    }
