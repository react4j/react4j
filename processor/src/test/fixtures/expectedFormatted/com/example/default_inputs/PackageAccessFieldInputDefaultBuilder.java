...
final class PackageAccessFieldInputDefaultBuilder {
  private PackageAccessFieldInputDefaultBuilder() {}
  ...
  private static class Builder implements Step1 {
    ...
    Builder() {
      _element =
          ReactElement.createViewElement(React4j_PackageAccessFieldInputDefaultView.Factory.TYPE);
      final JsPropertyMap<Object> inputs = _element.inputs();
      inputs.set(
          React4j_PackageAccessFieldInputDefaultView.Inputs.myProp,
          PackageAccessFieldInputDefaultView.DEFAULT_MY_PROP);
    }
