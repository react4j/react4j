...
@ArezComponent(
    name = "com_example_default_inputs_PublicFieldInputDefaultView",
    disposeNotifier = Feature.DISABLE,
    defaultSkipIfDisposed = Feature.ENABLE,
    sting = Feature.DISABLE,
    allowEmpty = true)
@Generated("react4j.processor.React4jProcessor")
abstract class React4j_PublicFieldInputDefaultView extends PublicFieldInputDefaultView {
  @Nonnull
  private final react4j.internal.NativeView $$react4j$$_nativeView;

  React4j_PublicFieldInputDefaultView(
  ...
  private void $$react4j$$_componentWillUnmount() {
    ((Arez_React4j_PublicFieldInputDefaultView) this).dispose();
  }
  ...
  private static final class NativeView extends react4j.internal.NativeView
    ...
    @Nonnull
    private final React4j_PublicFieldInputDefaultView view;

    @JsConstructor
    NativeView(@Nullable final JsPropertyMap<Object> inputs) {
      super(inputs);
      view = new Arez_React4j_PublicFieldInputDefaultView(this);
    }
