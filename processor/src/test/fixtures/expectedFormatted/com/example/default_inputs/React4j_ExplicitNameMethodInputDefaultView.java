...
@ArezComponent(
    name = "com_example_default_inputs_ExplicitNameMethodInputDefaultView",
    disposeNotifier = Feature.DISABLE,
    defaultSkipIfDisposed = Feature.ENABLE,
    sting = Feature.DISABLE,
    allowEmpty = true)
@Generated("react4j.processor.React4jProcessor")
abstract class React4j_ExplicitNameMethodInputDefaultView
    extends ExplicitNameMethodInputDefaultView {
  @Nonnull
  private final react4j.internal.NativeView $$react4j$$_nativeView;

  React4j_ExplicitNameMethodInputDefaultView(
  ...
  private void $$react4j$$_componentWillUnmount() {
    ((Arez_React4j_ExplicitNameMethodInputDefaultView) this).dispose();
  }
  ...
  private static final class NativeView extends react4j.internal.NativeView
    ...
    @Nonnull
    private final React4j_ExplicitNameMethodInputDefaultView view;

    @JsConstructor
    NativeView(@Nullable final JsPropertyMap<Object> inputs) {
      super(inputs);
      view = new Arez_React4j_ExplicitNameMethodInputDefaultView(this);
    }
