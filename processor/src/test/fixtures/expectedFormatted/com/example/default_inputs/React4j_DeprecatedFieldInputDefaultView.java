...
abstract class React4j_DeprecatedFieldInputDefaultView extends DeprecatedFieldInputDefaultView {
  @Nonnull
  private final react4j.internal.NativeView $$react4j$$_nativeView;

  React4j_DeprecatedFieldInputDefaultView(
  ...
  private static ViewConstructorFunction getConstructorFunction() {
    ...
    if (React.enableViewNames()) {
      Js.asPropertyMap(viewConstructor).set("displayName", "DeprecatedFieldInputDefault");
    }
  ...
  private void $$react4j$$_componentWillUnmount() {
    ((Arez_React4j_DeprecatedFieldInputDefaultView) this).dispose();
  }
  ...
  private static final class NativeView extends react4j.internal.NativeView
    ...
    @Nonnull
    private final React4j_DeprecatedFieldInputDefaultView view;

    @JsConstructor
    NativeView(@Nullable final JsPropertyMap<Object> inputs) {
      super(inputs);
      view = new Arez_React4j_DeprecatedFieldInputDefaultView(this);
    }
