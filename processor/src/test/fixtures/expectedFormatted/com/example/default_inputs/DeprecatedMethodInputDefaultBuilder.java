...
final class DeprecatedMethodInputDefaultBuilder {
  private DeprecatedMethodInputDefaultBuilder() {}
  ...
  private static class Builder implements Step1 {
    ...
    Builder() {
      _element =
          ReactElement.createViewElement(React4j_DeprecatedMethodInputDefaultView.Factory.TYPE);
      final JsPropertyMap<Object> inputs = _element.inputs();
      inputs.set(
          React4j_DeprecatedMethodInputDefaultView.Inputs.myProp,
          DeprecatedMethodInputDefaultView.getMyPropDefault());
    }
