...
abstract class React4j_ProtectedAccessFromBasePublishModel
    extends ProtectedAccessFromBasePublishModel {
  @Nonnull
  ...
  private static final class NativeView extends react4j.internal.NativeView
    ...
    @Nonnull
    private final React4j_ProtectedAccessFromBasePublishModel view;

    @JsConstructor
    NativeView(@Nullable final JsPropertyMap<Object> inputs) {
      super(inputs);
      view = new Arez_React4j_ProtectedAccessFromBasePublishModel(this);
    }
