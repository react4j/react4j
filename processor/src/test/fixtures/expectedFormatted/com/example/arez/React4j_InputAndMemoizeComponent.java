...
abstract class React4j_InputAndMemoizeComponent extends InputAndMemoizeComponent {
  @Nonnull
  ...
  React4j_InputAndMemoizeComponent(
  ...
  private static ViewConstructorFunction getConstructorFunction() {
    ...
    if (React.enableViewNames()) {
      Js.asPropertyMap(viewConstructor).set("displayName", "InputAndMemoizeComponent");
    }
  ...
  @Nullable
  @Override
  @Observable(name = "value", expectSetter = false, readOutsideTransaction = Feature.ENABLE)
  String getValue() {
    if (React.shouldCheckInvariants()) {
      return null != $$react4j$$_nativeView.inputs().getAsAny(Inputs.value)
          ? $$react4j$$_nativeView.inputs().getAsAny(Inputs.value).asString()
          : null;
    } else {
  ...
  @Action(verifyRequired = false, skipIfDisposed = Feature.DISABLE, reportParameters = false)
  boolean $$react4j$$_shouldComponentUpdate(@Nullable final JsPropertyMap<Object> nextInputs) {
    ...
    return modified || ViewState.SCHEDULED == $$react4j$$_state;
  }
  ...
  private static final class LiteNativeView extends react4j.internal.NativeView
    ...
    LiteNativeView(@Nullable final JsPropertyMap<Object> inputs) {
      super(inputs);
      view = new Arez_React4j_InputAndMemoizeComponent(this);
    }
