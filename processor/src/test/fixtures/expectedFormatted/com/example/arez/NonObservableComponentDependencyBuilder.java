...
final class NonObservableComponentDependencyBuilder {
  private NonObservableComponentDependencyBuilder() {}
  ...
  private static class Builder implements Step1 {
    ...
    private final ReactElement _element =
        ReactElement.createViewElement(React4j_NonObservableComponentDependencyView.Factory.TYPE);
    ...
    public final ReactNode model(@Nonnull final NonObservableComponentDependencyView.Model model) {
      _element.setKey(Identifiable.<Object>getArezId(model)
          + (React.enableViewNames()
              ? "_NonObservableComponentDependencyView_2755cc8f"
              : NonObservableComponentDependencyView.class.getName()));
