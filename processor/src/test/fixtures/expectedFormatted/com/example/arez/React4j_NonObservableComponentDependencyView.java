...
@ArezComponent(
    name = "com_example_arez_NonObservableComponentDependencyView",
    disposeNotifier = Feature.DISABLE,
    defaultSkipIfDisposed = Feature.ENABLE,
    sting = Feature.DISABLE)
@Generated("react4j.processor.React4jProcessor")
abstract class React4j_NonObservableComponentDependencyView
    extends NonObservableComponentDependencyView {
  @Nonnull
  ...
  React4j_NonObservableComponentDependencyView(
      @Nonnull final react4j.internal.NativeView $$react4j$$_nativeView,
      @Nonnull final NonObservableComponentDependencyView.Model model) {
    super(model);
  ...
  private static ViewConstructorFunction getConstructorFunction() {
    final ViewConstructorFunction viewConstructor =
        (React.shouldStoreDebugDataAsState() || React.shouldValidateInputValues())
            ? NativeView::new
            : LiteNativeView::new;
  ...
  private static void $$react4j$$_validateInputValues(@Nonnull final JsPropertyMap<Object> inputs) {
    ...
    if (React.shouldCheckInvariants()) {
      Guards.apiInvariant(
          () -> null != raw$model,
          () ->
              "Required input named 'model' is missing from view named 'NonObservableComponentDependencyView' so it was either incorrectly omitted or a null value has been incorrectly specified.");
    }
  }
  ...
  private void $$react4j$$_componentWillUnmount() {
    ((Arez_React4j_NonObservableComponentDependencyView) this).dispose();
  ...
  ReactNode $$react4j$$_render() {
    ...
    final NonObservableComponentDependencyView.Model $$react4jv$$_candidate0 = model;
    SchedulerUtil.pauseUntilRenderLoopComplete();
    final ReactNode result = render();
    if (Arez.shouldCheckInvariants() && Arez.areSpiesEnabled()) {
      Guards.invariant(
          () -> !$$react4j$$_getRenderObserver()
              .getContext()
              .getSpy()
              .asObserverInfo($$react4j$$_getRenderObserver())
              .getDependencies()
              .isEmpty(),
          () -> "View render completed on '" + this
              + "' without accessing any Arez dependencies but has a type set to TRACKING. The render method needs to access an Arez dependency or the type should be changed to STATEFUL or MAYBE_TRACKING.");
    }
    return result;
  }
  ...
  private static final class LiteNativeView extends react4j.internal.NativeView
    ...
    LiteNativeView(@Nullable final JsPropertyMap<Object> inputs) {
      super(inputs);
      final NonObservableComponentDependencyView.Model model =
          inputs.getAsAny(Inputs.model).cast();
      view = Disposable.isDisposed(inputs.getAsAny(Inputs.model).cast())
          ? null
          : new Arez_React4j_NonObservableComponentDependencyView(this, model);
      if (React.shouldValidateInputValues()) {
        assert null != inputs;
  ...
  private static final class NativeView extends react4j.internal.NativeView
      implements OnComponentDidMount,
