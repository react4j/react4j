...
@ArezComponent(
    name = "com_example_arez_TrackingInheritedAutoObserveMethodView",
    disposeNotifier = Feature.DISABLE,
    defaultSkipIfDisposed = Feature.ENABLE,
    sting = Feature.DISABLE)
@Generated("react4j.processor.React4jProcessor")
abstract class React4j_TrackingInheritedAutoObserveMethodView
    extends TrackingInheritedAutoObserveMethodView {
  @Nonnull
  ...
  React4j_TrackingInheritedAutoObserveMethodView(
  ...
  @Nullable
  @Override
  TrackingInheritedAutoObserveMethodBase.Model getModel() {
    if (React.shouldCheckInvariants()) {
      return null != $$react4j$$_nativeView.inputs().getAsAny(Inputs.model)
          ? $$react4j$$_nativeView.inputs().getAsAny(Inputs.model).cast()
          : null;
    } else {
  ...
  private void $$react4j$$_componentWillUnmount() {
    ((Arez_React4j_TrackingInheritedAutoObserveMethodView) this).dispose();
  ...
  ReactNode $$react4j$$_render() {
    ...
    final TrackingInheritedAutoObserveMethodBase.Model $$react4jv$$_candidate0 = observedModel();
    if (!ComponentObservable.maybeObserve($$react4jv$$_candidate0)) {
      return null;
    }
  ...
  private static final class LiteNativeView extends react4j.internal.NativeView
    ...
    @Nonnull
    private final React4j_TrackingInheritedAutoObserveMethodView view;

    @JsConstructor
    LiteNativeView(@Nullable final JsPropertyMap<Object> inputs) {
      super(inputs);
      view = new Arez_React4j_TrackingInheritedAutoObserveMethodView(this);
    }
