...
abstract class React4j_ObserveOnView extends ObserveOnView {
  @Nonnull
  ...
  React4j_ObserveOnView(@Nonnull final react4j.internal.NativeView $$react4j$$_nativeView) {
  ...
  private void $$react4j$$_componentWillUnmount() {
    ((Arez_React4j_ObserveOnView) this).dispose();
  ...
  private static final class LiteNativeView extends react4j.internal.NativeView
    ...
    LiteNativeView(@Nullable final JsPropertyMap<Object> inputs) {
      super(inputs);
      view = new Arez_React4j_ObserveOnView(this);
    }
