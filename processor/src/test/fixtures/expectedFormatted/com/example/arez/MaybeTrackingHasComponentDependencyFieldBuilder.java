...
final class MaybeTrackingHasComponentDependencyFieldBuilder {
  ...
  private static class Builder implements Step1 {
    ...
    private final ReactElement _element = ReactElement.createViewElement(
        React4j_MaybeTrackingHasComponentDependencyFieldView.Factory.TYPE);
    ...
    public final ReactNode model(
      ...
      _element.setKey(Identifiable.<Object>getArezId(model)
          + (React.enableViewNames()
              ? "_MaybeTrackingHasComponentDependencyFieldView_8376a9ac"
              : MaybeTrackingHasComponentDependencyFieldView.class.getName()));
