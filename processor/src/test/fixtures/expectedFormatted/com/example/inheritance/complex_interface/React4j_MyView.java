...
abstract class React4j_MyView extends MyView {
  ...
  static final class Inputs {
    static final String aaField2InRootInterface =
        React.shouldMinimizeInputKeys() ? "a" : "aaField2InRootInterface";

    static final String aaField2InInnerInterface =
        React.shouldMinimizeInputKeys() ? "b" : "aaField2InInnerInterface";

    static final String aaField2InLeafInterface =
        React.shouldMinimizeInputKeys() ? "c" : "aaField2InLeafInterface";

    static final String field2InLeaf = React.shouldMinimizeInputKeys() ? "d" : "field2InLeaf";

    static final String zzField1InRootInterface =
        React.shouldMinimizeInputKeys() ? "e" : "zzField1InRootInterface";

    static final String zzField1InInnerInterface =
        React.shouldMinimizeInputKeys() ? "f" : "zzField1InInnerInterface";

    static final String zzField1InLeafInterface =
        React.shouldMinimizeInputKeys() ? "g" : "zzField1InLeafInterface";
