...
@ArezComponent(
    name = "com_example_input_ChildInputView",
    disposeNotifier = Feature.DISABLE,
    defaultSkipIfDisposed = Feature.ENABLE,
    sting = Feature.DISABLE)
@Generated("react4j.processor.React4jProcessor")
abstract class React4j_ChildInputView extends ChildInputView {
  @Nonnull
  ...
  React4j_ChildInputView(@Nonnull final react4j.internal.NativeView $$react4j$$_nativeView) {
  ...
  ReactNode getChild() {
    if (React.shouldCheckInvariants()) {
      return null != $$react4j$$_nativeView.inputs().getAsAny(Inputs.child)
          ? $$react4j$$_nativeView.inputs().getAsAny(Inputs.child).cast()
          : null;
    } else {
  ...
  private void $$react4j$$_componentWillUnmount() {
    ((Arez_React4j_ChildInputView) this).dispose();
  ...
  private static final class LiteNativeView extends react4j.internal.NativeView
    ...
    @Nonnull
    private final React4j_ChildInputView view;

    @JsConstructor
    LiteNativeView(@Nullable final JsPropertyMap<Object> inputs) {
      super(inputs);
      view = new Arez_React4j_ChildInputView(this);
    }
