...
abstract class React4j_ExplicitOptional extends ExplicitOptional {
  ...
  String getMyOptionalProp() {
    if (React.shouldCheckInvariants()) {
      return null != $$react4j$$_nativeView.inputs().getAsAny(Inputs.myOptionalProp)
          ? $$react4j$$_nativeView.inputs().getAsAny(Inputs.myOptionalProp).asString()
          : null;
    } else {
  ...
  String getMyRequiredProp() {
    if (React.shouldCheckInvariants()) {
      return null != $$react4j$$_nativeView.inputs().getAsAny(Inputs.myRequiredProp)
          ? $$react4j$$_nativeView.inputs().getAsAny(Inputs.myRequiredProp).asString()
          : null;
    } else {
  ...
  String getMyOtherOptionalProp() {
    if (React.shouldCheckInvariants()) {
      return null != $$react4j$$_nativeView.inputs().getAsAny(Inputs.myOtherOptionalProp)
          ? $$react4j$$_nativeView.inputs().getAsAny(Inputs.myOtherOptionalProp).asString()
          : null;
    } else {
  ...
  private boolean $$react4j$$_shouldComponentUpdate(
    ...
    if (!Js.isTripleEqual(
        inputs.get(Inputs.myOptionalProp), nextInputs.get(Inputs.myOptionalProp))) {
      return true;
    }
    if (!Js.isTripleEqual(
        inputs.get(Inputs.myRequiredProp), nextInputs.get(Inputs.myRequiredProp))) {
      return true;
    }
    if (!Js.isTripleEqual(
        inputs.get(Inputs.myOtherOptionalProp), nextInputs.get(Inputs.myOtherOptionalProp))) {
      return true;
    }
    return false;
  }
  ...
  static final class Inputs {
    ...
    static final String myOtherOptionalProp =
        React.shouldMinimizeInputKeys() ? "c" : "myOtherOptionalProp";
  ...
  private static final class NativeView extends react4j.internal.NativeView
    ...
    NativeView(@Nullable final JsPropertyMap<Object> inputs) {
      super(inputs);
      view = new Arez_React4j_ExplicitOptional(this);
    }
