...
@ArezComponent(
    name = "com_example_optional_props_OptionalChildrenWithOptionalAndRequired",
    disposeNotifier = Feature.DISABLE,
    defaultSkipIfDisposed = Feature.ENABLE,
    sting = Feature.DISABLE,
    allowEmpty = true)
@Generated("react4j.processor.React4jProcessor")
abstract class React4j_OptionalChildrenWithOptionalAndRequired
    extends OptionalChildrenWithOptionalAndRequired {
  @Nonnull
  ...
  private static ViewConstructorFunction getConstructorFunction() {
    ...
    if (React.enableViewNames()) {
      Js.asPropertyMap(viewConstructor)
          .set("displayName", "OptionalChildrenWithOptionalAndRequired");
    }
  ...
  private static final class NativeView extends react4j.internal.NativeView
    ...
    @Nonnull
    private final React4j_OptionalChildrenWithOptionalAndRequired view;

    @JsConstructor
    NativeView(@Nullable final JsPropertyMap<Object> inputs) {
      super(inputs);
      view = new Arez_React4j_OptionalChildrenWithOptionalAndRequired(this);
    }
