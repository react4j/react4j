...
final class RequiredChildrenWithOptionalAndRequiredBuilder {
  ...
  private static class Builder implements Step1 {
    ...
    Builder() {
      _element = ReactElement.createViewElement(
          React4j_RequiredChildrenWithOptionalAndRequired.Factory.TYPE);
      final JsPropertyMap<Object> inputs = _element.inputs();
      inputs.set(
          React4j_RequiredChildrenWithOptionalAndRequired.Inputs.myProp,
          RequiredChildrenWithOptionalAndRequired.DEFAULT_MY_PROP);
    }
    ...
    public final Step1 myRequiredProp(@Nullable final String myRequiredProp) {
      _element.input(
          React4j_RequiredChildrenWithOptionalAndRequired.Inputs.myRequiredProp, myRequiredProp);
      return this;
    }
    ...
    public final Step1 children(@Nullable final ReactNode... children) {
      _element.input(
          React4j_RequiredChildrenWithOptionalAndRequired.Inputs.children, ReactNode.of(children));
      return this;
    }
