  ...
  private static class Builder implements Step1 {
    ...
    Builder() {
      _element = ReactElement.createViewElement(
          React4j_OptionalChildrenWithOptionalAndRequired.Factory.TYPE);
      final JsPropertyMap<Object> inputs = _element.inputs();
      inputs.set(
          React4j_OptionalChildrenWithOptionalAndRequired.Inputs.myProp,
          OptionalChildrenWithOptionalAndRequired.DEFAULT_MY_PROP);
    }
    ...
    public final Step1 myRequiredProp(@Nullable final String myRequiredProp) {
      _element.input(
          React4j_OptionalChildrenWithOptionalAndRequired.Inputs.myRequiredProp, myRequiredProp);
      return this;
    }
    ...
    public final Step1 children(@Nullable final ReactNode... children) {
      _element.input(
          React4j_OptionalChildrenWithOptionalAndRequired.Inputs.children, ReactNode.of(children));
      return this;
    }
