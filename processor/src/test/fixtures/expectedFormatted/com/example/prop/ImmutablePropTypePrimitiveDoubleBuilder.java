...
final class ImmutablePropTypePrimitiveDoubleBuilder {
  ...
  private static class Builder implements Step1 {
    ...
    private final ReactElement _element =
        ReactElement.createViewElement(React4j_ImmutablePropTypePrimitiveDouble.Factory.TYPE);
    ...
    public final ReactNode myProp(final double myProp) {
      _element.setKey(myProp
          + (React.enableViewNames()
              ? "_ImmutablePropTypePrimitiveDouble_9191758c"
              : ImmutablePropTypePrimitiveDouble.class.getName()));
