...
abstract class React4j_QualifiedNonnullContextPropModel extends QualifiedNonnullContextPropModel {
  ...
  private static void $$react4j$$_validateInputValues(@Nonnull final JsPropertyMap<Object> inputs) {
    ...
    if (React.shouldCheckInvariants()) {
      Guards.apiInvariant(
          () -> null != raw$myProp,
          () ->
              "Context value of type java.lang.String with qualifier 'my-proppo' is missing when constructing view named 'QualifiedNonnullContextPropModel'. Ensure a parent view publishes the value to the context.");
    }
  }
  ...
  private static final class NativeView extends react4j.internal.NativeView
    ...
    @Nonnull
    private final React4j_QualifiedNonnullContextPropModel view;
