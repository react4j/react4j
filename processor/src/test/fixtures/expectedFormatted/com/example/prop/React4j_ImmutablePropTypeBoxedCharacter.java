...
@ArezComponent(
    name = "com_example_prop_ImmutablePropTypeBoxedCharacter",
...
abstract class React4j_ImmutablePropTypeBoxedCharacter extends ImmutablePropTypeBoxedCharacter {
  ...
  React4j_ImmutablePropTypeBoxedCharacter(
      ...
      @Nullable final Character myProp) {
    super(myProp);
  ...
  private static final class NativeView extends react4j.internal.NativeView
    ...
    @Nonnull
    private final React4j_ImmutablePropTypeBoxedCharacter view;
    ...
    NativeView(@Nullable final JsPropertyMap<Object> inputs) {
      ...
      view = new Arez_React4j_ImmutablePropTypeBoxedCharacter(this, myProp);
    }
