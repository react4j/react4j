...
final class ImmutablePropTypeBoxedByteBuilder {
  ...
  private static class Builder implements Step1 {
    ...
    private final ReactElement _element =
        ReactElement.createViewElement(React4j_ImmutablePropTypeBoxedByte.Factory.TYPE);
    ...
    public final ReactNode myProp(@Nullable final Byte myProp) {
      _element.setKey(myProp
          + (React.enableViewNames()
              ? "_ImmutablePropTypeBoxedByte_72d659be"
              : ImmutablePropTypeBoxedByte.class.getName()));
