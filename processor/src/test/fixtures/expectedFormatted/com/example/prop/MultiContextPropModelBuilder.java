...
final class MultiContextPropModelBuilder {
  ...
  private static class Builder implements Step1 {
    ...
    private final ReactElement _element =
        ReactElement.createViewElement(React4j_MultiContextPropModel.Factory.TYPE);

    @Nonnull
    private final Context.ConsumerRenderFunction<String> _$context_stringContextValue =
        this::$context_stringContextValue;

    @Nonnull
    private final Context.ConsumerRenderFunction<Integer> _$context_intContextValue =
        this::$context_intContextValue;
    ...
    public final ReactNode build() {
      return ContextHolder.CONTEXT_stringContextValue.consumer()
          .render(_$context_stringContextValue);
    }
