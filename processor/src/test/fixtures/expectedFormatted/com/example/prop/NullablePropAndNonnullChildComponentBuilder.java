...
final class NullablePropAndNonnullChildComponentBuilder {
  ...
  private static class Builder implements Step1, Step2 {
    ...
    private final ReactElement _element =
        ReactElement.createViewElement(React4j_NullablePropAndNonnullChildComponent.Factory.TYPE);
    ...
    public final Step2 child(@Nullable final ReactNode child) {
      _element.input(
          React4j_NullablePropAndNonnullChildComponent.Inputs.child, ReactNode.of(child));
      return this;
    }
