...
@ArezComponent(
    name = "com_example_prop_MutablePropAndOnChangeAndPostConstructComponent",
    disposeNotifier = Feature.DISABLE,
    defaultSkipIfDisposed = Feature.ENABLE,
    sting = Feature.DISABLE,
    allowEmpty = true)
@Generated("react4j.processor.React4jProcessor")
abstract class React4j_MutablePropAndOnChangeAndPostConstructComponent
    extends MutablePropAndOnChangeAndPostConstructComponent {
  @Nonnull
  ...
  private static ViewConstructorFunction getConstructorFunction() {
    ...
    if (React.enableViewNames()) {
      Js.asPropertyMap(viewConstructor)
          .set("displayName", "MutablePropAndOnChangeAndPostConstructComponent");
    }
  ...
  private static final class NativeView extends react4j.internal.NativeView
    ...
    @Nonnull
    private final React4j_MutablePropAndOnChangeAndPostConstructComponent view;

    @JsConstructor
    NativeView(@Nullable final JsPropertyMap<Object> inputs) {
      super(inputs);
      view = new Arez_React4j_MutablePropAndOnChangeAndPostConstructComponent(this);
    }
