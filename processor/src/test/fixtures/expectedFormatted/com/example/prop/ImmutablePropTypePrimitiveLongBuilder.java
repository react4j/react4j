...
final class ImmutablePropTypePrimitiveLongBuilder {
  ...
  private static class Builder implements Step1 {
    ...
    private final ReactElement _element =
        ReactElement.createViewElement(React4j_ImmutablePropTypePrimitiveLong.Factory.TYPE);
    ...
    public final ReactNode myProp(final long myProp) {
      _element.setKey(myProp
          + (React.enableViewNames()
              ? "_ImmutablePropTypePrimitiveLong_ebf73d2b"
              : ImmutablePropTypePrimitiveLong.class.getName()));
