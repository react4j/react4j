...
@ArezComponent(
    name = "com_example_prop_NullabilityPropsComponent",
...
abstract class React4j_NullabilityPropsComponent extends NullabilityPropsComponent {
  ...
  private static void $$react4j$$_validateInputValues(@Nonnull final JsPropertyMap<Object> inputs) {
    ...
    if (React.shouldCheckInvariants()) {
      Guards.apiInvariant(
          () -> null != raw$myProp,
          () ->
              "Required input named 'myProp' is missing from view named 'NullabilityPropsComponent' so it was either incorrectly omitted or a null value has been incorrectly specified.");
    }
  }
  ...
  private static final class NativeView extends react4j.internal.NativeView
    ...
    NativeView(@Nullable final JsPropertyMap<Object> inputs) {
      super(inputs);
      view = new Arez_React4j_NullabilityPropsComponent(this);
      if (React.shouldValidateInputValues()) {
        assert null != inputs;
        React4j_NullabilityPropsComponent.$$react4j$$_validateInputValues(inputs);
      }
    }
