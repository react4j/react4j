...
@ArezComponent(
    name = "com_example_prop_ProtectedAccessFromBasePropModel",
...
abstract class React4j_ProtectedAccessFromBasePropModel extends ProtectedAccessFromBasePropModel {
  ...
  private void $$react4j$$_componentWillUnmount() {
    ((Arez_React4j_ProtectedAccessFromBasePropModel) this).dispose();
  }
  ...
  private static final class NativeView extends react4j.internal.NativeView
    ...
    @Nonnull
    private final React4j_ProtectedAccessFromBasePropModel view;

    @JsConstructor
    NativeView(@Nullable final JsPropertyMap<Object> inputs) {
      super(inputs);
      view = new Arez_React4j_ProtectedAccessFromBasePropModel(this);
    }
