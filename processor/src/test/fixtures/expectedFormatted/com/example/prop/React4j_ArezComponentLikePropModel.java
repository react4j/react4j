...
@ArezComponent(
    name = "com_example_prop_ArezComponentLikePropModel",
    disposeNotifier = Feature.DISABLE,
    defaultSkipIfDisposed = Feature.ENABLE,
    sting = Feature.DISABLE)
@Generated("react4j.processor.React4jProcessor")
abstract class React4j_ArezComponentLikePropModel extends ArezComponentLikePropModel {
  @Nonnull
  ...
  React4j_ArezComponentLikePropModel(
  ...
  private static ViewConstructorFunction getConstructorFunction() {
    ...
    if (React.enableViewNames()) {
      Js.asPropertyMap(viewConstructor).set("displayName", "ArezComponentLikePropModel");
    }
  ...
  @Nullable
  @Override
  ArezComponentLikePropModel.Model getModel() {
  ...
  private void $$react4j$$_componentWillUnmount() {
    ((Arez_React4j_ArezComponentLikePropModel) this).dispose();
  ...
  ReactNode $$react4j$$_render() {
    ...
    if ($$react4jv$$_candidate0 instanceof ComponentObservable
        && !ComponentObservable.observe($$react4jv$$_candidate0)) {
      return null;
    }
  ...
  private static final class LiteNativeView extends react4j.internal.NativeView
    ...
    LiteNativeView(@Nullable final JsPropertyMap<Object> inputs) {
      super(inputs);
      view = new Arez_React4j_ArezComponentLikePropModel(this);
    }
