...
final class ImmutablePropTypeArezComponentWithExplicitRequireIdBuilder {
  ...
  private static class Builder implements Step1 {
    ...
    private final ReactElement _element = ReactElement.createViewElement(
        React4j_ImmutablePropTypeArezComponentWithExplicitRequireId.Factory.TYPE);
    ...
    public final ReactNode myProp(
      ...
      _element.setKey(Identifiable.<Object>getArezId(myProp)
          + (React.enableViewNames()
              ? "_ImmutablePropTypeArezComponentWithExplicitRequireId_a574b6c9"
              : ImmutablePropTypeArezComponentWithExplicitRequireId.class.getName()));
      assert Disposable.isNotDisposed(myProp);
      _element.input(
          React4j_ImmutablePropTypeArezComponentWithExplicitRequireId.Inputs.myProp, myProp);
      return build();
    }
