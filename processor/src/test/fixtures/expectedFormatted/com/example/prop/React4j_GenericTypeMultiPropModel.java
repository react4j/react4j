...
abstract class React4j_GenericTypeMultiPropModel<T> extends GenericTypeMultiPropModel<T> {
  ...
  String getValue2() {
    if (React.shouldCheckInvariants()) {
      return null != $$react4j$$_nativeView.inputs().getAsAny(Inputs.value2)
          ? $$react4j$$_nativeView.inputs().getAsAny(Inputs.value2).asString()
          : null;
    } else {
  ...
  String getValue3() {
    if (React.shouldCheckInvariants()) {
      return null != $$react4j$$_nativeView.inputs().getAsAny(Inputs.value3)
          ? $$react4j$$_nativeView.inputs().getAsAny(Inputs.value3).asString()
          : null;
    } else {
  ...
  String getValue4() {
    if (React.shouldCheckInvariants()) {
      return null != $$react4j$$_nativeView.inputs().getAsAny(Inputs.value4)
          ? $$react4j$$_nativeView.inputs().getAsAny(Inputs.value4).asString()
          : null;
    } else {
  ...
  private static final class NativeView<T> extends react4j.internal.NativeView
    ...
    NativeView(@Nullable final JsPropertyMap<Object> inputs) {
      super(inputs);
      view = new Arez_React4j_GenericTypeMultiPropModel<T>(this);
    }
