...
@ArezComponent(
    name = "com_example_prop_SingleChildPropComponent",
...
abstract class React4j_SingleChildPropComponent extends SingleChildPropComponent {
  ...
  React4j_SingleChildPropComponent(
  ...
  private static ViewConstructorFunction getConstructorFunction() {
    ...
    if (React.enableViewNames()) {
      Js.asPropertyMap(viewConstructor).set("displayName", "SingleChildPropComponent");
    }
  ...
  private void $$react4j$$_componentWillUnmount() {
    ((Arez_React4j_SingleChildPropComponent) this).dispose();
  }
  ...
  private static final class NativeView extends react4j.internal.NativeView
    ...
    @Nonnull
    private final React4j_SingleChildPropComponent view;

    @JsConstructor
    NativeView(@Nullable final JsPropertyMap<Object> inputs) {
      super(inputs);
      view = new Arez_React4j_SingleChildPropComponent(this);
    }
