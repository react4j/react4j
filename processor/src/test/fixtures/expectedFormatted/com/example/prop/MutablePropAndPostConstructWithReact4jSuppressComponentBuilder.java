...
final class MutablePropAndPostConstructWithReact4jSuppressComponentBuilder {
  ...
  private static class Builder implements Step1 {
    ...
    private final ReactElement _element = ReactElement.createViewElement(
        React4j_MutablePropAndPostConstructWithReact4jSuppressComponent.Factory.TYPE);
    ...
    public final ReactNode myProp(@Nullable final String myProp) {
      _element.input(
          React4j_MutablePropAndPostConstructWithReact4jSuppressComponent.Inputs.myProp, myProp);
      return build();
    }
