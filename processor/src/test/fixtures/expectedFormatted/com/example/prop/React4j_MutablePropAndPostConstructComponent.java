...
@ArezComponent(
    name = "com_example_prop_MutablePropAndPostConstructComponent",
    disposeNotifier = Feature.DISABLE,
    defaultSkipIfDisposed = Feature.ENABLE,
    sting = Feature.DISABLE,
    allowEmpty = true)
@Generated("react4j.processor.React4jProcessor")
abstract class React4j_MutablePropAndPostConstructComponent
    extends MutablePropAndPostConstructComponent {
  @Nonnull
  ...
  private static final class NativeView extends react4j.internal.NativeView
    ...
    @Nonnull
    private final React4j_MutablePropAndPostConstructComponent view;

    @JsConstructor
    NativeView(@Nullable final JsPropertyMap<Object> inputs) {
      super(inputs);
      view = new Arez_React4j_MutablePropAndPostConstructComponent(this);
    }
