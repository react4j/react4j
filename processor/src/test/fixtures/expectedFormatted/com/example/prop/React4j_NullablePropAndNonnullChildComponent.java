...
abstract class React4j_NullablePropAndNonnullChildComponent
    extends NullablePropAndNonnullChildComponent {
  @Nonnull
  ...
  private static void $$react4j$$_validateInputValues(@Nonnull final JsPropertyMap<Object> inputs) {
    ...
    if (React.shouldCheckInvariants()) {
      Guards.apiInvariant(
          () -> null != raw$myProp,
          () ->
              "Required input named 'myProp' is missing from view named 'NullablePropAndNonnullChildComponent' so it was either incorrectly omitted or a null value has been incorrectly specified.");
    }
  }
  ...
  private static final class NativeView extends react4j.internal.NativeView
    ...
    @Nonnull
    private final React4j_NullablePropAndNonnullChildComponent view;
