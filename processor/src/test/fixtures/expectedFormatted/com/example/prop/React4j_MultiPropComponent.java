...
@ArezComponent(
    name = "com_example_prop_MultiPropComponent",
...
abstract class React4j_MultiPropComponent extends MultiPropComponent {
  ...
  React4j_MultiPropComponent(@Nonnull final react4j.internal.NativeView $$react4j$$_nativeView) {
  ...
  private static ViewConstructorFunction getConstructorFunction() {
    ...
    if (React.enableViewNames()) {
      Js.asPropertyMap(viewConstructor).set("displayName", "MultiPropComponent");
    }
  ...
  private static final class NativeView extends react4j.internal.NativeView
    ...
    @Nonnull
    private final React4j_MultiPropComponent view;

    @JsConstructor
    NativeView(@Nullable final JsPropertyMap<Object> inputs) {
      super(inputs);
      view = new Arez_React4j_MultiPropComponent(this);
    }
