...
abstract class React4j_MutablePropAndPostConstructWithReact4jSuppressComponent
    extends MutablePropAndPostConstructWithReact4jSuppressComponent {
  @Nonnull
  private final react4j.internal.NativeView $$react4j$$_nativeView;

  React4j_MutablePropAndPostConstructWithReact4jSuppressComponent(
  ...
  private static ViewConstructorFunction getConstructorFunction() {
    ...
    if (React.enableViewNames()) {
      Js.asPropertyMap(viewConstructor)
          .set("displayName", "MutablePropAndPostConstructWithReact4jSuppressComponent");
    }
  ...
  String getMyProp() {
    if (React.shouldCheckInvariants()) {
      Guards.apiInvariant(
          () -> $$react4j$$_isReady(),
          () -> "The view '" + this
              + "' accessed the input named 'myProp' before the view is ready (possibly in a @PostConstruct annotated method?) and does not have a @OnInputChange annotated method to cover the input and reflect changes of the input onto the view. This is considered a likely bug and the @Input should be made immutable or an @OnInputChange method added to cover the input. This warning can be suppressed by annotating the element with @SuppressWarnings( \"React4j:MutableInputAccessedInPostConstruct\" ) or @SuppressReact4jWarnings( \"React4j:MutableInputAccessedInPostConstruct\" ) to the @Input annotated method.");
    }
    if (React.shouldCheckInvariants()) {
      return null != $$react4j$$_nativeView.inputs().getAsAny(Inputs.myProp)
          ? $$react4j$$_nativeView.inputs().getAsAny(Inputs.myProp).asString()
          : null;
    } else {
  ...
  private void $$react4j$$_componentWillUnmount() {
    ((Arez_React4j_MutablePropAndPostConstructWithReact4jSuppressComponent) this).dispose();
  }
  ...
  private static final class NativeView extends react4j.internal.NativeView
    ...
    @Nonnull
    private final React4j_MutablePropAndPostConstructWithReact4jSuppressComponent view;

    @JsConstructor
    NativeView(@Nullable final JsPropertyMap<Object> inputs) {
      super(inputs);
      view = new Arez_React4j_MutablePropAndPostConstructWithReact4jSuppressComponent(this);
    }
