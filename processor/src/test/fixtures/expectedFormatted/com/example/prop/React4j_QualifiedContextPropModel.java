...
@ArezComponent(
    name = "com_example_prop_QualifiedContextPropModel",
...
abstract class React4j_QualifiedContextPropModel extends QualifiedContextPropModel {
  ...
  React4j_QualifiedContextPropModel(
  ...
  private static ViewConstructorFunction getConstructorFunction() {
    ...
    if (React.enableViewNames()) {
      Js.asPropertyMap(viewConstructor).set("displayName", "QualifiedContextPropModel");
    }
  ...
  private static final class NativeView extends react4j.internal.NativeView
    ...
    NativeView(@Nullable final JsPropertyMap<Object> inputs) {
      super(inputs);
      view = new Arez_React4j_QualifiedContextPropModel(this);
    }
