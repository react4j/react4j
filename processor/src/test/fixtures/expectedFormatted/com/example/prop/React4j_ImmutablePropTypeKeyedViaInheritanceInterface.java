...
@ArezComponent(
    name = "com_example_prop_ImmutablePropTypeKeyedViaInheritanceInterface",
    disposeNotifier = Feature.DISABLE,
    defaultSkipIfDisposed = Feature.ENABLE,
    sting = Feature.DISABLE,
    allowEmpty = true)
@Generated("react4j.processor.React4jProcessor")
abstract class React4j_ImmutablePropTypeKeyedViaInheritanceInterface
    extends ImmutablePropTypeKeyedViaInheritanceInterface {
  @Nonnull
  ...
  private static ViewConstructorFunction getConstructorFunction() {
    ...
    if (React.enableViewNames()) {
      Js.asPropertyMap(viewConstructor)
          .set("displayName", "ImmutablePropTypeKeyedViaInheritanceInterface");
    }
  ...
  private static final class NativeView extends react4j.internal.NativeView
    ...
    @Nonnull
    private final React4j_ImmutablePropTypeKeyedViaInheritanceInterface view;
