...
abstract class React4j_MultiContextPropModel extends MultiContextPropModel {
  ...
  String getStringContextValue() {
    if (React.shouldCheckInvariants()) {
      return null != $$react4j$$_nativeView.inputs().getAsAny(Inputs.stringContextValue)
          ? $$react4j$$_nativeView.inputs().getAsAny(Inputs.stringContextValue).asString()
          : null;
    } else {
  ...
  private boolean $$react4j$$_shouldComponentUpdate(
    ...
    if (!Js.isTripleEqual(
        inputs.get(Inputs.stringContextValue), nextInputs.get(Inputs.stringContextValue))) {
      return true;
    }
    if (!Js.isTripleEqual(
        inputs.get(Inputs.intContextValue), nextInputs.get(Inputs.intContextValue))) {
      return true;
    }
    return false;
  }
  ...
  static final class Inputs {
    static final String stringContextValue =
        React.shouldMinimizeInputKeys() ? "a" : "stringContextValue";
  ...
  private static final class NativeView extends react4j.internal.NativeView
    ...
    @Nonnull
    private final React4j_MultiContextPropModel view;

    @JsConstructor
    NativeView(@Nullable final JsPropertyMap<Object> inputs) {
      super(inputs);
      view = new Arez_React4j_MultiContextPropModel(this);
    }
