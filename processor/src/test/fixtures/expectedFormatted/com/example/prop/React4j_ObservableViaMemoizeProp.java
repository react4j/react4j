...
abstract class React4j_ObservableViaMemoizeProp extends ObservableViaMemoizeProp {
  ...
  React4j_ObservableViaMemoizeProp(
  ...
  private static ViewConstructorFunction getConstructorFunction() {
    ...
    if (React.enableViewNames()) {
      Js.asPropertyMap(viewConstructor).set("displayName", "ObservableViaMemoizeProp");
    }
  ...
  private static final class NativeView extends react4j.internal.NativeView
    ...
    NativeView(@Nullable final JsPropertyMap<Object> inputs) {
      super(inputs);
      view = new Arez_React4j_ObservableViaMemoizeProp(this);
    }
