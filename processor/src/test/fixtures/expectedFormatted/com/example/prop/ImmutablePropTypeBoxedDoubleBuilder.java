...
final class ImmutablePropTypeBoxedDoubleBuilder {
  ...
  private static class Builder implements Step1 {
    ...
    private final ReactElement _element =
        ReactElement.createViewElement(React4j_ImmutablePropTypeBoxedDouble.Factory.TYPE);
    ...
    public final ReactNode myProp(@Nullable final Double myProp) {
      _element.setKey(myProp
          + (React.enableViewNames()
              ? "_ImmutablePropTypeBoxedDouble_7e5f2de1"
              : ImmutablePropTypeBoxedDouble.class.getName()));
