...
final class ImmutablePropTypeArezComponentLikeInterfaceBuilder {
  ...
  private static class Builder implements Step1 {
    ...
    private final ReactElement _element = ReactElement.createViewElement(
        React4j_ImmutablePropTypeArezComponentLikeInterface.Factory.TYPE);
    ...
    public final ReactNode myProp(
      ...
      _element.setKey(Identifiable.<Object>getArezId(myProp)
          + (React.enableViewNames()
              ? "_ImmutablePropTypeArezComponentLikeInterface_c528e47c"
              : ImmutablePropTypeArezComponentLikeInterface.class.getName()));
