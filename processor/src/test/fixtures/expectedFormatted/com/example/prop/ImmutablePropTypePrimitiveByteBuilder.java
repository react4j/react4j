...
final class ImmutablePropTypePrimitiveByteBuilder {
  ...
  private static class Builder implements Step1 {
    ...
    private final ReactElement _element =
        ReactElement.createViewElement(React4j_ImmutablePropTypePrimitiveByte.Factory.TYPE);
    ...
    public final ReactNode myProp(final byte myProp) {
      _element.setKey(myProp
          + (React.enableViewNames()
              ? "_ImmutablePropTypePrimitiveByte_90aa81dc"
              : ImmutablePropTypePrimitiveByte.class.getName()));
