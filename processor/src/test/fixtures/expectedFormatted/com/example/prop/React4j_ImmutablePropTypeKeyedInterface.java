...
@ArezComponent(
    name = "com_example_prop_ImmutablePropTypeKeyedInterface",
...
abstract class React4j_ImmutablePropTypeKeyedInterface extends ImmutablePropTypeKeyedInterface {
  ...
  private static ViewConstructorFunction getConstructorFunction() {
    ...
    if (React.enableViewNames()) {
      Js.asPropertyMap(viewConstructor).set("displayName", "ImmutablePropTypeKeyedInterface");
    }
  ...
  private static final class NativeView extends react4j.internal.NativeView
    ...
    NativeView(@Nullable final JsPropertyMap<Object> inputs) {
      super(inputs);
      ImmutablePropTypeKeyedInterface.KeyedInterface myProp;
      ...
      view = new Arez_React4j_ImmutablePropTypeKeyedInterface(this, myProp);
    }
