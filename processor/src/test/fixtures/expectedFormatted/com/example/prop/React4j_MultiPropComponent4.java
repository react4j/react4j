...
@ArezComponent(
    name = "com_example_prop_MultiPropComponent4",
...
abstract class React4j_MultiPropComponent4 extends MultiPropComponent4 {
  ...
  String getMyProp3() {
    if (React.shouldCheckInvariants()) {
      return null != $$react4j$$_nativeView.inputs().getAsAny(Inputs.myProp3)
          ? $$react4j$$_nativeView.inputs().getAsAny(Inputs.myProp3).asString()
          : null;
    } else {
  ...
  String getMyProp4() {
    if (React.shouldCheckInvariants()) {
      return null != $$react4j$$_nativeView.inputs().getAsAny(Inputs.myProp4)
          ? $$react4j$$_nativeView.inputs().getAsAny(Inputs.myProp4).asString()
          : null;
    } else {
  ...
  private static final class NativeView extends react4j.internal.NativeView
    ...
    NativeView(@Nullable final JsPropertyMap<Object> inputs) {
      super(inputs);
      view = new Arez_React4j_MultiPropComponent4(this);
    }
