...
abstract class React4j_ObservableProp extends ObservableProp {
  ...
  React4j_ObservableProp(@Nonnull final react4j.internal.NativeView $$react4j$$_nativeView) {
  ...
  Object getValue() {
    if (React.shouldCheckInvariants()) {
      return null != $$react4j$$_nativeView.inputs().getAsAny(Inputs.value)
          ? $$react4j$$_nativeView.inputs().getAsAny(Inputs.value).cast()
          : null;
    } else {
  ...
  private static final class LiteNativeView extends react4j.internal.NativeView
    ...
    @Nonnull
    private final React4j_ObservableProp view;

    @JsConstructor
    LiteNativeView(@Nullable final JsPropertyMap<Object> inputs) {
      super(inputs);
      view = new Arez_React4j_ObservableProp(this);
    }
