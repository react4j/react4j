...
@ArezComponent(
    name = "com_example_prop_MultiPropComponent3",
...
abstract class React4j_MultiPropComponent3 extends MultiPropComponent3 {
  ...
  React4j_MultiPropComponent3(@Nonnull final react4j.internal.NativeView $$react4j$$_nativeView) {
  ...
  private static ViewConstructorFunction getConstructorFunction() {
    ...
    if (React.enableViewNames()) {
      Js.asPropertyMap(viewConstructor).set("displayName", "MultiPropComponent3");
    }
  ...
  private static final class NativeView extends react4j.internal.NativeView
    ...
    @Nonnull
    private final React4j_MultiPropComponent3 view;

    @JsConstructor
    NativeView(@Nullable final JsPropertyMap<Object> inputs) {
      super(inputs);
      view = new Arez_React4j_MultiPropComponent3(this);
    }
