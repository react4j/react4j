...
@ArezComponent(
    name = "com_example_prop_validate_StringPropValidate",
    disposeNotifier = Feature.DISABLE,
    defaultSkipIfDisposed = Feature.ENABLE,
    sting = Feature.DISABLE,
    allowEmpty = true)
@Generated("react4j.processor.React4jProcessor")
abstract class React4j_StringPropValidate extends StringPropValidate {
  @Nonnull
  private final react4j.internal.NativeView $$react4j$$_nativeView;

  React4j_StringPropValidate(@Nonnull final react4j.internal.NativeView $$react4j$$_nativeView) {
  ...
  private void $$react4j$$_componentWillUnmount() {
    ((Arez_React4j_StringPropValidate) this).dispose();
  }
  ...
  private static final class NativeView extends react4j.internal.NativeView
    ...
    NativeView(@Nullable final JsPropertyMap<Object> inputs) {
      super(inputs);
      view = new Arez_React4j_StringPropValidate(this);
      if (React.shouldValidateInputValues()) {
        assert null != inputs;
