...
abstract class React4j_OtherPropValidate extends OtherPropValidate {
  ...
  React4j_OtherPropValidate(@Nonnull final react4j.internal.NativeView $$react4j$$_nativeView) {
  ...
  private static ViewConstructorFunction getConstructorFunction() {
    ...
    if (React.enableViewNames()) {
      Js.asPropertyMap(viewConstructor).set("displayName", "OtherPropValidate");
    }
  ...
  private static final class NativeView extends react4j.internal.NativeView
    ...
    @Nonnull
    private final React4j_OtherPropValidate view;

    @JsConstructor
    NativeView(@Nullable final JsPropertyMap<Object> inputs) {
      super(inputs);
      view = new Arez_React4j_OtherPropValidate(this);
      if (React.shouldValidateInputValues()) {
        assert null != inputs;
