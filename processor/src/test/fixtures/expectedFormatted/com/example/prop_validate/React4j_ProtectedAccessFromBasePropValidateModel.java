...
@ArezComponent(
    name = "com_example_prop_validate_ProtectedAccessFromBasePropValidateModel",
    disposeNotifier = Feature.DISABLE,
    defaultSkipIfDisposed = Feature.ENABLE,
    sting = Feature.DISABLE,
    allowEmpty = true)
@Generated("react4j.processor.React4jProcessor")
abstract class React4j_ProtectedAccessFromBasePropValidateModel
    extends ProtectedAccessFromBasePropValidateModel {
  @Nonnull
  ...
  private static ViewConstructorFunction getConstructorFunction() {
    ...
    if (React.enableViewNames()) {
      Js.asPropertyMap(viewConstructor)
          .set("displayName", "ProtectedAccessFromBasePropValidateModel");
    }
  ...
  private static final class NativeView extends react4j.internal.NativeView
    ...
    @Nonnull
    private final React4j_ProtectedAccessFromBasePropValidateModel view;

    @JsConstructor
    NativeView(@Nullable final JsPropertyMap<Object> inputs) {
      super(inputs);
      view = new Arez_React4j_ProtectedAccessFromBasePropValidateModel(this);
      if (React.shouldValidateInputValues()) {
        assert null != inputs;
