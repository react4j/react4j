...
@ArezComponent(
    name = "com_example_prop_validate_PublicAccessViaInterfacePropValidateModel",
    disposeNotifier = Feature.DISABLE,
    defaultSkipIfDisposed = Feature.ENABLE,
    sting = Feature.DISABLE,
    allowEmpty = true)
@Generated("react4j.processor.React4jProcessor")
abstract class React4j_PublicAccessViaInterfacePropValidateModel
    extends PublicAccessViaInterfacePropValidateModel {
  @Nonnull
  ...
  private static ViewConstructorFunction getConstructorFunction() {
    ...
    if (React.enableViewNames()) {
      Js.asPropertyMap(viewConstructor)
          .set("displayName", "PublicAccessViaInterfacePropValidateModel");
    }
