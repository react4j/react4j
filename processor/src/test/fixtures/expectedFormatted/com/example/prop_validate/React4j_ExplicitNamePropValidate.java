...
@ArezComponent(
    name = "com_example_prop_validate_ExplicitNamePropValidate",
    disposeNotifier = Feature.DISABLE,
    defaultSkipIfDisposed = Feature.ENABLE,
    sting = Feature.DISABLE,
    allowEmpty = true)
@Generated("react4j.processor.React4jProcessor")
abstract class React4j_ExplicitNamePropValidate extends ExplicitNamePropValidate {
  @Nonnull
  private final react4j.internal.NativeView $$react4j$$_nativeView;

  React4j_ExplicitNamePropValidate(
  ...
  private static ViewConstructorFunction getConstructorFunction() {
    ...
    if (React.enableViewNames()) {
      Js.asPropertyMap(viewConstructor).set("displayName", "ExplicitNamePropValidate");
    }
  ...
  private void $$react4j$$_componentWillUnmount() {
    ((Arez_React4j_ExplicitNamePropValidate) this).dispose();
  }
  ...
  private static final class NativeView extends react4j.internal.NativeView
    ...
    @Nonnull
    private final React4j_ExplicitNamePropValidate view;

    @JsConstructor
    NativeView(@Nullable final JsPropertyMap<Object> inputs) {
      super(inputs);
      view = new Arez_React4j_ExplicitNamePropValidate(this);
      if (React.shouldValidateInputValues()) {
        assert null != inputs;
