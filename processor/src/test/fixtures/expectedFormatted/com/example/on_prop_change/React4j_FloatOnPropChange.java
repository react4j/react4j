...
@ArezComponent(
    name = "com_example_on_prop_change_FloatOnPropChange",
...
abstract class React4j_FloatOnPropChange extends FloatOnPropChange {
  ...
  React4j_FloatOnPropChange(@Nonnull final react4j.internal.NativeView $$react4j$$_nativeView) {
  ...
  private static ViewConstructorFunction getConstructorFunction() {
    ...
    if (React.enableViewNames()) {
      Js.asPropertyMap(viewConstructor).set("displayName", "FloatOnPropChange");
    }
  ...
  @Override
  float getMyProp() {
    return $$react4j$$_nativeView.inputs().getAsAny(Inputs.myProp).asFloat();
  }
  ...
  private void $$react4j$$_componentPreUpdate(@Nullable final JsPropertyMap<Object> prevInputs) {
    if (null != prevInputs) {
      ...
      if (myProp) {
        onMyPropChange(inputs.getAsAny(Inputs.myProp).asFloat());
      }
    }
  }

  private void $$react4j$$_componentWillUnmount() {
    ((Arez_React4j_FloatOnPropChange) this).dispose();
  }
  ...
  private static final class NativeView extends react4j.internal.NativeView
    ...
    NativeView(@Nullable final JsPropertyMap<Object> inputs) {
      super(inputs);
      view = new Arez_React4j_FloatOnPropChange(this);
    }
