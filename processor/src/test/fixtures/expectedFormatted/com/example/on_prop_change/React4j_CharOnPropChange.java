...
@ArezComponent(
    name = "com_example_on_prop_change_CharOnPropChange",
...
abstract class React4j_CharOnPropChange extends CharOnPropChange {
  ...
  React4j_CharOnPropChange(@Nonnull final react4j.internal.NativeView $$react4j$$_nativeView) {
  ...
  private static ViewConstructorFunction getConstructorFunction() {
    ...
    if (React.enableViewNames()) {
      Js.asPropertyMap(viewConstructor).set("displayName", "CharOnPropChange");
    }
  ...
  @Override
  char getMyProp() {
    return $$react4j$$_nativeView.inputs().getAsAny(Inputs.myProp).asChar();
  }
  ...
  private void $$react4j$$_componentPreUpdate(@Nullable final JsPropertyMap<Object> prevInputs) {
    if (null != prevInputs) {
      ...
      if (myProp) {
        onMyPropChange(inputs.getAsAny(Inputs.myProp).asChar());
      }
    }
  }

  private void $$react4j$$_componentWillUnmount() {
    ((Arez_React4j_CharOnPropChange) this).dispose();
  }
  ...
  private static final class NativeView extends react4j.internal.NativeView
    ...
    @Nonnull
    private final React4j_CharOnPropChange view;

    @JsConstructor
    NativeView(@Nullable final JsPropertyMap<Object> inputs) {
      super(inputs);
      view = new Arez_React4j_CharOnPropChange(this);
    }
