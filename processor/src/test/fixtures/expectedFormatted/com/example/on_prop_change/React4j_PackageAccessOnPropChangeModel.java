...
@ArezComponent(
    name = "com_example_on_prop_change_PackageAccessOnPropChangeModel",
...
abstract class React4j_PackageAccessOnPropChangeModel extends PackageAccessOnPropChangeModel {
  ...
  private static ViewConstructorFunction getConstructorFunction() {
    ...
    if (React.enableViewNames()) {
      Js.asPropertyMap(viewConstructor).set("displayName", "PackageAccessOnPropChangeModel");
    }
  ...
  private static final class NativeView extends react4j.internal.NativeView
    ...
    @Nonnull
    private final React4j_PackageAccessOnPropChangeModel view;

    @JsConstructor
    NativeView(@Nullable final JsPropertyMap<Object> inputs) {
      super(inputs);
      view = new Arez_React4j_PackageAccessOnPropChangeModel(this);
    }
