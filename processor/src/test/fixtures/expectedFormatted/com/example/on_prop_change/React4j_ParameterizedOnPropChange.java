...
@ArezComponent(
    name = "com_example_on_prop_change_ParameterizedOnPropChange",
...
abstract class React4j_ParameterizedOnPropChange extends ParameterizedOnPropChange {
  ...
  React4j_ParameterizedOnPropChange(
  ...
  private static ViewConstructorFunction getConstructorFunction() {
    ...
    if (React.enableViewNames()) {
      Js.asPropertyMap(viewConstructor).set("displayName", "ParameterizedOnPropChange");
    }
  ...
  private void $$react4j$$_componentWillUnmount() {
    ((Arez_React4j_ParameterizedOnPropChange) this).dispose();
  }
  ...
  private static final class NativeView extends react4j.internal.NativeView
    ...
    NativeView(@Nullable final JsPropertyMap<Object> inputs) {
      super(inputs);
      view = new Arez_React4j_ParameterizedOnPropChange(this);
    }
