...
@ArezComponent(
    name = "com_example_on_prop_change_StringOnPropChange",
...
abstract class React4j_StringOnPropChange extends StringOnPropChange {
  ...
  React4j_StringOnPropChange(@Nonnull final react4j.internal.NativeView $$react4j$$_nativeView) {
  ...
  private static ViewConstructorFunction getConstructorFunction() {
    ...
    if (React.enableViewNames()) {
      Js.asPropertyMap(viewConstructor).set("displayName", "StringOnPropChange");
    }
  ...
  private void $$react4j$$_componentWillUnmount() {
    ((Arez_React4j_StringOnPropChange) this).dispose();
  }
  ...
  private static final class NativeView extends react4j.internal.NativeView
    ...
    @Nonnull
    private final React4j_StringOnPropChange view;

    @JsConstructor
    NativeView(@Nullable final JsPropertyMap<Object> inputs) {
      super(inputs);
      view = new Arez_React4j_StringOnPropChange(this);
    }
