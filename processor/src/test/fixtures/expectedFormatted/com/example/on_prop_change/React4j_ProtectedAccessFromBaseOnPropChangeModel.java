...
@ArezComponent(
    name = "com_example_on_prop_change_ProtectedAccessFromBaseOnPropChangeModel",
    disposeNotifier = Feature.DISABLE,
    defaultSkipIfDisposed = Feature.ENABLE,
    sting = Feature.DISABLE,
    allowEmpty = true)
@Generated("react4j.processor.React4jProcessor")
abstract class React4j_ProtectedAccessFromBaseOnPropChangeModel
    extends ProtectedAccessFromBaseOnPropChangeModel {
  @Nonnull
  private final react4j.internal.NativeView $$react4j$$_nativeView;

  React4j_ProtectedAccessFromBaseOnPropChangeModel(
  ...
  private static ViewConstructorFunction getConstructorFunction() {
    ...
    if (React.enableViewNames()) {
      Js.asPropertyMap(viewConstructor)
          .set("displayName", "ProtectedAccessFromBaseOnPropChangeModel");
    }
  ...
  private void $$react4j$$_componentPreUpdate(@Nullable final JsPropertyMap<Object> prevInputs) {
    if (null != prevInputs) {
      final JsPropertyMap<Object> inputs = $$react4j$$_nativeView.inputs();
      final boolean myProp =
          !Js.isTripleEqual(inputs.get(Inputs.myProp), prevInputs.get(Inputs.myProp));
      if (myProp) {
  ...
  private static final class NativeView extends react4j.internal.NativeView
    ...
    @Nonnull
    private final React4j_ProtectedAccessFromBaseOnPropChangeModel view;

    @JsConstructor
    NativeView(@Nullable final JsPropertyMap<Object> inputs) {
      super(inputs);
      view = new Arez_React4j_ProtectedAccessFromBaseOnPropChangeModel(this);
    }
