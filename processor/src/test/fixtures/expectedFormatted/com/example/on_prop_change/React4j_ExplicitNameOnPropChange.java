...
@ArezComponent(
    name = "com_example_on_prop_change_ExplicitNameOnPropChange",
    disposeNotifier = Feature.DISABLE,
    defaultSkipIfDisposed = Feature.ENABLE,
    sting = Feature.DISABLE,
    allowEmpty = true)
@Generated("react4j.processor.React4jProcessor")
abstract class React4j_ExplicitNameOnPropChange extends ExplicitNameOnPropChange {
  @Nonnull
  private final react4j.internal.NativeView $$react4j$$_nativeView;

  React4j_ExplicitNameOnPropChange(
  ...
  private static ViewConstructorFunction getConstructorFunction() {
    ...
    if (React.enableViewNames()) {
      Js.asPropertyMap(viewConstructor).set("displayName", "ExplicitNameOnPropChange");
    }
  ...
  private void $$react4j$$_componentPreUpdate(@Nullable final JsPropertyMap<Object> prevInputs) {
    if (null != prevInputs) {
      ...
      if (myProp) {
        onMyInputChange(inputs.getAsAny(Inputs.myProp).asDouble());
      }
    }
  }

  private void $$react4j$$_componentWillUnmount() {
    ((Arez_React4j_ExplicitNameOnPropChange) this).dispose();
  }
  ...
  private static final class NativeView extends react4j.internal.NativeView
    ...
    @Nonnull
    private final React4j_ExplicitNameOnPropChange view;

    @JsConstructor
    NativeView(@Nullable final JsPropertyMap<Object> inputs) {
      super(inputs);
      view = new Arez_React4j_ExplicitNameOnPropChange(this);
    }
