...
@ArezComponent(
    name = "com_example_on_prop_change_NonnullOnPropChange",
  ...
  private static void $$react4j$$_validateInputValues(@Nonnull final JsPropertyMap<Object> inputs) {
    ...
    if (React.shouldCheckInvariants()) {
      Guards.apiInvariant(
          () -> null != raw$myProp,
          () ->
              "Required input named 'myProp' is missing from view named 'NonnullOnPropChange' so it was either incorrectly omitted or a null value has been incorrectly specified.");
    }
  }
