...
abstract class React4j_OtherTypeOnPropChange extends OtherTypeOnPropChange {
  ...
  React4j_OtherTypeOnPropChange(@Nonnull final react4j.internal.NativeView $$react4j$$_nativeView) {
  ...
  private static ViewConstructorFunction getConstructorFunction() {
    ...
    if (React.enableViewNames()) {
      Js.asPropertyMap(viewConstructor).set("displayName", "OtherTypeOnPropChange");
    }
  ...
  BitSet getMyProp() {
    if (React.shouldCheckInvariants()) {
      return null != $$react4j$$_nativeView.inputs().getAsAny(Inputs.myProp)
          ? $$react4j$$_nativeView.inputs().getAsAny(Inputs.myProp).cast()
          : null;
    } else {
  ...
  private void $$react4j$$_componentWillUnmount() {
    ((Arez_React4j_OtherTypeOnPropChange) this).dispose();
  }
  ...
  private static final class NativeView extends react4j.internal.NativeView
    ...
    @Nonnull
    private final React4j_OtherTypeOnPropChange view;

    @JsConstructor
    NativeView(@Nullable final JsPropertyMap<Object> inputs) {
      super(inputs);
      view = new Arez_React4j_OtherTypeOnPropChange(this);
    }
