...
@ArezComponent(
    name = "com_example_on_prop_change_IntOnPropChange",
    disposeNotifier = Feature.DISABLE,
    defaultSkipIfDisposed = Feature.ENABLE,
    sting = Feature.DISABLE,
    allowEmpty = true)
@Generated("react4j.processor.React4jProcessor")
abstract class React4j_IntOnPropChange extends IntOnPropChange {
  @Nonnull
  private final react4j.internal.NativeView $$react4j$$_nativeView;

  React4j_IntOnPropChange(@Nonnull final react4j.internal.NativeView $$react4j$$_nativeView) {
  ...
  private static ViewConstructorFunction getConstructorFunction() {
    ...
    if (React.enableViewNames()) {
      Js.asPropertyMap(viewConstructor).set("displayName", "IntOnPropChange");
    }
  ...
  private void $$react4j$$_componentWillUnmount() {
    ((Arez_React4j_IntOnPropChange) this).dispose();
  }
  ...
  private static final class NativeView extends react4j.internal.NativeView
    ...
    @Nonnull
    private final React4j_IntOnPropChange view;

    @JsConstructor
    NativeView(@Nullable final JsPropertyMap<Object> inputs) {
      super(inputs);
      view = new Arez_React4j_IntOnPropChange(this);
    }
