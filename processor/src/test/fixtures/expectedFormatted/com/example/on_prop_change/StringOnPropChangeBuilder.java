...
final class StringOnPropChangeBuilder {
  ...
  private static class Builder implements Step1 {
    ...
    private final ReactElement _element =
        ReactElement.createViewElement(React4j_StringOnPropChange.Factory.TYPE);

    @Override
    @Nonnull
    @Contract(pure = true)
    public final ReactNode myProp(@Nullable final String myProp) {
      _element.input(React4j_StringOnPropChange.Inputs.myProp, myProp);
      return build();
    }
