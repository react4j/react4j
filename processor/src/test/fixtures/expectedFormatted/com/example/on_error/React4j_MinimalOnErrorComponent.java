...
@ArezComponent(
    name = "com_example_on_error_MinimalOnErrorComponent",
...
abstract class React4j_MinimalOnErrorComponent extends MinimalOnErrorComponent {
  ...
  React4j_MinimalOnErrorComponent(
  ...
  private static ViewConstructorFunction getConstructorFunction() {
    ...
    if (React.enableViewNames()) {
      Js.asPropertyMap(viewConstructor).set("displayName", "MinimalOnErrorComponent");
    }
  ...
  private static final class NativeView extends react4j.internal.NativeView
    ...
    @Nonnull
    private final React4j_MinimalOnErrorComponent view;

    @JsConstructor
    NativeView(@Nullable final JsPropertyMap<Object> inputs) {
      super(inputs);
      view = new Arez_React4j_MinimalOnErrorComponent(this);
    }
