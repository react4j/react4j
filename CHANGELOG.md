...
* **\[arez\]** Update the `org.realityforge.arez.browserlocation` dependency to version `0.24`.
* **\[arez\]** Update the `org.realityforge.arez.spytools` dependency to version `0.22`.
