...
* Fix legacy closure namespace configuration.
...
### [v0.223](https://github.com/react4j/react4j/tree/v0.223) (2026-05-07) · [Full Changelog](https://github.com/react4j/react4j/compare/v0.222...v0.223)
...
### [v0.214](https://github.com/react4j/react4j/tree/v0.214) (2026-04-20) · [Full Changelog](https://github.com/react4j/react4j/compare/v0.213...v0.214)

Changes in this release:

* Ensure private constructors exist for utility classes to avoid instantiation.
...
### [v0.207](https://github.com/react4j/react4j/tree/v0.207) (2026-04-02) · [Full Changelog](https://github.com/react4j/react4j/compare/v0.206...v0.207)

Changes in this release:

### [v0.206](https://github.com/react4j/react4j/tree/v0.206) (2026-04-02) · [Full Changelog](https://github.com/react4j/react4j/compare/v0.205...v0.206)
...
* Ensure we correctly handle immutable long primitives.
...
* Ensure `getSnapshotBeforeUpdate(...)` is annotated with `@Nullable`.

### [v0.200](https://github.com/react4j/react4j/tree/v0.200) (2026-01-21) · [Full Changelog](https://github.com/react4j/react4j/compare/v0.199...v0.200)
...
### [v0.195](https://github.com/react4j/react4j/tree/v0.195) (2024-05-24) · [Full Changelog](https://github.com/react4j/react4j/compare/v0.194...v0.195)
...
* Remove the `react4j.freeze_inputs` compile-time configuration setting as it is not needed as no java code has access to the props and it is assumed that the react internals are trusted. Remove all the associated infrastructure to support freezing of inputs.
* Fix bug where a component may not be re-rendered if the only input change was a removal of an existing key.
...
The release includes 5 non breaking API changes, 8 potentially breaking API changes and 102 breaking API changes.
...
* Upgrade the `org.realityforge.arez.testng` artifact to version `0.23`.
...
* Fix a bug where immutable, primitive, numeric inputs would cause a cast error when generating the key for the view. This occurs as a javascript number value is extracted from the inputs map which models the value as a `Double` and then attempts to cast to a primitive such as `int`. This is fixed by double casting ala `(int) (double) inputs.get(...)`.
...
* Ensure that a `@Nonnull` annotated input that is sourced from the context has nonnull traits validated.
...
* Add a `@Publish` annotation that simplifies publishing values from a view to child view.

### [v0.162](https://github.com/react4j/react4j/tree/v0.162) (2020-06-07) · [Full Changelog](https://github.com/react4j/react4j/compare/v0.161...v0.162) · [API Differences](https://react4j.github.io/api-diff?key=react4j&old=0.161&new=0.162)

The release includes 27 non breaking API changes, 3 potentially breaking API changes and 30 breaking API changes.
...
* Reduce the access level of the `React.Element`, `React.StrictMode`, `React.Fragment` and `React.Suspense` fields as they are only used within local methods.
...
* Enhance the annotation processor to allow immutable props that are assignable to `arez.component.Identifiable`.
...
* Update code generation to comply with best practices strongly suggested by the latest arez release.
...
* Remove unnecessary `jsinterop.annotations.Annotations` inherit for annotations-only dependency.
...
* Add the `@Prop.source` and `@Prop.qualifier` parameters so that props can be supplied from the react context by setting `source=CONTEXT`.
...
* Generate an error if `@sting.Named` is present on a constructor parameter but `sting` is disabled.
* Generate an error if `@javax.inject.Named` is present on a constructor parameter but `inject` is disabled.
...
### [v0.141](https://github.com/react4j/react4j/tree/v0.141) (2019-11-12) · [Full Changelog](https://github.com/react4j/react4j/compare/v0.140...v0.141)
